...
{
    atomic_signal_fence(Jakt::MemoryOrder::memory_order_acq_rel);
    atomic_thread_fence(Jakt::MemoryOrder::memory_order_acq_rel);
}
...
template<typename T, MemoryOrder DefaultMemoryOrder = Jakt::MemoryOrder::memory_order_seq_cst>
class Atomic {
