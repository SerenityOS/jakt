...
public: protected:
explicit Compiler(JaktInternal::DynamicArray<Jakt::jakt__path::Path> a_files, JaktInternal::Dictionary<ByteString,Jakt::utility::FileId> a_file_ids, JaktInternal::DynamicArray<Jakt::error::JaktError> a_errors, JaktInternal::Optional<Jakt::utility::FileId> a_current_file, JaktInternal::DynamicArray<u8> a_current_file_contents, bool a_dump_lexer, bool a_dump_parser, bool a_ignore_parser_errors, bool a_debug_print, Jakt::jakt__path::Path a_std_include_path, JaktInternal::DynamicArray<ByteString> a_include_paths, bool a_json_errors, bool a_dump_type_hints, bool a_dump_try_hints, bool a_optimize, JaktInternal::Optional<ByteString> a_target_triple, JaktInternal::Dictionary<ByteString,ByteString> a_user_configuration, Jakt::jakt__path::Path a_binary_dir, Jakt::jakt__path::Path a_exports_dir, JaktInternal::Optional<Jakt::jakt__path::Path> a_assume_main_file_path);
public:
static NonnullRefPtr<Compiler> __jakt_create(JaktInternal::DynamicArray<Jakt::jakt__path::Path> files, JaktInternal::Dictionary<ByteString,Jakt::utility::FileId> file_ids, JaktInternal::DynamicArray<Jakt::error::JaktError> errors, JaktInternal::Optional<Jakt::utility::FileId> current_file, JaktInternal::DynamicArray<u8> current_file_contents, bool dump_lexer, bool dump_parser, bool ignore_parser_errors, bool debug_print, Jakt::jakt__path::Path std_include_path, JaktInternal::DynamicArray<ByteString> include_paths, bool json_errors, bool dump_type_hints, bool dump_try_hints, bool optimize, JaktInternal::Optional<ByteString> target_triple, JaktInternal::Dictionary<ByteString,ByteString> user_configuration, Jakt::jakt__path::Path binary_dir, Jakt::jakt__path::Path exports_dir, JaktInternal::Optional<Jakt::jakt__path::Path> assume_main_file_path);
