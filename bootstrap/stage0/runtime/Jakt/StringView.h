...
[[nodiscard]] ALWAYS_INLINE AK_STRING_VIEW_LITERAL_CONSTEVAL Jakt::StringView operator"" sv(char const* cstring, size_t length)
{
    return Jakt::StringView(cstring, length);
}
