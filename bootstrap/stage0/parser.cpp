...
return (base->equals(rhs_base) && (name == rhs_name)) && (generic_args.operator[](JaktInternal::Range<i64>{static_cast<i64>(0LL),static_cast<i64>(9223372036854775807LL)}) == rhs_generic_args.operator[](JaktInternal::Range<i64>{static_cast<i64>(0LL),static_cast<i64>(9223372036854775807LL)}));};/*case end*/
default:return false;}/*switch end*/
}};/*case end*/
case 0 /* Name */: {
