...
builder.appendff("external_name: {}, ", external_name);
JaktInternal::PrettyPrint::must_output_indentation(builder);
builder.appendff("is_autogenerated: {}", is_autogenerated);
}
builder.append(")"sv);return builder.to_string(); }
...
Jakt::parser::ParsedVarDecl::ParsedVarDecl(ByteString a_name, NonnullRefPtr<typename Jakt::parser::ParsedType> a_parsed_type, bool a_is_mutable, JaktInternal::Optional<Jakt::utility::Span> a_inlay_span, Jakt::utility::Span a_span, JaktInternal::Optional<Jakt::parser::ExternalName> a_external_name, bool a_is_autogenerated): name(move(a_name)), parsed_type(move(a_parsed_type)), is_mutable(move(a_is_mutable)), inlay_span(move(a_inlay_span)), span(move(a_span)), external_name(move(a_external_name)), is_autogenerated(move(a_is_autogenerated)){}
...
var_decls.push(Jakt::parser::ParsedVarDecl(ByteString::from_utf8_without_validation(""sv),this->parse_typename(),false,JaktInternal::OptionalNone(),this->current().span(),JaktInternal::OptionalNone(),false));
}
...
return Jakt::parser::ParsedVarDecl(name,Jakt::parser::ParsedType::Empty(JaktInternal::OptionalNone()),is_mutable,span,span,JaktInternal::OptionalNone(),false);
}
...
return Jakt::parser::ParsedVarDecl(name,parsed_type,is_mutable,JaktInternal::OptionalNone(),span,JaktInternal::OptionalNone(),false);
}
else {
return Jakt::parser::ParsedVarDecl(ByteString::from_utf8_without_validation(""sv),Jakt::parser::ParsedType::Empty(JaktInternal::OptionalNone()),false,JaktInternal::OptionalNone(),span,JaktInternal::OptionalNone(),false);
}
...
Jakt::parser::ParsedVarDecl tuple_var_decl = Jakt::parser::ParsedVarDecl(ByteString::from_utf8_without_validation(""sv),Jakt::parser::ParsedType::Empty(JaktInternal::OptionalNone()),is_mutable,JaktInternal::OptionalNone(),this->current().span(),JaktInternal::OptionalNone(),false);
if (this->current().__jakt_init_index() == 7 /* LParen */){
...
tuple_var_decl.is_autogenerated = true;
...
return_statement = Jakt::parser::ParsedStatement::DestructuringDeclaration(vars,old_return_statement,Jakt::parser::merge_spans(start,this->previous().span()));
}
...
Jakt::parser::ParsedVarDecl tuple_var_decl = Jakt::parser::ParsedVarDecl(tuple_var_name,Jakt::parser::ParsedType::Empty(JaktInternal::OptionalNone()),false,JaktInternal::OptionalNone(),this->current().span(),JaktInternal::OptionalNone(),false);
...
NonnullRefPtr<typename Jakt::parser::ParsedStatement> const destructured_vars_stmt = Jakt::parser::ParsedStatement::DestructuringDeclaration(destructured_var_decls,var_decl,Jakt::parser::merge_spans(start_span,this->previous().span()));
...
builder.append("ParsedStatement::DestructuringDeclaration"sv);
...
[[nodiscard]] NonnullRefPtr<ParsedStatement> ParsedStatement::DestructuringDeclaration(JaktInternal::DynamicArray<Jakt::parser::ParsedVarDecl> vars, NonnullRefPtr<typename Jakt::parser::ParsedStatement> var_decl, Jakt::utility::Span span){
NonnullRefPtr<ParsedStatement> __jakt_uninit_enum = adopt_ref(*new ParsedStatement);
__jakt_uninit_enum->__jakt_variant_index = 4;
...
break;
case 3 /* DestructuringDeclaration */:this->as.DestructuringDeclaration.vars.~DynamicArray();
...
case 3 /* DestructuringDeclaration */: {
auto&& __jakt_match_value = __jakt_match_variant.as.DestructuringDeclaration;JaktInternal::DynamicArray<Jakt::parser::ParsedVarDecl> const& lhs_vars = __jakt_match_value.vars;
NonnullRefPtr<typename Jakt::parser::ParsedStatement> const& lhs_var_decl = __jakt_match_value.var_decl;
{auto&& __jakt_match_variant = *rhs_statement;
switch(__jakt_match_variant.__jakt_init_index()) {
case 3 /* DestructuringDeclaration */: {
auto&& __jakt_match_value = __jakt_match_variant.as.DestructuringDeclaration;JaktInternal::DynamicArray<Jakt::parser::ParsedVarDecl> const& rhs_vars = __jakt_match_value.vars;
