...
ErrorOr<JaktInternal::Tuple<NonnullRefPtr<parser::ParsedExpression>,JaktInternal::Optional<parser::ParsedBlock>,JaktInternal::Optional<NonnullRefPtr<parser::ParsedStatement>>>> expand_context_for_bindings(const NonnullRefPtr<parser::ParsedExpression> condition, const JaktInternal::Optional<NonnullRefPtr<parser::ParsedExpression>> acc, const JaktInternal::Optional<parser::ParsedBlock> then_block, const JaktInternal::Optional<NonnullRefPtr<parser::ParsedStatement>> else_statement, const utility::Span span);
...
ErrorOr<void> check_implicit_constructor_argument_access(const types::ScopeId caller_scope_id, const parser::ParsedCall call, const types::CheckedStruct struct_);
...
ErrorOr<NonnullRefPtr<types::CheckedExpression>> typecheck_indexed_struct(const NonnullRefPtr<parser::ParsedExpression> expr, const String field_name, const types::ScopeId scope_id, const bool is_optional, const types::SafetyMode safety_mode, const utility::Span span);
