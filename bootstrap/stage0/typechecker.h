...
public: JaktInternal::Optional<types::FieldRecord> lookup_struct_field(ids::StructId const struct_id, ByteString const name) const;
...
public: jakt__path::Path get_root_path() const;
...
public: bool scope_can_access(ids::ScopeId const accessor, ids::ScopeId const accessee) const;
...
public: ErrorOr<void> typecheck_enum(parser::ParsedRecord const record, ids::EnumId const enum_id, ids::ScopeId const parent_scope_id);
...
public: ErrorOr<void> check_type_argument_requirements(ids::TypeId const generic_argument, JaktInternal::DynamicArray<ids::TraitId> const constraints, utility::Span const arg_span, ids::ScopeId const scope_id);
...
public: ErrorOr<NonnullRefPtr<typename types::CheckedExpression>> typecheck_must(NonnullRefPtr<typename parser::ParsedExpression> const expr, utility::Span const span, ids::ScopeId const scope_id, types::SafetyMode const safety_mode, JaktInternal::Optional<ids::TypeId> const type_hint);
...
public: JaktInternal::Optional<types::CheckedEnumVariant> get_enum_variant(types::CheckedEnum const enum_, ByteString const variant_name);
