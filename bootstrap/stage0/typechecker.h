...
struct MatchSuccess {
JaktInternal::DynamicArray<NonnullRefPtr<types::CheckedExpression>> args;
...
ErrorOr<NonnullRefPtr<types::CheckedExpression>> typecheck_set(JaktInternal::DynamicArray<NonnullRefPtr<parser::ParsedExpression>> const values, utility::Span const span, types::ScopeId const scope_id, types::SafetyMode const safety_mode, JaktInternal::Optional<types::TypeId> const type_hint);
...
ErrorOr<types::TypeId> typecheck_typename(NonnullRefPtr<parser::ParsedType> const parsed_type, types::ScopeId const scope_id, JaktInternal::Optional<DeprecatedString> const name);
...
ErrorOr<NonnullRefPtr<types::CheckedExpression>> typecheck_dictionary(JaktInternal::DynamicArray<JaktInternal::Tuple<NonnullRefPtr<parser::ParsedExpression>,NonnullRefPtr<parser::ParsedExpression>>> const values, utility::Span const span, types::ScopeId const scope_id, types::SafetyMode const safety_mode, JaktInternal::Optional<types::TypeId> const type_hint);
...
ErrorOr<bool> check_restricted_access(types::ScopeId const accessor, DeprecatedString const accessee_kind, types::ScopeId const accessee, DeprecatedString const name, JaktInternal::DynamicArray<NonnullRefPtr<types::MaybeResolvedScope>> const whitelist, utility::Span const span);
...
ErrorOr<NonnullRefPtr<types::CheckedExpression>> typecheck_array(types::ScopeId const scope_id, JaktInternal::DynamicArray<NonnullRefPtr<parser::ParsedExpression>> const values, JaktInternal::Optional<NonnullRefPtr<parser::ParsedExpression>> const fill_size, utility::Span const span, types::SafetyMode const safety_mode, JaktInternal::Optional<types::TypeId> const type_hint);
...
ErrorOr<NonnullRefPtr<types::CheckedStatement>> typecheck_destructuring_assignment(JaktInternal::DynamicArray<parser::ParsedVarDecl> const vars, NonnullRefPtr<parser::ParsedStatement> const var_decl, types::ScopeId const scope_id, types::SafetyMode const safety_mode, utility::Span const span);
...
ErrorOr<bool> validate_argument_label(types::CheckedParameter const param, DeprecatedString const label, utility::Span const span, NonnullRefPtr<parser::ParsedExpression> const expr, JaktInternal::Optional<NonnullRefPtr<types::CheckedExpression>> const default_value);
...
ErrorOr<NonnullRefPtr<types::CheckedExpression>> typecheck_indexed_struct(NonnullRefPtr<parser::ParsedExpression> const expr, DeprecatedString const field_name, types::ScopeId const scope_id, bool const is_optional, types::SafetyMode const safety_mode, utility::Span const span);
...
ErrorOr<NonnullRefPtr<types::CheckedExpression>> typecheck_try_block(NonnullRefPtr<parser::ParsedStatement> const stmt, DeprecatedString const error_name, utility::Span const error_span, parser::ParsedBlock const catch_block, types::ScopeId const scope_id, types::SafetyMode const safety_mode, utility::Span const span);
ErrorOr<types::CheckedUnaryOperator> typecheck_is_enum_variant(NonnullRefPtr<types::CheckedExpression> const checked_expr, NonnullRefPtr<parser::ParsedType> const inner, JaktInternal::DynamicArray<parser::EnumVariantPatternArgument> const bindings, types::ScopeId const scope_id);
...
ErrorOr<NonnullRefPtr<types::CheckedExpression>> typecheck_match(NonnullRefPtr<parser::ParsedExpression> const expr, JaktInternal::DynamicArray<parser::ParsedMatchCase> const cases, utility::Span const span, types::ScopeId const scope_id, types::SafetyMode const safety_mode, JaktInternal::Optional<types::TypeId> const type_hint);
...
ErrorOr<NonnullRefPtr<types::CheckedStatement>> typecheck_for(DeprecatedString const iterator_name, utility::Span const name_span, NonnullRefPtr<parser::ParsedExpression> const range, parser::ParsedBlock const block, types::ScopeId const scope_id, types::SafetyMode const safety_mode, utility::Span const span);
