...
public: ErrorOr<JaktInternal::Optional<JaktInternal::DynamicArray<Jakt::ids::TypeId>>> get_type_ids_from_type_hint_if_struct_ids_match(JaktInternal::Optional<Jakt::ids::TypeId> const type_hint, Jakt::ids::StructId const expected_struct_id) const;
...
public: ErrorOr<Jakt::types::CheckedBlock> typecheck_block(Jakt::parser::ParsedBlock const parsed_block, Jakt::ids::ScopeId const parent_scope_id, Jakt::types::SafetyMode const safety_mode, JaktInternal::Optional<Jakt::ids::TypeId> const yield_type_hint);
...
public: ErrorOr<Jakt::ids::TypeId> typecheck_typename(NonnullRefPtr<typename Jakt::parser::ParsedType> const parsed_type, Jakt::ids::ScopeId const scope_id, JaktInternal::Optional<ByteString> const name);
...
public: ErrorOr<NonnullRefPtr<typename Jakt::types::CheckedStatement>> typecheck_statement(NonnullRefPtr<typename Jakt::parser::ParsedStatement> const statement, Jakt::ids::ScopeId const scope_id, Jakt::types::SafetyMode const safety_mode, JaktInternal::Optional<Jakt::ids::TypeId> const type_hint);
public: ErrorOr<NonnullRefPtr<typename Jakt::types::CheckedStatement>> typecheck_yield(JaktInternal::Optional<NonnullRefPtr<typename Jakt::parser::ParsedExpression>> const expr, Jakt::utility::Span const span, Jakt::ids::ScopeId const scope_id, Jakt::types::SafetyMode const safety_mode, JaktInternal::Optional<Jakt::ids::TypeId> const type_hint);
...
public: ErrorOr<NonnullRefPtr<typename Jakt::types::CheckedStatement>> typecheck_if(NonnullRefPtr<typename Jakt::parser::ParsedExpression> const condition, Jakt::parser::ParsedBlock const then_block, JaktInternal::Optional<NonnullRefPtr<typename Jakt::parser::ParsedStatement>> const else_statement, Jakt::ids::ScopeId const scope_id, Jakt::types::SafetyMode const safety_mode, Jakt::utility::Span const span);
...
public: ErrorOr<NonnullRefPtr<typename Jakt::types::CheckedExpression>> typecheck_expression_and_dereference_if_needed(NonnullRefPtr<typename Jakt::parser::ParsedExpression> const expr, Jakt::ids::ScopeId const scope_id, Jakt::types::SafetyMode const safety_mode, JaktInternal::Optional<Jakt::ids::TypeId> const type_hint, Jakt::utility::Span const span);
...
public: ErrorOr<NonnullRefPtr<typename Jakt::types::CheckedExpression>> infer_signed_int(i64 const val, Jakt::utility::Span const span, JaktInternal::Optional<Jakt::ids::TypeId> const type_hint);
public: ErrorOr<NonnullRefPtr<typename Jakt::types::CheckedExpression>> infer_unsigned_int(u64 const val, Jakt::utility::Span const span, JaktInternal::Optional<Jakt::ids::TypeId> const type_hint);
...
public: ErrorOr<NonnullRefPtr<typename Jakt::types::CheckedExpression>> typecheck_expression(NonnullRefPtr<typename Jakt::parser::ParsedExpression> const expr, Jakt::ids::ScopeId const scope_id, Jakt::types::SafetyMode const safety_mode, JaktInternal::Optional<Jakt::ids::TypeId> const type_hint);
public: ErrorOr<NonnullRefPtr<typename Jakt::types::CheckedExpression>> typecheck_must(NonnullRefPtr<typename Jakt::parser::ParsedExpression> const expr, Jakt::utility::Span const span, Jakt::ids::ScopeId const scope_id, Jakt::types::SafetyMode const safety_mode, JaktInternal::Optional<Jakt::ids::TypeId> const type_hint);
...
public: ErrorOr<NonnullRefPtr<typename Jakt::types::CheckedExpression>> typecheck_namespaced_var_or_simple_enum_constructor_call(ByteString const name, JaktInternal::DynamicArray<ByteString> const namespace_, Jakt::ids::ScopeId const scope_id, Jakt::types::SafetyMode const safety_mode, JaktInternal::Optional<Jakt::ids::TypeId> const type_hint, Jakt::utility::Span const span);
public: ErrorOr<NonnullRefPtr<typename Jakt::types::CheckedExpression>> typecheck_array(Jakt::ids::ScopeId const scope_id, JaktInternal::DynamicArray<NonnullRefPtr<typename Jakt::parser::ParsedExpression>> const values, JaktInternal::Optional<NonnullRefPtr<typename Jakt::parser::ParsedExpression>> const fill_size, Jakt::utility::Span const span, Jakt::types::SafetyMode const safety_mode, JaktInternal::Optional<Jakt::ids::TypeId> const type_hint);
public: ErrorOr<NonnullRefPtr<typename Jakt::types::CheckedExpression>> typecheck_set(JaktInternal::DynamicArray<NonnullRefPtr<typename Jakt::parser::ParsedExpression>> const values, Jakt::utility::Span const span, Jakt::ids::ScopeId const scope_id, Jakt::types::SafetyMode const safety_mode, JaktInternal::Optional<Jakt::ids::TypeId> const type_hint);
...
public: ErrorOr<JaktInternal::Tuple<JaktInternal::Optional<ByteString>,Jakt::types::CheckedMatchCase,JaktInternal::Optional<Jakt::ids::TypeId>>> typecheck_match_variant(Jakt::parser::ParsedMatchCase const case_, Jakt::ids::TypeId const subject_type_id, size_t const variant_index, JaktInternal::Optional<Jakt::ids::TypeId> const final_result_type, Jakt::types::CheckedEnumVariant const variant, JaktInternal::DynamicArray<Jakt::parser::EnumVariantPatternArgument> const variant_arguments, JaktInternal::Dictionary<ByteString,Jakt::parser::ParsedPatternDefault> const default_bindings, Jakt::utility::Span const arguments_span, Jakt::ids::ScopeId const scope_id, Jakt::types::SafetyMode const safety_mode);
public: ErrorOr<NonnullRefPtr<typename Jakt::types::CheckedExpression>> typecheck_match(NonnullRefPtr<typename Jakt::parser::ParsedExpression> const expr, JaktInternal::DynamicArray<Jakt::parser::ParsedMatchCase> const cases, Jakt::utility::Span const span, Jakt::ids::ScopeId const scope_id, Jakt::types::SafetyMode const safety_mode, JaktInternal::Optional<Jakt::ids::TypeId> const type_hint);
public: ErrorOr<JaktInternal::Tuple<Jakt::types::CheckedMatchBody,JaktInternal::Optional<Jakt::ids::TypeId>>> typecheck_match_body(Jakt::parser::ParsedMatchBody const body, Jakt::ids::ScopeId const scope_id, Jakt::types::SafetyMode const safety_mode, Jakt::types::GenericInferences& generic_inferences, JaktInternal::Optional<Jakt::ids::TypeId> const final_result_type, Jakt::utility::Span const span);
public: ErrorOr<NonnullRefPtr<typename Jakt::types::CheckedExpression>> typecheck_dictionary(JaktInternal::DynamicArray<JaktInternal::Tuple<NonnullRefPtr<typename Jakt::parser::ParsedExpression>,NonnullRefPtr<typename Jakt::parser::ParsedExpression>>> const values, Jakt::utility::Span const span, Jakt::ids::ScopeId const scope_id, Jakt::types::SafetyMode const safety_mode, JaktInternal::Optional<Jakt::ids::TypeId> const type_hint);
