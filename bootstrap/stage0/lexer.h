...
struct Lexer {
  public:
size_t index;JaktInternal::DynamicArray<u8> input;NonnullRefPtr<compiler::Compiler> compiler;JaktInternal::Optional<JaktInternal::DynamicArray<u8>> comment_contents;JaktInternal::Set<DeprecatedString> illegal_cpp_keywords;ErrorOr<JaktInternal::Optional<DeprecatedString>> consume_comment_contents();
...
bool eof() const;
Lexer(size_t a_index, JaktInternal::DynamicArray<u8> a_input, NonnullRefPtr<compiler::Compiler> a_compiler, JaktInternal::Optional<JaktInternal::DynamicArray<u8>> a_comment_contents, JaktInternal::Set<DeprecatedString> a_illegal_cpp_keywords);
