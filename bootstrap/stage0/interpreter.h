...
NonnullRefPtr<compiler::Compiler> compiler;NonnullRefPtr<types::CheckedProgram> program;JaktInternal::DynamicArray<utility::Span> spans;JaktInternal::Dictionary<DeprecatedString,types::Value> reflected_type_cache;JaktInternal::Set<DeprecatedString> seen_reflected_types;JaktInternal::Optional<types::FunctionId> current_function_id;NonnullRefPtr<types::TypecheckFunctions> typecheck_functions;ErrorOr<void> update_binding(NonnullRefPtr<typename types::CheckedExpression> const binding, NonnullRefPtr<interpreter::InterpreterScope> scope, types::Value const value, utility::Span const span);
protected:
...
ErrorOr<types::Value> reflect_methods(utility::Span const span);
