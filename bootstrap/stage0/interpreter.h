...
private: ErrorOr<interpreter::StatementResult> call_compiler_interface_function(NonnullRefPtr<types::CheckedFunction> const function, JaktInternal::DynamicArray<types::Value> const arguments, utility::Span const call_span);
