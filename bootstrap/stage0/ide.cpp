...
__jakt_var_809 = Jakt::DeprecatedString("struct"sv); goto __jakt_label_725;
...
__jakt_var_810 = Jakt::DeprecatedString("class"sv); goto __jakt_label_726;
...
__jakt_var_812 = Jakt::DeprecatedString("enum"sv); goto __jakt_label_728;
...
__jakt_var_813 = output; goto __jakt_label_729;
...
__jakt_var_814 = (TRY((DynamicArray<JaktInternal::Tuple<JaktInternal::Optional<DeprecatedString>,types::TypeId>>::create_with({(Tuple{string_none, type_id})})))); goto __jakt_label_730;
...
__jakt_var_815 = ((expr)->to_number_constant(program)); goto __jakt_label_731;
...
__jakt_var_817 = TRY((__jakt_format(Jakt::DeprecatedString("fn({}) -> {}"sv),utility::join(param_names,Jakt::DeprecatedString(", "sv)),return_type))); goto __jakt_label_733;
...
return JaktInternal::ExplicitValue(Jakt::DeprecatedString(""sv));
    ...
    if (_jakt_value.is_return())
        return _jakt_value.release_return();
    _jakt_value.release_value();
}) + Jakt::DeprecatedString("enum "sv)) + ((enum_).name)); goto __jakt_label_734;
...
utility::panic(Jakt::DeprecatedString("unreachable: should've been struct"sv));
    ...
    if (_jakt_value.is_return())
        return _jakt_value.release_return();
    _jakt_value.release_value();
}) + ((struct_).name)); goto __jakt_label_735;
...
__jakt_var_823 = (output + Jakt::DeprecatedString(">"sv)); goto __jakt_label_739;
...
__jakt_var_824 = TRY((ide::completions_for_type_id(program,type_id))); goto __jakt_label_740;
...
__jakt_var_825 = TRY((ide::completions_for_type_id(program,result_type_id))); goto __jakt_label_741;
...
__jakt_var_826 = TRY((__jakt_format(Jakt::DeprecatedString("{} {}: {}"sv),mut_string,name,type_name))); goto __jakt_label_742;
...
__jakt_var_827 = TRY((ide::find_type_definition_for_type_id(program,type_id,span))); goto __jakt_label_743;
...
__jakt_var_828 = ((((program)->get_function(function_id)))->name_span); goto __jakt_label_744;
...
__jakt_var_830 = TRY((ide::find_span_in_expression(program,rhs,span))); goto __jakt_label_746;
...
__jakt_var_836 = TRY((ide::find_span_in_expression(program,index,span))); goto __jakt_label_752;
...
__jakt_var_843 = (TRY((Set<DeprecatedString>::create_with_values({TRY((__jakt_format(Jakt::DeprecatedString("else ({})"sv),TRY((((program)->type_name(type_id,false)))))))})))); goto __jakt_label_759;
...
__jakt_var_844 = static_cast<JaktInternal::Optional<ide::Usage>>( ide::Usage { typename ide::Usage::NameSet(cases_array) } ); goto __jakt_label_760;
...
__jakt_var_837 = TRY((ide::find_span_in_expression(program,expr,span))); goto __jakt_label_753;
...
__jakt_var_845 = none; goto __jakt_label_761;
...
__jakt_var_846 = TRY((ide::find_span_in_block(program,catch_block,span))); goto __jakt_label_762;
...
__jakt_var_848 = none; goto __jakt_label_764;
...
__jakt_var_852 = static_cast<JaktInternal::Optional<DeprecatedString>>(output); goto __jakt_label_768;
...
auto&& __jakt_match_value = __jakt_match_variant.template get<types::Type::GenericInstance>();types::StructId const& struct_id = __jakt_match_value.id;
JaktInternal::DynamicArray<types::TypeId> const& args = __jakt_match_value.args;
return JaktInternal::ExplicitValue(({ Optional<utility::Span> __jakt_var_854; {
...
__jakt_var_854 = output; goto __jakt_label_770;
...
__jakt_var_855 = none; goto __jakt_label_771;
...
__jakt_var_858 = TRY((ide::find_span_in_block(program,block,span))); goto __jakt_label_774;
...
__jakt_var_859 = TRY((ide::find_span_in_statement(program,var_decl,span))); goto __jakt_label_775;
