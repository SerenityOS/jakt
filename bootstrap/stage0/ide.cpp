...
__jakt_var_869 = (ByteString::from_utf8_without_validation("struct"sv)); goto __jakt_label_755;
...
__jakt_var_870 = (ByteString::from_utf8_without_validation("class"sv)); goto __jakt_label_756;
...
return JaktInternal::ExplicitValue(({ Optional<ByteString> __jakt_var_872; {
{
...
__jakt_var_872 = (ByteString::from_utf8_without_validation("enum"sv)); goto __jakt_label_758;
...
__jakt_var_873 = output; goto __jakt_label_759;
...
__jakt_var_875 = ((((program)->get_function(function_id)))->name_span); goto __jakt_label_761;
...
case 2 /* Typename */: {
auto&& __jakt_match_value = __jakt_match_variant.as.Typename;ids::TypeId const& type_id = __jakt_match_value.value;
return JaktInternal::ExplicitValue(({ Optional<utility::Span> __jakt_var_876; {
__jakt_var_876 = TRY((ide::find_type_definition_for_type_id(program,type_id,span))); goto __jakt_label_762;
...
__jakt_var_880 = static_cast<JaktInternal::Optional<ByteString>>(output); goto __jakt_label_766;
...
return JaktInternal::ExplicitValue(({ Optional<JaktInternal::Optional<ByteString>> __jakt_var_881; {
ByteString const result = TRY((ide::get_enum_variant_signature(program,name,type_id,variants,number_constant)));
__jakt_var_881 = static_cast<JaktInternal::Optional<ByteString>>(result); goto __jakt_label_767;
...
__jakt_var_882 = TRY((ide::completions_for_type_id(program,type_id))); goto __jakt_label_768;
...
case 1 /* Call */: {
auto&& __jakt_match_value = __jakt_match_variant.as.Call;ids::FunctionId const& function_id = __jakt_match_value.value;
return JaktInternal::ExplicitValue(({ Optional<JaktInternal::DynamicArray<ByteString>> __jakt_var_883; {
ids::TypeId const result_type_id = ((((program)->get_function(function_id)))->return_type_id);
__jakt_var_883 = TRY((ide::completions_for_type_id(program,result_type_id))); goto __jakt_label_769;
...
__jakt_var_885 = output; goto __jakt_label_771;
...
__jakt_var_886 = none; goto __jakt_label_772;
...
__jakt_var_887 = TRY((ide::find_span_in_block(program,block,span))); goto __jakt_label_773;
...
__jakt_var_888 = TRY((ide::find_span_in_statement(program,var_decl,span))); goto __jakt_label_774;
...
__jakt_var_889 = TRY((ide::find_span_in_expression(program,rhs,span))); goto __jakt_label_775;
...
__jakt_var_894 = none; goto __jakt_label_780;
...
__jakt_var_895 = TRY((ide::find_span_in_expression(program,index,span))); goto __jakt_label_781;
...
__jakt_var_901 = names; goto __jakt_label_787;

}
__jakt_label_787:; __jakt_var_901.release_value(); }));
};/*case end*/
default: {
return JaktInternal::ExplicitValue(({ Optional<JaktInternal::Set<ByteString>> __jakt_var_902; {
__jakt_var_902 = Set<ByteString>::create_with_values({__jakt_format((StringView::from_string_literal("else ({})"sv)),TRY((((program)->type_name(type_id,false)))))}); goto __jakt_label_788;
...
__jakt_var_903 = static_cast<JaktInternal::Optional<ide::Usage>>(ide::Usage::NameSet(cases_array)); goto __jakt_label_789;
...
__jakt_var_896 = TRY((ide::find_span_in_expression(program,expr,span))); goto __jakt_label_782;
...
__jakt_var_904 = none; goto __jakt_label_790;
...
__jakt_var_905 = TRY((ide::find_span_in_block(program,catch_block,span))); goto __jakt_label_791;
...
__jakt_var_907 = none; goto __jakt_label_793;
...
__jakt_var_908 = __jakt_format((StringView::from_string_literal("{} {}: {}"sv)),mut_string,name,type_name); goto __jakt_label_794;
...
__jakt_var_909 = __jakt_format((StringView::from_string_literal("fn({}) -> {}"sv)),utility::join(param_names,(ByteString::from_utf8_without_validation(", "sv))),return_type); goto __jakt_label_795;
...
return JaktInternal::ExplicitValue((ByteString::from_utf8_without_validation(""sv)));
    ...
    if (_jakt_value.is_return())
        return _jakt_value.release_return();
    _jakt_value.release_value();
})) + ((ByteString::from_utf8_without_validation("enum "sv))))) + (((enum_).name))); goto __jakt_label_796;
...
utility::panic((ByteString::from_utf8_without_validation("unreachable: should've been struct"sv)));
    ...
    if (_jakt_value.is_return())
        return _jakt_value.release_return();
    _jakt_value.release_value();
})) + (((struct_).name))); goto __jakt_label_797;
...
__jakt_var_915 = ((output) + ((ByteString::from_utf8_without_validation(">"sv)))); goto __jakt_label_801;
...
__jakt_var_916 = ((expr)->to_number_constant(program)); goto __jakt_label_802;

}
__jakt_label_802:; __jakt_var_916.release_value(); }));
};/*case end*/
default: {
return JaktInternal::ExplicitValue(({ Optional<JaktInternal::Optional<types::NumberConstant>> __jakt_var_917; {
JaktInternal::Optional<types::NumberConstant> const none = JaktInternal::OptionalNone();
__jakt_var_917 = none; goto __jakt_label_803;
...
__jakt_var_918 = output; goto __jakt_label_804;
...
return JaktInternal::ExplicitValue(({ Optional<JaktInternal::DynamicArray<JaktInternal::Tuple<JaktInternal::Optional<ByteString>,ids::TypeId>>> __jakt_var_919; {
JaktInternal::Optional<ByteString> const string_none = JaktInternal::OptionalNone();
__jakt_var_919 = DynamicArray<JaktInternal::Tuple<JaktInternal::Optional<ByteString>,ids::TypeId>>::create_with({(Tuple{string_none, type_id})}); goto __jakt_label_805;

}
__jakt_label_805:; __jakt_var_919.release_value(); }));
};/*case end*/
default: {
