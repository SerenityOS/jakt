...
__jakt_var_818 = Jakt::DeprecatedString("struct"sv); goto __jakt_label_726;
...
__jakt_var_819 = Jakt::DeprecatedString("class"sv); goto __jakt_label_727;
...
__jakt_var_820 = Jakt::DeprecatedString("enum"sv); goto __jakt_label_728;
...
__jakt_var_821 = Jakt::DeprecatedString("enum"sv); goto __jakt_label_729;
...
return JaktInternal::ExplicitValue(({ Optional<JaktInternal::DynamicArray<JaktInternal::Tuple<JaktInternal::Optional<DeprecatedString>,types::TypeId>>> __jakt_var_822; {
...
__jakt_var_822 = output; goto __jakt_label_730;
...
return JaktInternal::ExplicitValue(({ Optional<JaktInternal::DynamicArray<JaktInternal::Tuple<JaktInternal::Optional<DeprecatedString>,types::TypeId>>> __jakt_var_823; {
JaktInternal::Optional<DeprecatedString> const string_none = JaktInternal::OptionalNone();
__jakt_var_823 = (TRY((DynamicArray<JaktInternal::Tuple<JaktInternal::Optional<DeprecatedString>,types::TypeId>>::create_with({(Tuple{string_none, type_id})})))); goto __jakt_label_731;
...
return JaktInternal::ExplicitValue(({ Optional<JaktInternal::Optional<types::NumberConstant>> __jakt_var_824; {
__jakt_var_824 = ((expr)->to_number_constant(program)); goto __jakt_label_732;

}
__jakt_label_732:; __jakt_var_824.release_value(); }));
};/*case end*/
default: {
return JaktInternal::ExplicitValue(({ Optional<JaktInternal::Optional<types::NumberConstant>> __jakt_var_825; {
JaktInternal::Optional<types::NumberConstant> const none = JaktInternal::OptionalNone();
__jakt_var_825 = none; goto __jakt_label_733;
...
__jakt_var_826 = TRY((__jakt_format(Jakt::DeprecatedString("fn({}) -> {}"sv),utility::join(param_names,Jakt::DeprecatedString(", "sv)),return_type))); goto __jakt_label_734;
...
__jakt_var_827 = ((JAKT_RESOLVE_EXPLICIT_VALUE_OR_CONTROL_FLOW_RETURN_ONLY(([&]() -> JaktInternal::ExplicitValueOrControlFlow<DeprecatedString,ErrorOr<DeprecatedString>>{
...
return JaktInternal::ExplicitValue(Jakt::DeprecatedString(""sv));
 ...
 + Jakt::DeprecatedString("enum "sv)) + ((enum_).name)); goto __jakt_label_735;
...
__jakt_var_828 = (JAKT_RESOLVE_EXPLICIT_VALUE_OR_CONTROL_FLOW_RETURN_ONLY(([&]() -> JaktInternal::ExplicitValueOrControlFlow<DeprecatedString, ErrorOr<DeprecatedString>>{
...
__jakt_var_829 = (output + Jakt::DeprecatedString(">"sv)); goto __jakt_label_737;
...
__jakt_var_830 = (output + Jakt::DeprecatedString(">"sv)); goto __jakt_label_738;
...
__jakt_var_831 = (output + Jakt::DeprecatedString(">"sv)); goto __jakt_label_739;
...
JaktInternal::DynamicArray<types::TypeId> const& args = __jakt_match_value.args;
return JaktInternal::ExplicitValue(({ Optional<DeprecatedString> __jakt_var_832; {
...
__jakt_var_832 = (output + Jakt::DeprecatedString(">"sv)); goto __jakt_label_740;
...
return JaktInternal::ExplicitValue(({ Optional<JaktInternal::DynamicArray<DeprecatedString>> __jakt_var_833; {
__jakt_var_833 = TRY((ide::completions_for_type_id(program,type_id))); goto __jakt_label_741;
...
return JaktInternal::ExplicitValue(({ Optional<JaktInternal::DynamicArray<DeprecatedString>> __jakt_var_834; {
types::TypeId const result_type_id = ((((program)->get_function(function_id)))->return_type_id);
__jakt_var_834 = TRY((ide::completions_for_type_id(program,result_type_id))); goto __jakt_label_742;
...
switch(__jakt_match_variant.index()) {
case 0: {
return JaktInternal::ExplicitValue(({ Optional<DeprecatedString> __jakt_var_835; {
...
__jakt_var_835 = TRY((__jakt_format(Jakt::DeprecatedString("{} {}: {}"sv),mut_string,name,type_name))); goto __jakt_label_743;
...
return JaktInternal::ExplicitValue(({ Optional<utility::Span> __jakt_var_836; {
__jakt_var_836 = TRY((ide::find_type_definition_for_type_id(program,type_id,span))); goto __jakt_label_744;
...
auto&& __jakt_match_value = __jakt_match_variant.template get<typename ide::Usage::Call>();
types::FunctionId const& function_id = __jakt_match_value.value;
return JaktInternal::ExplicitValue(({ Optional<utility::Span> __jakt_var_837; {
__jakt_var_837 = ((((program)->get_function(function_id)))->name_span); goto __jakt_label_745;
...
auto&& __jakt_match_value = __jakt_match_variant.template get<typename ide::Usage::Typename>();
types::TypeId const& type_id = __jakt_match_value.value;
return JaktInternal::ExplicitValue(({ Optional<utility::Span> __jakt_var_838; {
__jakt_var_838 = TRY((ide::find_type_definition_for_type_id(program,type_id,span))); goto __jakt_label_746;
...
__jakt_var_839 = TRY((ide::find_span_in_expression(program,rhs,span))); goto __jakt_label_747;
...
__jakt_var_840 = none; goto __jakt_label_748;
...
__jakt_var_841 = none; goto __jakt_label_749;
...
__jakt_var_842 = none; goto __jakt_label_750;
...
__jakt_var_843 = none; goto __jakt_label_751;
...
__jakt_var_844 = none; goto __jakt_label_752;
...
__jakt_var_845 = TRY((ide::find_span_in_expression(program,index,span))); goto __jakt_label_753;
...
__jakt_var_847 = JAKT_RESOLVE_EXPLICIT_VALUE_OR_CONTROL_FLOW_AT_LOOP_NESTED_MATCH(([&]() -> JaktInternal::ExplicitValueOrControlFlow<JaktInternal::Optional<ide::Usage>, ErrorOr<JaktInternal::Optional<ide::Usage>>>{
...
__jakt_var_848 = JAKT_RESOLVE_EXPLICIT_VALUE_OR_CONTROL_FLOW_AT_LOOP_NESTED_MATCH(([&]() -> JaktInternal::ExplicitValueOrControlFlow<JaktInternal::Optional<ide::Usage>, ErrorOr<JaktInternal::Optional<ide::Usage>>>{
auto&& __jakt_match_variant = body;
switch(__jakt_match_variant.index()) {
case 1: {
auto&& __jakt_match_value = __jakt_match_variant.template get<typename types::CheckedMatchBody::Block>();
...
auto&& __jakt_match_value = __jakt_match_variant.template get<typename types::Type::Enum>();
types::EnumId const& enum_id = __jakt_match_value.value;
return JaktInternal::ExplicitValue(({ Optional<JaktInternal::Set<DeprecatedString>> __jakt_var_850; {
...
__jakt_var_850 = names; goto __jakt_label_758;
...
return JaktInternal::ExplicitValue(({ Optional<JaktInternal::Set<DeprecatedString>> __jakt_var_851; {
JaktInternal::Set<DeprecatedString> names = (TRY((Set<DeprecatedString>::create_with_values({}))));
types::CheckedEnum const enum_ = ((program)->get_enum(enum_id));
{
JaktInternal::ArrayIterator<types::CheckedEnumVariant> _magic = ((((enum_).variants)).iterator());
...
__jakt_var_851 = names; goto __jakt_label_759;

}
__jakt_label_759:; __jakt_var_851.release_value(); }));
};/*case end*/
default: {
return JaktInternal::ExplicitValue(({ Optional<JaktInternal::Set<DeprecatedString>> __jakt_var_852; {
__jakt_var_852 = (TRY((Set<DeprecatedString>::create_with_values({TRY((__jakt_format(Jakt::DeprecatedString("else ({})"sv),TRY((((program)->type_name(type_id,false)))))))})))); goto __jakt_label_760;
...
__jakt_var_849 = JAKT_RESOLVE_EXPLICIT_VALUE_OR_CONTROL_FLOW_AT_LOOP_NESTED_MATCH(([&]() -> JaktInternal::ExplicitValueOrControlFlow<JaktInternal::Optional<ide::Usage>,ErrorOr<JaktInternal::Optional<ide::Usage>>>{
...
__jakt_var_853 = static_cast<JaktInternal::Optional<ide::Usage>>( ide::Usage { typename ide::Usage::NameSet(cases_array) } ); goto __jakt_label_761;
...
__jakt_var_846 = TRY((ide::find_span_in_expression(program,expr,span))); goto __jakt_label_754;
...
__jakt_var_854 = none; goto __jakt_label_762;
...
__jakt_var_855 = TRY((ide::find_span_in_block(program,catch_block,span))); goto __jakt_label_763;
...
__jakt_var_856 = JAKT_RESOLVE_EXPLICIT_VALUE_OR_CONTROL_FLOW_RETURN_ONLY(([&]() -> JaktInternal::ExplicitValueOrControlFlow<JaktInternal::Optional<ide::Usage>,ErrorOr<JaktInternal::Optional<ide::Usage>>>{
...
return JaktInternal::ExplicitValue(({ Optional<JaktInternal::Optional<DeprecatedString>> __jakt_var_858; {
...
__jakt_var_858 = static_cast<JaktInternal::Optional<DeprecatedString>>(result); goto __jakt_label_766;
...
auto&& __jakt_match_value = __jakt_match_variant.template get<typename ide::Usage::Call>();
types::FunctionId const& function_id = __jakt_match_value.value;
return JaktInternal::ExplicitValue(({ Optional<JaktInternal::Optional<DeprecatedString>> __jakt_var_859; {
DeprecatedString const result = TRY((ide::get_function_signature(program,function_id)));
__jakt_var_859 = static_cast<JaktInternal::Optional<DeprecatedString>>(result); goto __jakt_label_767;
...
auto&& __jakt_match_value = __jakt_match_variant.template get<typename ide::Usage::Typename>();
types::TypeId const& type_id = __jakt_match_value.value;
return JaktInternal::ExplicitValue(({ Optional<JaktInternal::Optional<DeprecatedString>> __jakt_var_860; {
DeprecatedString const result = TRY((ide::get_type_signature(program,type_id)));
__jakt_var_860 = static_cast<JaktInternal::Optional<DeprecatedString>>(result); goto __jakt_label_768;
...
return JaktInternal::ExplicitValue(({ Optional<JaktInternal::Optional<DeprecatedString>> __jakt_var_861; {
DeprecatedString output = Jakt::DeprecatedString(""sv);
bool first = true;
{
...
__jakt_var_861 = static_cast<JaktInternal::Optional<DeprecatedString>>(output); goto __jakt_label_769;
...
return JaktInternal::ExplicitValue(({ Optional<JaktInternal::Optional<DeprecatedString>> __jakt_var_862; {
DeprecatedString const result = TRY((ide::get_enum_variant_signature(program,name,type_id,variants,number_constant)));
__jakt_var_862 = static_cast<JaktInternal::Optional<DeprecatedString>>(result); goto __jakt_label_770;
...
auto&& __jakt_match_value = __jakt_match_variant.template get<types::Type::GenericInstance>();types::StructId const& struct_id = __jakt_match_value.id;
JaktInternal::DynamicArray<types::TypeId> const& args = __jakt_match_value.args;
return JaktInternal::ExplicitValue(({ Optional<utility::Span> __jakt_var_863; {
...
__jakt_var_863 = output; goto __jakt_label_771;
...
__jakt_var_864 = none; goto __jakt_label_772;

}
__jakt_label_772:; __jakt_var_864.release_value(); }));
};/*case end*/
case 13: {
...
__jakt_var_865 = output; goto __jakt_label_773;

}
__jakt_label_773:; __jakt_var_865.release_value(); }));
};/*case end*/
case 6: {
...
__jakt_var_866 = none; goto __jakt_label_774;

}
__jakt_label_774:; __jakt_var_866.release_value(); }));
};/*case end*/
case 7: {
...
__jakt_var_867 = TRY((ide::find_span_in_block(program,block,span))); goto __jakt_label_775;

}
__jakt_label_775:; __jakt_var_867.release_value(); }));
};/*case end*/
case 2: {
...
__jakt_var_868 = TRY((ide::find_span_in_statement(program,var_decl,span))); goto __jakt_label_776;

}
__jakt_label_776:; __jakt_var_868.release_value(); }));
};/*case end*/
case 12: {
