...
return JaktInternal::ExplicitValue(({ Optional<ByteString> __jakt_var_854; {
{
...
__jakt_var_854 = (ByteString::from_utf8_without_validation("struct"sv)); goto __jakt_label_747;

}
__jakt_label_747:; __jakt_var_854.release_value(); }));
};/*case end*/
case 1 /* Class */: {
...
__jakt_var_855 = (ByteString::from_utf8_without_validation("class"sv)); goto __jakt_label_748;
...
__jakt_var_856 = (ByteString::from_utf8_without_validation("enum"sv)); goto __jakt_label_749;
...
__jakt_var_858 = output; goto __jakt_label_751;
...
__jakt_var_859 = TRY((ide::find_type_definition_for_type_id(program,type_id,span))); goto __jakt_label_752;
...
__jakt_var_860 = ((((program)->get_function(function_id)))->name_span); goto __jakt_label_753;
...
__jakt_var_861 = TRY((ide::find_type_definition_for_type_id(program,type_id,span))); goto __jakt_label_754;
...
return JaktInternal::ExplicitValue(({ Optional<JaktInternal::Optional<ByteString>> __jakt_var_862; {
ByteString const result = TRY((ide::get_var_signature(program,name,type_id,mutability,var_type,visibility,struct_type_id)));
__jakt_var_862 = static_cast<JaktInternal::Optional<ByteString>>(result); goto __jakt_label_755;
...
__jakt_var_865 = static_cast<JaktInternal::Optional<ByteString>>(output); goto __jakt_label_758;
...
__jakt_var_866 = static_cast<JaktInternal::Optional<ByteString>>(result); goto __jakt_label_759;
...
return JaktInternal::ExplicitValue(({ Optional<JaktInternal::DynamicArray<ByteString>> __jakt_var_867; {
__jakt_var_867 = TRY((ide::completions_for_type_id(program,type_id))); goto __jakt_label_760;
...
__jakt_var_868 = TRY((ide::completions_for_type_id(program,result_type_id))); goto __jakt_label_761;
...
__jakt_var_869 = none; goto __jakt_label_762;
...
__jakt_var_870 = output; goto __jakt_label_763;
...
__jakt_var_871 = none; goto __jakt_label_764;
...
__jakt_var_872 = TRY((ide::find_span_in_block(program,block,span))); goto __jakt_label_765;
...
__jakt_var_873 = TRY((ide::find_span_in_statement(program,var_decl,span))); goto __jakt_label_766;
...
__jakt_var_874 = TRY((ide::find_span_in_expression(program,rhs,span))); goto __jakt_label_767;
...
__jakt_var_875 = none; goto __jakt_label_768;
...
__jakt_var_880 = TRY((ide::find_span_in_expression(program,index,span))); goto __jakt_label_773;
...
case 25 /* Enum */: {
auto&& __jakt_match_value = __jakt_match_variant.as.Enum;ids::EnumId const& enum_id = __jakt_match_value.value;
return JaktInternal::ExplicitValue(({ Optional<JaktInternal::Set<ByteString>> __jakt_var_885; {
...
__jakt_var_885 = names; goto __jakt_label_778;
...
__jakt_var_887 = Set<ByteString>::create_with_values({__jakt_format((StringView::from_string_literal("else ({})"sv)),TRY((((program)->type_name(type_id,false)))))}); goto __jakt_label_780;
...
__jakt_var_888 = static_cast<JaktInternal::Optional<ide::Usage>>(ide::Usage::NameSet(cases_array)); goto __jakt_label_781;
...
__jakt_var_881 = TRY((ide::find_span_in_expression(program,expr,span))); goto __jakt_label_774;
...
__jakt_var_889 = none; goto __jakt_label_782;
...
__jakt_var_890 = TRY((ide::find_span_in_block(program,catch_block,span))); goto __jakt_label_783;
...
__jakt_var_892 = none; goto __jakt_label_785;
...
switch(__jakt_match_variant.__jakt_init_index()) {
case 0 /* Variable */: {
return JaktInternal::ExplicitValue(({ Optional<ByteString> __jakt_var_893; {
...
__jakt_var_893 = __jakt_format((StringView::from_string_literal("{} {}: {}"sv)),mut_string,name,type_name); goto __jakt_label_786;
...
__jakt_var_894 = __jakt_format((StringView::from_string_literal("fn({}) -> {}"sv)),utility::join(param_names,(ByteString::from_utf8_without_validation(", "sv))),return_type); goto __jakt_label_787;
...
__jakt_var_897 = ((output) + ((ByteString::from_utf8_without_validation(">"sv)))); goto __jakt_label_790;
...
return JaktInternal::ExplicitValue(({ Optional<JaktInternal::Optional<types::NumberConstant>> __jakt_var_901; {
__jakt_var_901 = ((expr)->to_number_constant(program)); goto __jakt_label_794;
...
JaktInternal::Optional<types::NumberConstant> const none = JaktInternal::OptionalNone();
__jakt_var_902 = none; goto __jakt_label_795;
...
return JaktInternal::ExplicitValue(({ Optional<JaktInternal::DynamicArray<JaktInternal::Tuple<JaktInternal::Optional<ByteString>,ids::TypeId>>> __jakt_var_903; {
...
__jakt_var_903 = output; goto __jakt_label_796;
...
__jakt_var_904 = DynamicArray<JaktInternal::Tuple<JaktInternal::Optional<ByteString>,ids::TypeId>>::create_with({(Tuple{string_none, type_id})}); goto __jakt_label_797;
