...
__jakt_var_880 = (ByteString::must_from_utf8("struct"sv)); goto __jakt_label_774;
...
__jakt_var_881 = (ByteString::must_from_utf8("class"sv)); goto __jakt_label_775;
...
__jakt_var_882 = (ByteString::must_from_utf8("enum"sv)); goto __jakt_label_776;
...
__jakt_var_883 = (ByteString::must_from_utf8("enum"sv)); goto __jakt_label_777;
...
__jakt_var_884 = output; goto __jakt_label_778;
...
__jakt_var_885 = TRY((ide::find_type_definition_for_type_id(program,type_id,span))); goto __jakt_label_779;
...
__jakt_var_886 = ((((program)->get_function(function_id)))->name_span); goto __jakt_label_780;
...
__jakt_var_887 = TRY((ide::find_type_definition_for_type_id(program,type_id,span))); goto __jakt_label_781;
...
__jakt_var_890 = static_cast<JaktInternal::Optional<ByteString>>(result); goto __jakt_label_784;
...
__jakt_var_891 = static_cast<JaktInternal::Optional<ByteString>>(output); goto __jakt_label_785;
...
__jakt_var_892 = static_cast<JaktInternal::Optional<ByteString>>(result); goto __jakt_label_786;
...
__jakt_var_893 = TRY((ide::completions_for_type_id(program,type_id))); goto __jakt_label_787;
...
__jakt_var_894 = TRY((ide::completions_for_type_id(program,result_type_id))); goto __jakt_label_788;
...
__jakt_var_895 = none; goto __jakt_label_789;
...
__jakt_var_896 = output; goto __jakt_label_790;
...
__jakt_var_898 = TRY((ide::find_span_in_block(program,block,span))); goto __jakt_label_792;
...
__jakt_var_899 = TRY((ide::find_span_in_statement(program,var_decl,span))); goto __jakt_label_793;
...
__jakt_var_900 = TRY((ide::find_span_in_expression(program,rhs,span))); goto __jakt_label_794;
...
__jakt_var_904 = none; goto __jakt_label_798;
...
__jakt_var_905 = none; goto __jakt_label_799;
...
__jakt_var_906 = TRY((ide::find_span_in_expression(program,index,span))); goto __jakt_label_800;
...
__jakt_var_911 = names; goto __jakt_label_805;
...
__jakt_var_912 = names; goto __jakt_label_806;
...
__jakt_var_913 = (TRY((Set<ByteString>::create_with_values({__jakt_format((StringView::from_string_literal("else ({})"sv)),TRY((((program)->type_name(type_id,false)))))})))); goto __jakt_label_807;
...
__jakt_var_914 = static_cast<JaktInternal::Optional<ide::Usage>>(ide::Usage::NameSet(cases_array)); goto __jakt_label_808;
...
__jakt_var_907 = TRY((ide::find_span_in_expression(program,expr,span))); goto __jakt_label_801;
...
__jakt_var_916 = TRY((ide::find_span_in_block(program,catch_block,span))); goto __jakt_label_810;
...
__jakt_var_918 = none; goto __jakt_label_812;
...
__jakt_var_919 = __jakt_format((StringView::from_string_literal("{} {}: {}"sv)),mut_string,name,type_name); goto __jakt_label_813;
...
__jakt_var_920 = __jakt_format((StringView::from_string_literal("fn({}) -> {}"sv)),utility::join(param_names,(ByteString::must_from_utf8(", "sv))),return_type); goto __jakt_label_814;
...
return JaktInternal::ExplicitValue((ByteString::must_from_utf8(""sv)));
    ...
    if (_jakt_value.is_return())
        return _jakt_value.release_return();
    _jakt_value.release_value();
})) + ((ByteString::must_from_utf8("enum "sv))))) + (((enum_).name))); goto __jakt_label_815;
...
__jakt_var_923 = ((output) + ((ByteString::must_from_utf8(">"sv)))); goto __jakt_label_817;
...
__jakt_var_924 = ((output) + ((ByteString::must_from_utf8(">"sv)))); goto __jakt_label_818;
...
__jakt_var_925 = ((output) + ((ByteString::must_from_utf8(">"sv)))); goto __jakt_label_819;
...
__jakt_var_926 = ((output) + ((ByteString::must_from_utf8(">"sv)))); goto __jakt_label_820;
...
return JaktInternal::ExplicitValue(({ Optional<JaktInternal::Optional<types::NumberConstant>> __jakt_var_927; {
__jakt_var_927 = ((expr)->to_number_constant(program)); goto __jakt_label_821;
...
JaktInternal::Optional<types::NumberConstant> const none = JaktInternal::OptionalNone();
__jakt_var_928 = none; goto __jakt_label_822;
...
return JaktInternal::ExplicitValue(({ Optional<JaktInternal::DynamicArray<JaktInternal::Tuple<JaktInternal::Optional<ByteString>,ids::TypeId>>> __jakt_var_929; {
...
__jakt_var_929 = output; goto __jakt_label_823;
...
__jakt_var_930 = (DynamicArray<JaktInternal::Tuple<JaktInternal::Optional<ByteString>,ids::TypeId>>::create_with({(Tuple{string_none, type_id})})); goto __jakt_label_824;
...
ErrorOr<ByteString> ide::JaktSymbol::debug_description() const { auto builder = ByteStringBuilder::create();builder.append("JaktSymbol("sv);{
