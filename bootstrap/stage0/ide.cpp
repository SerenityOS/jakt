...
return JaktInternal::ExplicitValue(({ Optional<ByteString> __jakt_var_852; {
{
...
__jakt_var_852 = (ByteString::from_utf8_without_validation("struct"sv)); goto __jakt_label_745;
...
__jakt_var_853 = (ByteString::from_utf8_without_validation("class"sv)); goto __jakt_label_746;
...
__jakt_var_854 = (ByteString::from_utf8_without_validation("enum"sv)); goto __jakt_label_747;
...
__jakt_var_856 = output; goto __jakt_label_749;
...
__jakt_var_857 = TRY((ide::find_type_definition_for_type_id(program,type_id,span))); goto __jakt_label_750;
...
__jakt_var_858 = ((((program)->get_function(function_id)))->name_span); goto __jakt_label_751;
...
return JaktInternal::ExplicitValue(({ Optional<JaktInternal::Optional<ByteString>> __jakt_var_860; {
ByteString const result = TRY((ide::get_var_signature(program,name,type_id,mutability,var_type,visibility,struct_type_id)));
__jakt_var_860 = static_cast<JaktInternal::Optional<ByteString>>(result); goto __jakt_label_753;
...
__jakt_var_863 = static_cast<JaktInternal::Optional<ByteString>>(output); goto __jakt_label_756;
...
return JaktInternal::ExplicitValue(({ Optional<JaktInternal::DynamicArray<ByteString>> __jakt_var_865; {
__jakt_var_865 = TRY((ide::completions_for_type_id(program,type_id))); goto __jakt_label_758;
...
__jakt_var_866 = TRY((ide::completions_for_type_id(program,result_type_id))); goto __jakt_label_759;
...
__jakt_var_867 = none; goto __jakt_label_760;
...
__jakt_var_868 = output; goto __jakt_label_761;
...
__jakt_var_870 = TRY((ide::find_span_in_block(program,block,span))); goto __jakt_label_763;
...
__jakt_var_871 = TRY((ide::find_span_in_statement(program,var_decl,span))); goto __jakt_label_764;
...
__jakt_var_872 = TRY((ide::find_span_in_expression(program,rhs,span))); goto __jakt_label_765;
...
__jakt_var_873 = none; goto __jakt_label_766;
...
__jakt_var_878 = TRY((ide::find_span_in_expression(program,index,span))); goto __jakt_label_771;
...
case 25 /* Enum */: {
auto&& __jakt_match_value = __jakt_match_variant.as.Enum;ids::EnumId const& enum_id = __jakt_match_value.value;
return JaktInternal::ExplicitValue(({ Optional<JaktInternal::Set<ByteString>> __jakt_var_883; {
...
__jakt_var_883 = names; goto __jakt_label_776;
...
__jakt_var_885 = Set<ByteString>::create_with_values({__jakt_format((StringView::from_string_literal("else ({})"sv)),TRY((((program)->type_name(type_id,false)))))}); goto __jakt_label_778;
...
__jakt_var_886 = static_cast<JaktInternal::Optional<ide::Usage>>(ide::Usage::NameSet(cases_array)); goto __jakt_label_779;
...
__jakt_var_879 = TRY((ide::find_span_in_expression(program,expr,span))); goto __jakt_label_772;
...
__jakt_var_887 = none; goto __jakt_label_780;
...
__jakt_var_888 = TRY((ide::find_span_in_block(program,catch_block,span))); goto __jakt_label_781;
...
__jakt_var_891 = __jakt_format((StringView::from_string_literal("{} {}: {}"sv)),mut_string,name,type_name); goto __jakt_label_784;
...
__jakt_var_892 = __jakt_format((StringView::from_string_literal("fn({}) -> {}"sv)),utility::join(param_names,(ByteString::from_utf8_without_validation(", "sv))),return_type); goto __jakt_label_785;
...
return JaktInternal::ExplicitValue((ByteString::from_utf8_without_validation(""sv)));
    ...
    if (_jakt_value.is_return())
        return _jakt_value.release_return();
    _jakt_value.release_value();
})) + ((ByteString::from_utf8_without_validation("enum "sv))))) + (((enum_).name))); goto __jakt_label_786;
...
utility::panic((ByteString::from_utf8_without_validation("unreachable: should've been struct"sv)));
    ...
    if (_jakt_value.is_return())
        return _jakt_value.release_return();
    _jakt_value.release_value();
})) + (((struct_).name))); goto __jakt_label_787;
...
__jakt_var_895 = ((output) + ((ByteString::from_utf8_without_validation(">"sv)))); goto __jakt_label_788;
...
return JaktInternal::ExplicitValue(({ Optional<JaktInternal::Optional<types::NumberConstant>> __jakt_var_899; {
__jakt_var_899 = ((expr)->to_number_constant(program)); goto __jakt_label_792;
...
JaktInternal::Optional<types::NumberConstant> const none = JaktInternal::OptionalNone();
__jakt_var_900 = none; goto __jakt_label_793;
...
return JaktInternal::ExplicitValue(({ Optional<JaktInternal::DynamicArray<JaktInternal::Tuple<JaktInternal::Optional<ByteString>,ids::TypeId>>> __jakt_var_901; {
...
__jakt_var_901 = output; goto __jakt_label_794;
...
__jakt_var_902 = DynamicArray<JaktInternal::Tuple<JaktInternal::Optional<ByteString>,ids::TypeId>>::create_with({(Tuple{string_none, type_id})}); goto __jakt_label_795;
