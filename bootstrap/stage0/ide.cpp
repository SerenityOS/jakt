...
return JaktInternal::ExplicitValue(({ Optional<JaktInternal::DynamicArray<JaktInternal::Tuple<JaktInternal::Optional<ByteString>,ids::TypeId>>> __jakt_var_880; {
...
__jakt_var_881 = ((DynamicArray<JaktInternal::Tuple<JaktInternal::Optional<ByteString>,ids::TypeId>>::must_create_with({(Tuple{string_none, type_id})}))); goto __jakt_label_775;
...
return JaktInternal::ExplicitValue(({ Optional<JaktInternal::Optional<types::NumberConstant>> __jakt_var_882; {
__jakt_var_882 = ((expr)->to_number_constant(program)); goto __jakt_label_776;
...
JaktInternal::Optional<types::NumberConstant> const none = JaktInternal::OptionalNone();
__jakt_var_883 = none; goto __jakt_label_777;
...
__jakt_var_884 = __jakt_format((StringView::from_string_literal("fn({}) -> {}"sv)),TRY((utility::join(param_names,(ByteString::must_from_utf8(", "sv))))),return_type); goto __jakt_label_778;
...
return JaktInternal::ExplicitValue((ByteString::must_from_utf8(""sv)));
    ...
    if (_jakt_value.is_return())
        return _jakt_value.release_return();
    _jakt_value.release_value();
})) + ((ByteString::must_from_utf8("enum "sv))))))) + (((enum_).name))))); goto __jakt_label_779;
...
utility::panic((ByteString::must_from_utf8("unreachable: should've been struct"sv)));
    ...
    if (_jakt_value.is_return())
        return _jakt_value.release_return();
    _jakt_value.release_value();
})) + (((struct_).name))))); goto __jakt_label_780;
...
__jakt_var_887 = TRY((((output) + ((ByteString::must_from_utf8(">"sv)))))); goto __jakt_label_781;
...
__jakt_var_891 = TRY((ide::completions_for_type_id(program,type_id))); goto __jakt_label_785;
...
__jakt_var_892 = TRY((ide::completions_for_type_id(program,result_type_id))); goto __jakt_label_786;
...
__jakt_var_893 = __jakt_format((StringView::from_string_literal("{} {}: {}"sv)),mut_string,name,type_name); goto __jakt_label_787;
...
return JaktInternal::ExplicitValue(({ Optional<utility::Span> __jakt_var_894; {
__jakt_var_894 = TRY((ide::find_type_definition_for_type_id(program,type_id,span))); goto __jakt_label_788;
...
__jakt_var_895 = ((((program)->get_function(function_id)))->name_span); goto __jakt_label_789;
...
__jakt_var_896 = TRY((ide::find_type_definition_for_type_id(program,type_id,span))); goto __jakt_label_790;
...
__jakt_var_910 = (TRY((Set<ByteString>::create_with_values({__jakt_format((StringView::from_string_literal("else ({})"sv)),TRY((((program)->type_name(type_id,false)))))})))); goto __jakt_label_804;
...
return JaktInternal::ExplicitValue(({ Optional<JaktInternal::Optional<ByteString>> __jakt_var_916; {
ByteString const result = TRY((ide::get_var_signature(program,name,type_id,mutability,var_type,visibility,struct_type_id)));
__jakt_var_916 = static_cast<JaktInternal::Optional<ByteString>>(result); goto __jakt_label_810;
...
__jakt_var_919 = static_cast<JaktInternal::Optional<ByteString>>(output); goto __jakt_label_813;
...
__jakt_var_920 = static_cast<JaktInternal::Optional<ByteString>>(result); goto __jakt_label_814;
...
auto&& __jakt_match_value = __jakt_match_variant.as.GenericInstance;ids::StructId const& struct_id = __jakt_match_value.id;
JaktInternal::DynamicArray<ids::TypeId> const& args = __jakt_match_value.args;
return JaktInternal::ExplicitValue(({ Optional<utility::Span> __jakt_var_921; {
...
__jakt_var_921 = output; goto __jakt_label_815;
...
return JaktInternal::ExplicitValue(({ Optional<JaktInternal::Optional<ide::Usage>> __jakt_var_922; {
...
__jakt_var_922 = none; goto __jakt_label_816;
...
__jakt_var_923 = output; goto __jakt_label_817;
...
__jakt_var_925 = TRY((ide::find_span_in_block(program,block,span))); goto __jakt_label_819;
...
__jakt_var_926 = TRY((ide::find_span_in_statement(program,var_decl,span))); goto __jakt_label_820;
...
((json_builder).append(__jakt_format((StringView::from_string_literal("\"children\": [{}]"sv)),TRY((utility::join(child_symbols,(ByteString::must_from_utf8(","sv))))))));
((json_builder).append((StringView::from_string_literal("}"sv))));
