...
return JaktInternal::ExplicitValue(({ Optional<ByteString> __jakt_var_853; {
{
...
__jakt_var_853 = (ByteString::from_utf8_without_validation("struct"sv)); goto __jakt_label_746;
...
__jakt_var_854 = (ByteString::from_utf8_without_validation("class"sv)); goto __jakt_label_747;
...
__jakt_var_855 = (ByteString::from_utf8_without_validation("enum"sv)); goto __jakt_label_748;
...
return JaktInternal::ExplicitValue(({ Optional<utility::Span> __jakt_var_857; {
...
__jakt_var_857 = output; goto __jakt_label_750;
...
__jakt_var_858 = TRY((ide::find_type_definition_for_type_id(program,type_id,span))); goto __jakt_label_751;
...
__jakt_var_859 = ((((program)->get_function(function_id)))->name_span); goto __jakt_label_752;
...
return JaktInternal::ExplicitValue(({ Optional<JaktInternal::Optional<ByteString>> __jakt_var_861; {
ByteString const result = TRY((ide::get_var_signature(program,name,type_id,mutability,var_type,visibility,struct_type_id)));
__jakt_var_861 = static_cast<JaktInternal::Optional<ByteString>>(result); goto __jakt_label_754;
...
__jakt_var_864 = static_cast<JaktInternal::Optional<ByteString>>(output); goto __jakt_label_757;
...
return JaktInternal::ExplicitValue(({ Optional<JaktInternal::DynamicArray<ByteString>> __jakt_var_866; {
__jakt_var_866 = TRY((ide::completions_for_type_id(program,type_id))); goto __jakt_label_759;
...
__jakt_var_867 = TRY((ide::completions_for_type_id(program,result_type_id))); goto __jakt_label_760;
...
__jakt_var_868 = none; goto __jakt_label_761;
...
__jakt_var_869 = output; goto __jakt_label_762;
...
__jakt_var_871 = TRY((ide::find_span_in_block(program,block,span))); goto __jakt_label_764;
...
__jakt_var_872 = TRY((ide::find_span_in_statement(program,var_decl,span))); goto __jakt_label_765;
...
__jakt_var_873 = TRY((ide::find_span_in_expression(program,rhs,span))); goto __jakt_label_766;
...
__jakt_var_874 = none; goto __jakt_label_767;
...
__jakt_var_879 = TRY((ide::find_span_in_expression(program,index,span))); goto __jakt_label_772;
...
case 25 /* Enum */: {
auto&& __jakt_match_value = __jakt_match_variant.as.Enum;ids::EnumId const& enum_id = __jakt_match_value.value;
return JaktInternal::ExplicitValue(({ Optional<JaktInternal::Set<ByteString>> __jakt_var_884; {
...
__jakt_var_884 = names; goto __jakt_label_777;
...
__jakt_var_886 = Set<ByteString>::create_with_values({__jakt_format((StringView::from_string_literal("else ({})"sv)),TRY((((program)->type_name(type_id,false)))))}); goto __jakt_label_779;
...
__jakt_var_887 = static_cast<JaktInternal::Optional<ide::Usage>>(ide::Usage::NameSet(cases_array)); goto __jakt_label_780;
...
__jakt_var_880 = TRY((ide::find_span_in_expression(program,expr,span))); goto __jakt_label_773;
...
__jakt_var_888 = none; goto __jakt_label_781;
...
__jakt_var_889 = TRY((ide::find_span_in_block(program,catch_block,span))); goto __jakt_label_782;
...
__jakt_var_891 = none; goto __jakt_label_784;
...
switch(__jakt_match_variant.__jakt_init_index()) {
case 0 /* Variable */: {
return JaktInternal::ExplicitValue(({ Optional<ByteString> __jakt_var_892; {
...
__jakt_var_892 = __jakt_format((StringView::from_string_literal("{} {}: {}"sv)),mut_string,name,type_name); goto __jakt_label_785;
...
__jakt_var_893 = __jakt_format((StringView::from_string_literal("fn({}) -> {}"sv)),utility::join(param_names,(ByteString::from_utf8_without_validation(", "sv))),return_type); goto __jakt_label_786;
...
return JaktInternal::ExplicitValue((ByteString::from_utf8_without_validation(""sv)));
    ...
    if (_jakt_value.is_return())
        return _jakt_value.release_return();
    _jakt_value.release_value();
})) + ((ByteString::from_utf8_without_validation("enum "sv))))) + (((enum_).name))); goto __jakt_label_787;
...
utility::panic((ByteString::from_utf8_without_validation("unreachable: should've been struct"sv)));
    ...
    if (_jakt_value.is_return())
        return _jakt_value.release_return();
    _jakt_value.release_value();
})) + (((struct_).name))); goto __jakt_label_788;
...
__jakt_var_896 = ((output) + ((ByteString::from_utf8_without_validation(">"sv)))); goto __jakt_label_789;
...
return JaktInternal::ExplicitValue(({ Optional<JaktInternal::Optional<types::NumberConstant>> __jakt_var_900; {
__jakt_var_900 = ((expr)->to_number_constant(program)); goto __jakt_label_793;
...
JaktInternal::Optional<types::NumberConstant> const none = JaktInternal::OptionalNone();
__jakt_var_901 = none; goto __jakt_label_794;
...
return JaktInternal::ExplicitValue(({ Optional<JaktInternal::DynamicArray<JaktInternal::Tuple<JaktInternal::Optional<ByteString>,ids::TypeId>>> __jakt_var_902; {
...
__jakt_var_902 = output; goto __jakt_label_795;
...
__jakt_var_903 = DynamicArray<JaktInternal::Tuple<JaktInternal::Optional<ByteString>,ids::TypeId>>::create_with({(Tuple{string_none, type_id})}); goto __jakt_label_796;
