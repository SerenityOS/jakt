...
return JaktInternal::ExplicitValue(({ Optional<types::CheckedMatchBody> __jakt_var_231; {
...
__jakt_var_231 = (final_body.value()); goto __jakt_label_222;

}
__jakt_label_222:; __jakt_var_231.release_value(); }));
};/*case end*/
case 0: {
...
return JaktInternal::ExplicitValue(({ Optional<types::CheckedMatchBody> __jakt_var_232; {
...
__jakt_var_232 =  types::CheckedMatchBody { typename types::CheckedMatchBody::Expression(checked_expression) } ; goto __jakt_label_223;

}
__jakt_label_223:; __jakt_var_232.release_value(); }));
};/*case end*/
...
return JaktInternal::ExplicitValue(({ Optional<types::ScopeId> __jakt_var_234; {
...
__jakt_var_234 = scope_id; goto __jakt_label_224;

}
__jakt_label_224:; __jakt_var_234.release_value(); }));
};/*case end*/
case 1: {
...
return JaktInternal::ExplicitValue(({ Optional<types::ScopeId> __jakt_var_235; {
...
__jakt_var_235 = scope_id; goto __jakt_label_225;

}
__jakt_label_225:; __jakt_var_235.release_value(); }));
};/*case end*/
default: VERIFY_NOT_REACHED();}/*switch end*/
}()
)));
...
;
__jakt_var_236 = caller_scope_id; goto __jakt_label_226;
...
const types::CheckedStruct struct_ = ((*this).get_struct((((callee)->struct_id).value())));
...
if (((this_expr).has_value())){
auto __jakt_var_237 = [&]() -> ErrorOr<void> {{
...
{
const interpreter::StatementResult value = ({ Optional<interpreter::StatementResult> __jakt_var_238;
auto __jakt_var_239 = [&]() -> ErrorOr<interpreter::StatementResult> { return TRY((((interpreter)->execute_expression(((argument).get<1>()),eval_scope)))); }();
if (__jakt_var_239.is_error()) {{
TRY((((*this).error(String("Error in argument"),span))));
continue;
}
} else {__jakt_var_238 = __jakt_var_239.release_value();
}
__jakt_var_238.release_value(); });
...
auto __jakt_var_240 = [&]() -> ErrorOr<void> {{
...
;return {};}();
if (__jakt_var_240.is_error()) {auto error = __jakt_var_240.release_error();{
...
types::Value const& x = __jakt_match_value.value;
return JaktInternal::ExplicitValue(({ Optional<NonnullRefPtr<types::CheckedExpression>> __jakt_var_241; {
TRY((((*this).error(TRY((String::formatted(String("Compiletime call failed: {}"),x))),span))));
__jakt_var_241 = checked_call; goto __jakt_label_227;
...
const JaktInternal::Tuple<NonnullRefPtr<parser::ParsedExpression>,JaktInternal::Optional<parser::ParsedBlock>,JaktInternal::Optional<NonnullRefPtr<parser::ParsedStatement>>> new_condition_new_then_block_new_else_statement_ = TRY((((*this).expand_context_for_bindings(expr,JaktInternal::OptionalNone(),remaining_code,TRY((parser::ParsedStatement::template create<typename parser::ParsedStatement::Block>(else_block,span))),span))));
const NonnullRefPtr<parser::ParsedExpression> new_condition = ((new_condition_new_then_block_new_else_statement_).get<0>());
const JaktInternal::Optional<parser::ParsedBlock> new_then_block = ((new_condition_new_then_block_new_else_statement_).get<1>());
...
const types::CheckedBlock checked_block = TRY((((*this).typecheck_block((new_then_block.value()),scope_id,safety_mode,JaktInternal::OptionalNone()))));
...
return JaktInternal::ExplicitValue(({ Optional<types::CheckedVisibility> __jakt_var_242; {
...
__jakt_var_242 =  types::CheckedVisibility { typename types::CheckedVisibility::Restricted(restricted_scopes,span) } ; goto __jakt_label_228;
...
return JaktInternal::ExplicitValue(({ Optional<types::TypeId> __jakt_var_243; {
const types::TypeId inner_type_id = TRY((((*this).typecheck_typename(inner,scope_id,name))));
__jakt_var_243 = TRY((((*this).find_or_add_type_id(TRY((types::Type::template create<typename types::Type::Reference>(inner_type_id))))))); goto __jakt_label_229;
...
return JaktInternal::ExplicitValue(({ Optional<types::TypeId> __jakt_var_244; {
const types::TypeId inner_type_id = TRY((((*this).typecheck_typename(inner,scope_id,name))));
__jakt_var_244 = TRY((((*this).find_or_add_type_id(TRY((types::Type::template create<typename types::Type::MutableReference>(inner_type_id))))))); goto __jakt_label_230;
...
utility::Span const& span = __jakt_match_value.span;
return JaktInternal::ExplicitValue(({ Optional<types::TypeId> __jakt_var_245; {
...
__jakt_var_245 = (type_id.value()); goto __jakt_label_231;
...
utility::Span const& span = __jakt_match_value.span;
return JaktInternal::ExplicitValue(({ Optional<types::TypeId> __jakt_var_246; {
...
__jakt_var_246 = JAKT_RESOLVE_EXPLICIT_VALUE_OR_CONTROL_FLOW_RETURN_ONLY(([&]() -> JaktInternal::ExplicitValueOrControlFlow<types::TypeId,ErrorOr<types::TypeId>>{
...
return JaktInternal::ExplicitValue(({ Optional<types::TypeId> __jakt_var_247; {
if (((maybe_type_and_scope).has_value())){
return ((((maybe_type_and_scope.value())).get<0>()));
}
TRY((((*this).error(TRY((String::formatted(String("Unknown type ‘{}’"),name))),span))));
__jakt_var_247 = types::unknown_type_id(); goto __jakt_label_233;
...
return JaktInternal::ExplicitValue(({ Optional<types::TypeId> __jakt_var_248; {
__jakt_var_248 = types::unknown_type_id(); goto __jakt_label_234;
...
utility::Span const& span = __jakt_match_value.span;
return JaktInternal::ExplicitValue(({ Optional<types::TypeId> __jakt_var_249; {
...
const types::StructId tuple_struct_id = TRY((((*this).find_struct_in_prelude(String("Tuple")))));
__jakt_var_249 = TRY((((*this).find_or_add_type_id(TRY((types::Type::template create<typename types::Type::GenericInstance>(tuple_struct_id,checked_types))))))); goto __jakt_label_235;
...
utility::Span const& span = __jakt_match_value.span;
return JaktInternal::ExplicitValue(({ Optional<types::TypeId> __jakt_var_250; {
const types::TypeId inner_type_id = TRY((((*this).typecheck_typename(inner,scope_id,name))));
const types::StructId array_struct_id = TRY((((*this).find_struct_in_prelude(String("Array")))));
__jakt_var_250 = TRY((((*this).find_or_add_type_id(TRY((types::Type::template create<typename types::Type::GenericInstance>(array_struct_id,(TRY((Array<types::TypeId>::create_with({inner_type_id}))))))))))); goto __jakt_label_236;
...
utility::Span const& span = __jakt_match_value.span;
return JaktInternal::ExplicitValue(({ Optional<types::TypeId> __jakt_var_251; {
...
__jakt_var_251 = TRY((((*this).find_or_add_type_id(TRY((types::Type::template create<typename types::Type::GenericInstance>(dict_struct_id,(TRY((Array<types::TypeId>::create_with({key_type_id, value_type_id}))))))))))); goto __jakt_label_237;
...
utility::Span const& span = __jakt_match_value.span;
return JaktInternal::ExplicitValue(({ Optional<types::TypeId> __jakt_var_252; {
const types::TypeId inner_type_id = TRY((((*this).typecheck_typename(inner,scope_id,name))));
const types::StructId set_struct_id = TRY((((*this).find_struct_in_prelude(String("Set")))));
__jakt_var_252 = TRY((((*this).find_or_add_type_id(TRY((types::Type::template create<typename types::Type::GenericInstance>(set_struct_id,(TRY((Array<types::TypeId>::create_with({inner_type_id}))))))))))); goto __jakt_label_238;
...
utility::Span const& span = __jakt_match_value.span;
return JaktInternal::ExplicitValue(({ Optional<types::TypeId> __jakt_var_253; {
const types::TypeId inner_type_id = TRY((((*this).typecheck_typename(inner,scope_id,name))));
const types::StructId optional_struct_id = TRY((((*this).find_struct_in_prelude(String("Optional")))));
__jakt_var_253 = TRY((((*this).find_or_add_type_id(TRY((types::Type::template create<typename types::Type::GenericInstance>(optional_struct_id,(TRY((Array<types::TypeId>::create_with({inner_type_id}))))))))))); goto __jakt_label_239;
...
utility::Span const& span = __jakt_match_value.span;
return JaktInternal::ExplicitValue(({ Optional<types::TypeId> __jakt_var_254; {
const types::TypeId inner_type_id = TRY((((*this).typecheck_typename(inner,scope_id,name))));
const types::StructId weakptr_struct_id = TRY((((*this).find_struct_in_prelude(String("WeakPtr")))));
__jakt_var_254 = TRY((((*this).find_or_add_type_id(TRY((types::Type::template create<typename types::Type::GenericInstance>(weakptr_struct_id,(TRY((Array<types::TypeId>::create_with({inner_type_id}))))))))))); goto __jakt_label_240;
...
const types::TypeId inner_type_id = TRY((((*this).typecheck_typename(inner,scope_id,name))));
__jakt_var_255 = TRY((((*this).find_or_add_type_id(TRY((types::Type::template create<typename types::Type::RawPtr>(inner_type_id))))))); goto __jakt_label_241;
...
__jakt_var_256 = TRY((((*this).typecheck_generic_resolved_type(name,checked_inner_types,scope_id,span)))); goto __jakt_label_242;
...
utility::Span const& span = __jakt_match_value.span;
return JaktInternal::ExplicitValue(({ Optional<types::TypeId> __jakt_var_257; {
...
return JaktInternal::ExplicitValue(({ Optional<String> __jakt_var_258;
auto __jakt_var_259 = [&]() -> ErrorOr<String> { return TRY((String::formatted(String("lambda{}"),((((*this).lambda_count)++))))); }();
if (!__jakt_var_259.is_error()) __jakt_var_258 = __jakt_var_259.release_value();
__jakt_var_258; }).value_or_lazy_evaluated([&] { return String(""); }));
}
}()))
;
...
__jakt_var_257 = TRY((((*this).find_or_add_type_id(TRY((types::Type::template create<typename types::Type::Function>(param_type_ids,can_throw,((checked_function)->return_type_id),function_id))))))); goto __jakt_label_243;
...
NonnullRefPtr<types::CheckedFunction> checked_function = TRY((types::CheckedFunction::create(((func).name),((func).name_span),TRY((((*this).typecheck_visibility(((method).visibility),enum_scope_id)))),types::unknown_type_id(),JaktInternal::OptionalNone(),(TRY((Array<types::CheckedParameter>::create_with({})))),TRY((types::FunctionGenerics::create((TRY((Array<types::CheckedParameter>::create_with({})))),(TRY((Array<types::FunctionGenericParameter>::create_with({})))),(TRY((Array<JaktInternal::Array<types::TypeId>>::create_with({}))))))),types::CheckedBlock((TRY((Array<NonnullRefPtr<types::CheckedStatement>>::create_with({})))),block_scope_id, types::BlockControlFlow { typename types::BlockControlFlow::MayReturn() } ,types::TypeId::none(),false),((func).can_throw),((func).type),((func).linkage),method_scope_id,JaktInternal::OptionalNone(),((!(is_generic)) || is_extern),func,((func).is_comptime),false,false)));
const types::FunctionId function_id = TRY((((module)->add_function(checked_function))));
...
return JaktInternal::ExplicitValue(({ Optional<JaktInternal::Optional<JaktInternal::Array<JaktInternal::Tuple<String,utility::Span>>>> __jakt_var_262; {
NonnullRefPtr<interpreter::Interpreter> interpreter = TRY((interpreter::Interpreter::create(((*this).compiler),((*this).program),(TRY((Array<utility::Span>::create_with({})))))));
...
__jakt_var_262 = JAKT_RESOLVE_EXPLICIT_VALUE_OR_CONTROL_FLOW_RETURN_ONLY(([&]() -> JaktInternal::ExplicitValueOrControlFlow<JaktInternal::Optional<JaktInternal::Array<JaktInternal::Tuple<String,utility::Span>>>, ErrorOr<void>>{
auto&& __jakt_match_variant = result;
switch(__jakt_match_variant.index()) {
case 0: {
auto&& __jakt_match_value = __jakt_match_variant.template get<typename interpreter::StatementResult::Return>();
return JaktInternal::ExplicitValue(({ Optional<JaktInternal::Array<JaktInternal::Tuple<String,utility::Span>>> __jakt_var_263; {
...
__jakt_var_263 = JaktInternal::OptionalNone(); goto __jakt_label_245;

}
__jakt_label_245:; __jakt_var_263; }));
};/*case end*/
case 2: {
auto&& __jakt_match_value = __jakt_match_variant.template get<typename interpreter::StatementResult::Yield>();
return JaktInternal::ExplicitValue(({ Optional<JaktInternal::Array<JaktInternal::Tuple<String,utility::Span>>> __jakt_var_264; {
TRY((((*this).error_with_hint(String("module name must evalute to a string literal or an array of strings"),((expression)->span()),String("this expression evaluates to an invalid value"),((expression)->span())))));
__jakt_var_264 = JaktInternal::OptionalNone(); goto __jakt_label_246;

}
__jakt_label_246:; __jakt_var_264; }));
};/*case end*/
case 3: {
auto&& __jakt_match_value = __jakt_match_variant.template get<typename interpreter::StatementResult::Continue>();
return JaktInternal::ExplicitValue(({ Optional<JaktInternal::Array<JaktInternal::Tuple<String,utility::Span>>> __jakt_var_265; {
TRY((((*this).error_with_hint(String("module name must evalute to a string literal or an array of strings"),((expression)->span()),String("this expression evaluates to an invalid value"),((expression)->span())))));
__jakt_var_265 = JaktInternal::OptionalNone(); goto __jakt_label_247;

}
__jakt_label_247:; __jakt_var_265; }));
};/*case end*/
case 4: {
auto&& __jakt_match_value = __jakt_match_variant.template get<typename interpreter::StatementResult::Break>();
return JaktInternal::ExplicitValue(({ Optional<JaktInternal::Array<JaktInternal::Tuple<String,utility::Span>>> __jakt_var_266; {
TRY((((*this).error_with_hint(String("module name must evalute to a string literal or an array of strings"),((expression)->span()),String("this expression evaluates to an invalid value"),((expression)->span())))));
__jakt_var_266 = JaktInternal::OptionalNone(); goto __jakt_label_248;

}
__jakt_label_248:; __jakt_var_266; }));
};/*case end*/
case 1: {
...
return JaktInternal::ExplicitValue(({ Optional<JaktInternal::Array<JaktInternal::Tuple<String,utility::Span>>> __jakt_var_267; {
...
__jakt_var_267 = JaktInternal::OptionalNone(); goto __jakt_label_249;

}
__jakt_label_249:; __jakt_var_267; }));
};/*case end*/
case 5: {
auto&& __jakt_match_value = __jakt_match_variant.template get<typename interpreter::StatementResult::JustValue>();
...
return JaktInternal::ExplicitValue(({ Optional<JaktInternal::Optional<JaktInternal::Array<JaktInternal::Tuple<String,utility::Span>>>> __jakt_var_268; {
if (((values).is_empty())){
...
__jakt_var_268 = static_cast<JaktInternal::Optional<JaktInternal::Array<JaktInternal::Tuple<String,utility::Span>>>>(result); goto __jakt_label_250;

}
__jakt_label_250:; __jakt_var_268.release_value(); }));
};/*case end*/
default: {
return JaktInternal::ExplicitValue(({ Optional<JaktInternal::Array<JaktInternal::Tuple<String,utility::Span>>> __jakt_var_269; {
...
__jakt_var_269 = JaktInternal::OptionalNone(); goto __jakt_label_251;

}
__jakt_label_251:; __jakt_var_269; }));
};/*case end*/
}/*switch end*/
}()
)));
...
__jakt_label_244:; __jakt_var_262.release_value(); }));
};/*case end*/
default: VERIFY_NOT_REACHED();}/*switch end*/
}()
));
...
return JaktInternal::ExplicitValue(({ Optional<types::ScopeId> __jakt_var_270; {
...
__jakt_var_270 = JAKT_RESOLVE_EXPLICIT_VALUE_OR_CONTROL_FLOW_RETURN_ONLY(([&]() -> JaktInternal::ExplicitValueOrControlFlow<types::ScopeId, ErrorOr<bool>>{
...
)); goto __jakt_label_252;

}
__jakt_label_252:; __jakt_var_270.release_value(); }));
}
}()))
;
{
...
NonnullRefPtr<types::Module> module = ((*this).current_module());
const types::VarId variable_id = TRY((((module)->add_variable(types::CheckedVariable(((parsed_var_decl).name),checked_member_type,((parsed_var_decl).is_mutable),((parsed_var_decl).span),JaktInternal::OptionalNone(),TRY((((*this).typecheck_visibility(((unchecked_member).visibility),checked_struct_scope_id)))))))));
...
utility::Span const& span = __jakt_match_value.span;
return JaktInternal::ExplicitValue(({ Optional<NonnullRefPtr<types::CheckedExpression>> __jakt_var_271; {
...
__jakt_var_271 = JAKT_RESOLVE_EXPLICIT_VALUE_OR_CONTROL_FLOW_RETURN_ONLY(([&]() -> JaktInternal::ExplicitValueOrControlFlow<NonnullRefPtr<types::CheckedExpression>, ErrorOr<NonnullRefPtr<types::CheckedExpression>>>{
...
)); goto __jakt_label_253;

}
__jakt_label_253:; __jakt_var_271.release_value(); }));
};/*case end*/
case 3: {
...
__jakt_var_272 = TRY((types::CheckedExpression::template create<typename types::CheckedExpression::QuotedString>(val,span))); goto __jakt_label_254;

}
__jakt_label_254:; __jakt_var_272.release_value(); }));
};/*case end*/
case 5: {
...
__jakt_var_273 = TRY((((*this).typecheck_call(call,scope_id,span,JaktInternal::OptionalNone(),JaktInternal::OptionalNone(),safety_mode,type_hint,false)))); goto __jakt_label_255;

}
__jakt_label_255:; __jakt_var_273.release_value(); }));
};/*case end*/
case 6: {
...
return JaktInternal::ExplicitValue(({ Optional<JaktInternal::Optional<types::StructOrEnumId>> __jakt_var_275; {
__jakt_var_275 = JAKT_RESOLVE_EXPLICIT_VALUE_OR_CONTROL_FLOW_RETURN_ONLY(([&]() -> JaktInternal::ExplicitValueOrControlFlow<JaktInternal::Optional<types::StructOrEnumId>,ErrorOr<NonnullRefPtr<types::CheckedExpression>>>{
auto __jakt_enum_value = (is_optional);
if (__jakt_enum_value == true) {
return JaktInternal::ExplicitValue(({ Optional<JaktInternal::Optional<types::StructOrEnumId>> __jakt_var_276; {
const types::StructId optional_struct_id = TRY((((*this).find_struct_in_prelude(String("Optional")))));
...
default: {
return JaktInternal::ExplicitValue(({ Optional<types::StructOrEnumId> __jakt_var_277; {
TRY((((*this).error(String("Can't use non-struct type as an optional type in optional chained call"),span))));
(found_optional = false);
__jakt_var_277 =  types::StructOrEnumId { typename types::StructOrEnumId::Struct(optional_struct_id) } ; goto __jakt_label_259;

}
__jakt_label_259:; __jakt_var_277.release_value(); }));
};/*case end*/
}/*switch end*/
}()
)));
...
__jakt_var_276 = static_cast<JaktInternal::Optional<types::StructOrEnumId>>(struct_id.value_or_lazy_evaluated([&] { return  types::StructOrEnumId { typename types::StructOrEnumId::Struct(optional_struct_id) } ; })); goto __jakt_label_258;

}
__jakt_label_258:; __jakt_var_276.release_value(); }));
}
else {
return JaktInternal::ExplicitValue(static_cast<JaktInternal::Optional<types::StructOrEnumId>>( types::StructOrEnumId { typename types::StructOrEnumId::Struct(id) } ));
}
...
__jakt_label_257:; __jakt_var_275.release_value(); }));
};/*case end*/
case 20: {
auto&& __jakt_match_value = __jakt_match_variant.template get<types::Type::GenericEnumInstance>();types::EnumId const& id = __jakt_match_value.id;
return JaktInternal::ExplicitValue(static_cast<JaktInternal::Optional<types::StructOrEnumId>>( types::StructOrEnumId { typename types::StructOrEnumId::Enum(id) } ));
...
default: {
return JaktInternal::ExplicitValue(({ Optional<JaktInternal::Optional<types::StructOrEnumId>> __jakt_var_278; {
...
__jakt_var_278 = none; goto __jakt_label_260;

}
__jakt_label_260:; __jakt_var_278.release_value(); }));
};/*case end*/
}/*switch end*/
}()
));
...
__jakt_var_279 = TRY((types::CheckedExpression::template create<typename types::CheckedExpression::MethodCall>(checked_expr,call,span,is_optional,result_type))); goto __jakt_label_261;

}
__jakt_label_261:; __jakt_var_279.release_value(); }));
};/*case end*/
default: {
{
...
__jakt_label_256:; __jakt_var_274.release_value(); }));
};/*case end*/
case 20: {
...
__jakt_var_280 = TRY((types::CheckedExpression::template create<typename types::CheckedExpression::Range>(checked_from,checked_to,span,type_id))); goto __jakt_label_262;

}
__jakt_label_262:; __jakt_var_280.release_value(); }));
};/*case end*/
case 11: {
...
return JaktInternal::ExplicitValue(({ Optional<types::CheckedUnaryOperator> __jakt_var_282; {
...
return JaktInternal::ExplicitValue(({ Optional<types::CheckedTypeCast> __jakt_var_283; {
const types::StructId optional_struct_id = TRY((((*this).find_struct_in_prelude(String("Optional")))));
...
__jakt_var_283 =  types::CheckedTypeCast { typename types::CheckedTypeCast::Fallible(optional_type_id) } ; goto __jakt_label_265;

}
__jakt_label_265:; __jakt_var_283.release_value(); }));
};/*case end*/
case 1: {
...
__jakt_var_282 =  types::CheckedUnaryOperator { typename types::CheckedUnaryOperator::TypeCast(checked_cast) } ; goto __jakt_label_264;

}
__jakt_label_264:; __jakt_var_282.release_value(); }));
};/*case end*/
case 12: {
...
return JaktInternal::ExplicitValue(({ Optional<types::CheckedUnaryOperator> __jakt_var_284; {
const bool old_ignore_errors = ((*this).ignore_errors);
(((*this).ignore_errors) = true);
...
__jakt_var_284 = operator_is; goto __jakt_label_266;

}
__jakt_label_266:; __jakt_var_284.release_value(); }));
};/*case end*/
case 13: {
...
__jakt_var_281 = TRY((((*this).typecheck_unary_operation(checked_expr,checked_op,span,scope_id,safety_mode)))); goto __jakt_label_263;

}
__jakt_label_263:; __jakt_var_281.release_value(); }));
};/*case end*/
case 12: {
...
__jakt_var_285 = TRY((types::CheckedExpression::template create<typename types::CheckedExpression::BinaryOp>((checked_lhs.value()),op,(checked_rhs.value()),span,output_type))); goto __jakt_label_267;

}
__jakt_label_267:; __jakt_var_285.release_value(); }));
};/*case end*/
case 15: {
...
return JaktInternal::ExplicitValue(({ Optional<NonnullRefPtr<types::CheckedExpression>> __jakt_var_286; {
JaktInternal::Optional<types::TypeId> type_hint_unwrapped = type_hint;
if ((((type_hint).has_value()) && ((((*this).get_type((type_hint.value()))))->index() == 19 /* GenericInstance */))){
const types::StructId id = (((*this).get_type((type_hint.value())))->get<types::Type::GenericInstance>()).id;
const JaktInternal::Array<types::TypeId> args = (((*this).get_type((type_hint.value())))->get<types::Type::GenericInstance>()).args;
...
__jakt_var_286 = TRY((types::CheckedExpression::template create<typename types::CheckedExpression::OptionalNone>(span,type_hint_unwrapped.value_or_lazy_evaluated([&] { return types::unknown_type_id(); })))); goto __jakt_label_268;

}
__jakt_label_268:; __jakt_var_286.release_value(); }));
};/*case end*/
case 14: {
...
utility::Span const& span = __jakt_match_value.span;
return JaktInternal::ExplicitValue(({ Optional<NonnullRefPtr<types::CheckedExpression>> __jakt_var_287; {
...
const NonnullRefPtr<types::Type> optional_type = TRY((types::Type::template create<typename types::Type::GenericInstance>(optional_struct_id,(TRY((Array<types::TypeId>::create_with({type_id})))))));
const types::TypeId optional_type_id = TRY((((*this).find_or_add_type_id(optional_type))));
__jakt_var_287 = TRY((types::CheckedExpression::template create<typename types::CheckedExpression::OptionalSome>(checked_expr,span,optional_type_id))); goto __jakt_label_269;

}
__jakt_label_269:; __jakt_var_287.release_value(); }));
};/*case end*/
case 9: {
...
return JaktInternal::ExplicitValue(({ Optional<NonnullRefPtr<types::CheckedExpression>> __jakt_var_288; {
TRY((((*this).error(TRY((String::formatted(String("Variable '{}' not found"),name))),span))));
__jakt_var_288 = TRY((types::CheckedExpression::template create<typename types::CheckedExpression::Var>(types::CheckedVariable(name,((type_hint).value_or(types::unknown_type_id())),false,span,JaktInternal::OptionalNone(), types::CheckedVisibility { typename types::CheckedVisibility::Public() } ),span))); goto __jakt_label_270;

}
__jakt_label_270:; __jakt_var_288.release_value(); }));
}
}()))
);
}
...
utility::Span const& span = __jakt_match_value.span;
return JaktInternal::ExplicitValue(({ Optional<NonnullRefPtr<types::CheckedExpression>> __jakt_var_289; {
const NonnullRefPtr<types::CheckedExpression> checked_expr = TRY((((*this).typecheck_expression_and_dereference_if_needed(expr,scope_id,safety_mode,JaktInternal::OptionalNone(),span))));
...
auto&& __jakt_match_value = __jakt_match_variant.template get<types::Type::GenericInstance>();types::StructId const& id = __jakt_match_value.id;
JaktInternal::Array<types::TypeId> const& args = __jakt_match_value.args;
return JaktInternal::ExplicitValue(({ Optional<types::TypeId> __jakt_var_290; {
types::TypeId inner_type_id = types::unknown_type_id();
...
__jakt_var_290 = inner_type_id; goto __jakt_label_272;

}
__jakt_label_272:; __jakt_var_290.release_value(); }));
};/*case end*/
default: {
return JaktInternal::ExplicitValue(({ Optional<types::TypeId> __jakt_var_291; {
TRY((((*this).error(String("Forced unwrap only works on Optional"),span))));
__jakt_var_291 = types::unknown_type_id(); goto __jakt_label_273;

}
__jakt_label_273:; __jakt_var_291.release_value(); }));
};/*case end*/
}/*switch end*/
}()
));
__jakt_var_289 = TRY((types::CheckedExpression::template create<typename types::CheckedExpression::ForcedUnwrap>(checked_expr,span,type_id))); goto __jakt_label_271;

}
__jakt_label_271:; __jakt_var_289.release_value(); }));
};/*case end*/
case 16: {
...
utility::Span const& span = __jakt_match_value.span;
return JaktInternal::ExplicitValue(({ Optional<NonnullRefPtr<types::CheckedExpression>> __jakt_var_292; {
...
__jakt_var_292 = TRY((types::CheckedExpression::template create<typename types::CheckedExpression::JaktTuple>(checked_values,span,type_id))); goto __jakt_label_274;

}
__jakt_label_274:; __jakt_var_292.release_value(); }));
};/*case end*/
case 10: {
...
utility::Span const& span = __jakt_match_value.span;
return JaktInternal::ExplicitValue(({ Optional<NonnullRefPtr<types::CheckedExpression>> __jakt_var_293; {
...
__jakt_var_293 = JAKT_RESOLVE_EXPLICIT_VALUE_OR_CONTROL_FLOW_RETURN_ONLY(([&]() -> JaktInternal::ExplicitValueOrControlFlow<NonnullRefPtr<types::CheckedExpression>, ErrorOr<NonnullRefPtr<types::CheckedExpression>>>{
auto&& __jakt_match_variant = *((*this).get_type(((checked_base)->type())));
switch(__jakt_match_variant.index()) {
case 19: {
auto&& __jakt_match_value = __jakt_match_variant.template get<types::Type::GenericInstance>();types::StructId const& id = __jakt_match_value.id;
JaktInternal::Array<types::TypeId> const& args = __jakt_match_value.args;
return JaktInternal::ExplicitValue(({ Optional<NonnullRefPtr<types::CheckedExpression>> __jakt_var_294; {
const types::StructId array_struct_id = TRY((((*this).find_struct_in_prelude(String("Array")))));
...
switch(__jakt_match_variant.index()) {
case 8: {
auto&& __jakt_match_value = __jakt_match_variant.template get<types::CheckedExpression::Range>();return JaktInternal::ExplicitValue(({ Optional<types::TypeId> __jakt_var_295; {
const types::StructId array_slice_struct_id = TRY((((*this).find_struct_in_prelude(String("ArraySlice")))));
__jakt_var_295 = TRY((((*this).find_or_add_type_id(TRY((types::Type::template create<typename types::Type::GenericInstance>(array_slice_struct_id,args))))))); goto __jakt_label_277;

}
__jakt_label_277:; __jakt_var_295.release_value(); }));
};/*case end*/
default: {
...
__jakt_var_294 = result; goto __jakt_label_276;

}
__jakt_label_276:; __jakt_var_294.release_value(); }));
};/*case end*/
default: {
return JaktInternal::ExplicitValue(({ Optional<NonnullRefPtr<types::CheckedExpression>> __jakt_var_296; {
TRY((((*this).error(String("Index used on value that cannot be indexed"),span))));
__jakt_var_296 = TRY((types::CheckedExpression::template create<typename types::CheckedExpression::Garbage>(span))); goto __jakt_label_278;

}
__jakt_label_278:; __jakt_var_296.release_value(); }));
};/*case end*/
}/*switch end*/
}()
...
__jakt_label_275:; __jakt_var_293.release_value(); }));
};/*case end*/
case 7: {
...
bool const& is_optional = __jakt_match_value.is_optional;
utility::Span const& span = __jakt_match_value.span;
return JaktInternal::ExplicitValue(({ Optional<NonnullRefPtr<types::CheckedExpression>> __jakt_var_297; {
const NonnullRefPtr<types::CheckedExpression> checked_expr = TRY((((*this).typecheck_expression_and_dereference_if_needed(expr,scope_id,safety_mode,JaktInternal::OptionalNone(),span))));
const types::StructId tuple_struct_id = TRY((((*this).find_struct_in_prelude(String("Tuple")))));
const types::StructId optional_struct_id = TRY((((*this).find_struct_in_prelude(String("Optional")))));
types::TypeId expr_type_id = types::unknown_type_id();
...
__jakt_var_297 = TRY((types::CheckedExpression::template create<typename types::CheckedExpression::IndexedTuple>(checked_expr,index,span,is_optional,expr_type_id))); goto __jakt_label_279;

}
__jakt_label_279:; __jakt_var_297.release_value(); }));
};/*case end*/
case 28: {
...
utility::Span const& span = __jakt_match_value.span;
return JaktInternal::ExplicitValue(({ Optional<NonnullRefPtr<types::CheckedExpression>> __jakt_var_298; {
...
__jakt_var_298 = output; goto __jakt_label_280;

}
__jakt_label_280:; __jakt_var_298.release_value(); }));
};/*case end*/
case 17: {
...
{
const types::CheckedVariable variable = ((*this).get_variable(((field).variable_id)));
...
ErrorOr<JaktInternal::Tuple<NonnullRefPtr<parser::ParsedExpression>,JaktInternal::Optional<parser::ParsedBlock>,JaktInternal::Optional<NonnullRefPtr<parser::ParsedStatement>>>> typechecker::Typechecker::expand_context_for_bindings(const NonnullRefPtr<parser::ParsedExpression> condition,const JaktInternal::Optional<NonnullRefPtr<parser::ParsedExpression>> acc,const JaktInternal::Optional<parser::ParsedBlock> then_block,const JaktInternal::Optional<NonnullRefPtr<parser::ParsedStatement>> else_statement,const utility::Span span) {
{
...
const JaktInternal::Tuple<NonnullRefPtr<parser::ParsedExpression>,JaktInternal::Optional<parser::ParsedBlock>,JaktInternal::Optional<NonnullRefPtr<parser::ParsedStatement>>> rhs_condition_rhs_then_block_rhs_else_statement_ = TRY((((*this).expand_context_for_bindings(rhs,acc,then_block,else_statement,span))));
const NonnullRefPtr<parser::ParsedExpression> rhs_condition = ((rhs_condition_rhs_then_block_rhs_else_statement_).get<0>());
const JaktInternal::Optional<parser::ParsedBlock> rhs_then_block = ((rhs_condition_rhs_then_block_rhs_else_statement_).get<1>());
...
const parser::ParsedBlock new_then_block = parser::ParsedBlock(outer_if_stmts);
...
const JaktInternal::Tuple<NonnullRefPtr<parser::ParsedExpression>,JaktInternal::Optional<parser::ParsedBlock>,JaktInternal::Optional<NonnullRefPtr<parser::ParsedStatement>>> new_condition_new_then_block_new_else_statement_ = TRY((((*this).expand_context_for_bindings((expr.value()),JaktInternal::OptionalNone(),JaktInternal::OptionalNone(),JaktInternal::OptionalNone(),span))));
const NonnullRefPtr<parser::ParsedExpression> new_condition = ((new_condition_new_then_block_new_else_statement_).get<0>());
const JaktInternal::Optional<parser::ParsedBlock> new_then_block = ((new_condition_new_then_block_new_else_statement_).get<1>());
const JaktInternal::Optional<NonnullRefPtr<parser::ParsedStatement>> new_else_statement = ((new_condition_new_then_block_new_else_statement_).get<2>());

const NonnullRefPtr<types::CheckedExpression> checked_expr = TRY((((*this).typecheck_expression_and_dereference_if_needed(new_condition,scope_id,safety_mode,type_hint,span))));
...
NonnullRefPtr<types::Module> module = ((*this).current_module());
(((((module)->structures))[((struct_id).id)]) = types::CheckedStruct(((parsed_record).name),((parsed_record).name_span),(TRY((Array<types::TypeId>::create_with({})))),(TRY((Array<types::CheckedField>::create_with({})))),struct_scope_id,((parsed_record).definition_linkage),((parsed_record).record_type),struct_type_id,super_struct_id));
...
const types::ScopeId block_scope_id = TRY((((*this).create_scope(method_scope_id,((func).can_throw),TRY((String::formatted(String("method-block({}::{})"),((parsed_record).name),((func).name))))))));
const bool is_generic = ((!(((((parsed_record).generic_parameters)).is_empty()))) || (!(((((func).generic_parameters)).is_empty()))));
NonnullRefPtr<types::CheckedFunction> checked_function = TRY((types::CheckedFunction::create(((func).name),((func).name_span),TRY((((*this).typecheck_visibility(((method).visibility),struct_scope_id)))),types::unknown_type_id(),((func).return_type_span),(TRY((Array<types::CheckedParameter>::create_with({})))),TRY((types::FunctionGenerics::create((TRY((Array<types::CheckedParameter>::create_with({})))),(TRY((Array<types::FunctionGenericParameter>::create_with({})))),(TRY((Array<JaktInternal::Array<types::TypeId>>::create_with({}))))))),types::CheckedBlock((TRY((Array<NonnullRefPtr<types::CheckedStatement>>::create_with({})))),block_scope_id, types::BlockControlFlow { typename types::BlockControlFlow::MayReturn() } ,types::TypeId::none(),false),((func).can_throw),((func).type),((func).linkage),method_scope_id,JaktInternal::OptionalNone(),((!(is_generic)) || is_extern),((method).parsed_function),((((method).parsed_function)).is_comptime),((method).is_virtual),((method).is_override))));
const types::FunctionId function_id = TRY((((module)->add_function(checked_function))));
...
ErrorOr<void> typechecker::Typechecker::check_implicit_constructor_argument_access(const types::ScopeId caller_scope_id,const parser::ParsedCall call,const types::CheckedStruct struct_) {
{
...
{
const JaktInternal::Tuple<NonnullRefPtr<parser::ParsedExpression>,JaktInternal::Optional<parser::ParsedBlock>,JaktInternal::Optional<NonnullRefPtr<parser::ParsedStatement>>> new_condition_new_then_block_new_else_statement_ = TRY((((*this).expand_context_for_bindings(condition,JaktInternal::OptionalNone(),then_block,else_statement,span))));
const NonnullRefPtr<parser::ParsedExpression> new_condition = ((new_condition_new_then_block_new_else_statement_).get<0>());
const JaktInternal::Optional<parser::ParsedBlock> new_then_block = ((new_condition_new_then_block_new_else_statement_).get<1>());
const JaktInternal::Optional<NonnullRefPtr<parser::ParsedStatement>> new_else_statement = ((new_condition_new_then_block_new_else_statement_).get<2>());
...
ErrorOr<NonnullRefPtr<types::CheckedExpression>> typechecker::Typechecker::typecheck_indexed_struct(const NonnullRefPtr<parser::ParsedExpression> expr,const String field_name,const types::ScopeId scope_id,const bool is_optional,const types::SafetyMode safety_mode,const utility::Span span) {
{
const NonnullRefPtr<types::CheckedExpression> checked_expr = TRY((((*this).typecheck_expression_and_dereference_if_needed(expr,scope_id,safety_mode,JaktInternal::OptionalNone(),span))));
const types::TypeId checked_expr_type_id = ((checked_expr)->type());
...
types::CheckedField field = (_magic_value.value());
{
const types::CheckedVariable member = ((*this).get_variable(((field).variable_id)));
...
const types::CheckedStruct structure = ((*this).get_struct(struct_id));
const JaktInternal::Optional<types::FieldRecord> field_record = TRY((((*this).lookup_struct_field(struct_id,field_name))));
...
f64 const& val = __jakt_match_value.value;
return JaktInternal::ExplicitValue(({ Optional<u64> __jakt_var_305; {
utility::todo(String("Implement floats"));
__jakt_var_305 = static_cast<u64>(0ULL); goto __jakt_label_282;

}
__jakt_label_282:; __jakt_var_305.release_value(); }));
};/*case end*/
default: VERIFY_NOT_REACHED();}/*switch end*/
}()
)));
...
;
__jakt_var_304 = value_expression; goto __jakt_label_281;

}
__jakt_label_281:; __jakt_var_304.release_value(); }));
}
else {
...
const NonnullRefPtr<types::CheckedFunction> checked_function = TRY((types::CheckedFunction::create(((variant).name),((variant).span), types::CheckedVisibility { typename types::CheckedVisibility::Public() } ,TRY((((*this).find_or_add_type_id(TRY((types::Type::template create<typename types::Type::Enum>(enum_id))))))),JaktInternal::OptionalNone(),params,TRY((types::FunctionGenerics::create(params,(TRY((Array<types::FunctionGenericParameter>::create_with({})))),(TRY((Array<JaktInternal::Array<types::TypeId>>::create_with({}))))))),types::CheckedBlock((TRY((Array<NonnullRefPtr<types::CheckedStatement>>::create_with({})))),block_scope_id, types::BlockControlFlow { typename types::BlockControlFlow::MayReturn() } ,types::TypeId::none(),false),can_function_throw, parser::FunctionType { typename parser::FunctionType::ImplicitEnumConstructor() } , parser::FunctionLinkage { typename parser::FunctionLinkage::Internal() } ,function_scope_id,JaktInternal::OptionalNone(),true,JaktInternal::OptionalNone(),false,false,false)));
const types::FunctionId function_id = TRY((((module)->add_function(checked_function))));
...
NonnullRefPtr<types::CheckedFunction> checked_constructor = TRY((types::CheckedFunction::create(((parsed_record).name),((parsed_record).name_span), types::CheckedVisibility { typename types::CheckedVisibility::Public() } ,struct_type_id,JaktInternal::OptionalNone(),(TRY((Array<types::CheckedParameter>::create_with({})))),TRY((types::FunctionGenerics::create((TRY((Array<types::CheckedParameter>::create_with({})))),(TRY((Array<types::FunctionGenericParameter>::create_with({})))),(TRY((Array<JaktInternal::Array<types::TypeId>>::create_with({}))))))),types::CheckedBlock((TRY((Array<NonnullRefPtr<types::CheckedStatement>>::create_with({})))),block_scope_id, types::BlockControlFlow { typename types::BlockControlFlow::MayReturn() } ,types::TypeId::none(),false),constructor_can_throw, parser::FunctionType { typename parser::FunctionType::ImplicitConstructor() } , parser::FunctionLinkage { typename parser::FunctionLinkage::Internal() } ,function_scope_id,struct_id,true,JaktInternal::OptionalNone(),false,false,false)));
NonnullRefPtr<types::Module> module = ((*this).current_module());
...
TRY((((((module)->structures)).push(types::CheckedStruct(((parsed_record).name),((parsed_record).name_span),(TRY((Array<types::TypeId>::create_with({})))),(TRY((Array<types::CheckedField>::create_with({})))),struct_scope_id,((parsed_record).definition_linkage),((parsed_record).record_type),struct_type_id,JaktInternal::OptionalNone())))));
}
return {};
}
...
(is_value_match = true);
const JaktInternal::Tuple<NonnullRefPtr<parser::ParsedExpression>,JaktInternal::Optional<parser::ParsedBlock>,JaktInternal::Optional<NonnullRefPtr<parser::ParsedStatement>>> new_condition_new_then_block_new_else_statement_ = TRY((((*this).expand_context_for_bindings(expr,JaktInternal::OptionalNone(),JaktInternal::OptionalNone(),JaktInternal::OptionalNone(),span))));
const NonnullRefPtr<parser::ParsedExpression> new_condition = ((new_condition_new_then_block_new_else_statement_).get<0>());
const JaktInternal::Optional<parser::ParsedBlock> new_then_block = ((new_condition_new_then_block_new_else_statement_).get<1>());
const JaktInternal::Optional<NonnullRefPtr<parser::ParsedStatement>> new_else_statement = ((new_condition_new_then_block_new_else_statement_).get<2>());

const NonnullRefPtr<types::CheckedExpression> checked_expression = TRY((((*this).typecheck_expression_and_dereference_if_needed(new_condition,scope_id,safety_mode,static_cast<JaktInternal::Optional<types::TypeId>>(subject_type_id),span))));
