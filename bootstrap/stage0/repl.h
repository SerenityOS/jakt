...
struct REPL {
  public:
public: NonnullRefPtr<compiler::Compiler> compiler;public: typechecker::Typechecker typechecker;public: ids::ScopeId root_scope_id;public: NonnullRefPtr<interpreter::InterpreterScope> root_interpreter_scope;public: utility::FileId file_id;public: static ErrorOr<repl::REPL> create(jakt__path::Path const runtime_path, JaktInternal::Optional<DeprecatedString> const target_triple, JaktInternal::Dictionary<DeprecatedString,DeprecatedString> const user_configuration);
public: static ErrorOr<JaktInternal::DynamicArray<u8>> line_to_bytes(DeprecatedString const line);
