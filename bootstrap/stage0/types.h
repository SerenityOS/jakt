...
constexpr u8 __jakt_init_index() const noexcept { return __jakt_variant_index - 1; }ErrorOr<DeprecatedString> debug_description() const;
[[nodiscard]] static StringLiteral Static(DeprecatedString value);
~StringLiteral();
...
[[nodiscard]] static ErrorOr<NonnullRefPtr<CheckedStatement>> InlineCpp(JaktInternal::DynamicArray<DeprecatedString> lines, utility::Span span);
...
constexpr u8 __jakt_init_index() const noexcept { return __jakt_variant_index - 1; }ErrorOr<DeprecatedString> debug_description() const;
[[nodiscard]] static CheckedCapture ByValue(DeprecatedString name, utility::Span span);
[[nodiscard]] static CheckedCapture ByReference(DeprecatedString name, utility::Span span);
[[nodiscard]] static CheckedCapture ByMutableReference(DeprecatedString name, utility::Span span);
[[nodiscard]] static CheckedCapture ByComptimeDependency(DeprecatedString name, utility::Span span);
[[nodiscard]] static CheckedCapture AllByReference(DeprecatedString name, utility::Span span);
~CheckedCapture();
...
[[nodiscard]] static CheckedTraitRequirements Methods(JaktInternal::Dictionary<DeprecatedString,ids::FunctionId> value);
...
constexpr u8 __jakt_init_index() const noexcept { return __jakt_variant_index - 1; }ErrorOr<DeprecatedString> debug_description() const;
[[nodiscard]] static CheckedEnumVariant Untyped(ids::EnumId enum_id, DeprecatedString name, utility::Span span);
[[nodiscard]] static CheckedEnumVariant Typed(ids::EnumId enum_id, DeprecatedString name, ids::TypeId type_id, utility::Span span);
[[nodiscard]] static CheckedEnumVariant WithValue(ids::EnumId enum_id, DeprecatedString name, NonnullRefPtr<typename types::CheckedExpression> expr, utility::Span span);
[[nodiscard]] static CheckedEnumVariant StructLike(ids::EnumId enum_id, DeprecatedString name, JaktInternal::DynamicArray<ids::VarId> fields, utility::Span span);
~CheckedEnumVariant();
...
constexpr u8 __jakt_init_index() const noexcept { return __jakt_variant_index - 1; }ErrorOr<DeprecatedString> debug_description() const;
[[nodiscard]] static ErrorOr<NonnullRefPtr<CheckedExpression>> Boolean(bool val, utility::Span span);
[[nodiscard]] static ErrorOr<NonnullRefPtr<CheckedExpression>> NumericConstant(types::CheckedNumericConstant val, utility::Span span, ids::TypeId type_id);
[[nodiscard]] static ErrorOr<NonnullRefPtr<CheckedExpression>> QuotedString(types::CheckedStringLiteral val, utility::Span span);
[[nodiscard]] static ErrorOr<NonnullRefPtr<CheckedExpression>> ByteConstant(DeprecatedString val, utility::Span span);
[[nodiscard]] static ErrorOr<NonnullRefPtr<CheckedExpression>> CharacterConstant(DeprecatedString val, utility::Span span);
[[nodiscard]] static ErrorOr<NonnullRefPtr<CheckedExpression>> CCharacterConstant(DeprecatedString val, utility::Span span);
[[nodiscard]] static ErrorOr<NonnullRefPtr<CheckedExpression>> UnaryOp(NonnullRefPtr<typename types::CheckedExpression> expr, types::CheckedUnaryOperator op, utility::Span span, ids::TypeId type_id);
[[nodiscard]] static ErrorOr<NonnullRefPtr<CheckedExpression>> BinaryOp(NonnullRefPtr<typename types::CheckedExpression> lhs, types::CheckedBinaryOperator op, NonnullRefPtr<typename types::CheckedExpression> rhs, utility::Span span, ids::TypeId type_id);
[[nodiscard]] static ErrorOr<NonnullRefPtr<CheckedExpression>> JaktTuple(JaktInternal::DynamicArray<NonnullRefPtr<typename types::CheckedExpression>> vals, utility::Span span, ids::TypeId type_id);
[[nodiscard]] static ErrorOr<NonnullRefPtr<CheckedExpression>> Range(JaktInternal::Optional<NonnullRefPtr<typename types::CheckedExpression>> from, JaktInternal::Optional<NonnullRefPtr<typename types::CheckedExpression>> to, utility::Span span, ids::TypeId type_id);
[[nodiscard]] static ErrorOr<NonnullRefPtr<CheckedExpression>> JaktArray(JaktInternal::DynamicArray<NonnullRefPtr<typename types::CheckedExpression>> vals, JaktInternal::Optional<NonnullRefPtr<typename types::CheckedExpression>> repeat, utility::Span span, ids::TypeId type_id, ids::TypeId inner_type_id);
[[nodiscard]] static ErrorOr<NonnullRefPtr<CheckedExpression>> JaktSet(JaktInternal::DynamicArray<NonnullRefPtr<typename types::CheckedExpression>> vals, utility::Span span, ids::TypeId type_id, ids::TypeId inner_type_id);
[[nodiscard]] static ErrorOr<NonnullRefPtr<CheckedExpression>> JaktDictionary(JaktInternal::DynamicArray<JaktInternal::Tuple<NonnullRefPtr<typename types::CheckedExpression>,NonnullRefPtr<typename types::CheckedExpression>>> vals, utility::Span span, ids::TypeId type_id, ids::TypeId key_type_id, ids::TypeId value_type_id);
[[nodiscard]] static ErrorOr<NonnullRefPtr<CheckedExpression>> IndexedExpression(NonnullRefPtr<typename types::CheckedExpression> expr, NonnullRefPtr<typename types::CheckedExpression> index, utility::Span span, ids::TypeId type_id);
[[nodiscard]] static ErrorOr<NonnullRefPtr<CheckedExpression>> IndexedDictionary(NonnullRefPtr<typename types::CheckedExpression> expr, NonnullRefPtr<typename types::CheckedExpression> index, utility::Span span, ids::TypeId type_id);
[[nodiscard]] static ErrorOr<NonnullRefPtr<CheckedExpression>> IndexedTuple(NonnullRefPtr<typename types::CheckedExpression> expr, size_t index, utility::Span span, bool is_optional, ids::TypeId type_id);
[[nodiscard]] static ErrorOr<NonnullRefPtr<CheckedExpression>> IndexedStruct(NonnullRefPtr<typename types::CheckedExpression> expr, DeprecatedString name, JaktInternal::Optional<ids::VarId> index, utility::Span span, bool is_optional, ids::TypeId type_id);
[[nodiscard]] static ErrorOr<NonnullRefPtr<CheckedExpression>> IndexedCommonEnumMember(NonnullRefPtr<typename types::CheckedExpression> expr, DeprecatedString index, utility::Span span, bool is_optional, ids::TypeId type_id);
[[nodiscard]] static ErrorOr<NonnullRefPtr<CheckedExpression>> ComptimeIndex(NonnullRefPtr<typename types::CheckedExpression> expr, NonnullRefPtr<typename types::CheckedExpression> index, bool is_optional, utility::Span span);
[[nodiscard]] static ErrorOr<NonnullRefPtr<CheckedExpression>> Match(NonnullRefPtr<typename types::CheckedExpression> expr, JaktInternal::DynamicArray<types::CheckedMatchCase> match_cases, utility::Span span, ids::TypeId type_id, bool all_variants_constant);
[[nodiscard]] static ErrorOr<NonnullRefPtr<CheckedExpression>> EnumVariantArg(NonnullRefPtr<typename types::CheckedExpression> expr, types::CheckedEnumVariantBinding arg, types::CheckedEnumVariant enum_variant, utility::Span span);
[[nodiscard]] static ErrorOr<NonnullRefPtr<CheckedExpression>> Call(types::CheckedCall call, utility::Span span, ids::TypeId type_id);
[[nodiscard]] static ErrorOr<NonnullRefPtr<CheckedExpression>> MethodCall(NonnullRefPtr<typename types::CheckedExpression> expr, types::CheckedCall call, utility::Span span, bool is_optional, ids::TypeId type_id);
[[nodiscard]] static ErrorOr<NonnullRefPtr<CheckedExpression>> NamespacedVar(JaktInternal::DynamicArray<types::CheckedNamespace> namespaces, NonnullRefPtr<types::CheckedVariable> var, utility::Span span);
[[nodiscard]] static ErrorOr<NonnullRefPtr<CheckedExpression>> Var(NonnullRefPtr<types::CheckedVariable> var, utility::Span span);
[[nodiscard]] static ErrorOr<NonnullRefPtr<CheckedExpression>> OptionalNone(utility::Span span, ids::TypeId type_id);
[[nodiscard]] static ErrorOr<NonnullRefPtr<CheckedExpression>> OptionalSome(NonnullRefPtr<typename types::CheckedExpression> expr, utility::Span span, ids::TypeId type_id);
[[nodiscard]] static ErrorOr<NonnullRefPtr<CheckedExpression>> ForcedUnwrap(NonnullRefPtr<typename types::CheckedExpression> expr, utility::Span span, ids::TypeId type_id);
[[nodiscard]] static ErrorOr<NonnullRefPtr<CheckedExpression>> Block(types::CheckedBlock block, utility::Span span, ids::TypeId type_id);
[[nodiscard]] static ErrorOr<NonnullRefPtr<CheckedExpression>> Function(JaktInternal::DynamicArray<types::CheckedCapture> captures, JaktInternal::DynamicArray<types::CheckedParameter> params, bool can_throw, ids::TypeId return_type_id, types::CheckedBlock block, utility::Span span, ids::TypeId type_id, JaktInternal::Optional<ids::FunctionId> pseudo_function_id, ids::ScopeId scope_id);
[[nodiscard]] static ErrorOr<NonnullRefPtr<CheckedExpression>> DependentFunction(JaktInternal::DynamicArray<types::CheckedCapture> captures, JaktInternal::DynamicArray<types::CheckedParameter> params, bool can_throw, ids::TypeId return_type_id, parser::ParsedBlock block, utility::Span span, ids::TypeId type_id, JaktInternal::Optional<ids::FunctionId> pseudo_function_id, ids::ScopeId scope_id);
[[nodiscard]] static ErrorOr<NonnullRefPtr<CheckedExpression>> Try(NonnullRefPtr<typename types::CheckedExpression> expr, JaktInternal::Optional<types::CheckedBlock> catch_block, JaktInternal::Optional<utility::Span> catch_span, JaktInternal::Optional<DeprecatedString> catch_name, utility::Span span, ids::TypeId type_id, ids::TypeId inner_type_id);
[[nodiscard]] static ErrorOr<NonnullRefPtr<CheckedExpression>> TryBlock(NonnullRefPtr<typename types::CheckedStatement> stmt, types::CheckedBlock catch_block, DeprecatedString error_name, utility::Span error_span, utility::Span span, ids::TypeId type_id);
[[nodiscard]] static ErrorOr<NonnullRefPtr<CheckedExpression>> Reflect(ids::TypeId type, utility::Span span, ids::TypeId type_id);
[[nodiscard]] static ErrorOr<NonnullRefPtr<CheckedExpression>> Garbage(utility::Span span, ids::TypeId type_id);
~CheckedExpression();
...
[[nodiscard]] static ErrorOr<NonnullRefPtr<Type>> TypeVariable(parser::CheckedQualifiers qualifiers, DeprecatedString name, JaktInternal::DynamicArray<ids::TypeId> trait_implementations, bool is_value);
[[nodiscard]] static ErrorOr<NonnullRefPtr<Type>> Dependent(parser::CheckedQualifiers qualifiers, ids::TypeId namespace_type, DeprecatedString name);
...
public: ErrorOr<JaktInternal::Optional<ids::StructId>> find_struct_in_scope(ids::ScopeId const scope_id, DeprecatedString const name, bool const ignore_mixin_scopes, bool const ignore_parent_scopes) const;
public: ErrorOr<JaktInternal::Optional<ids::TypeId>> find_type_in_scope(ids::ScopeId const scope_id, DeprecatedString const name, bool const ignore_mixin_scopes, bool const ignore_parent_scopes) const;
...
private: ErrorOr<JaktInternal::Optional<bool>> for_each_scope_accessible_unqualified_from_scope_impl(ids::ScopeId const scope_id, Function<ErrorOr<typename utility::IterationDecision<bool>>(ids::ScopeId, JaktInternal::Optional<DeprecatedString>, bool)> const& callback, bool const ignore_mixin_scopes, bool const ignore_parent_scopes) const;
...
public: ErrorOr<DeprecatedString> debug_description_of(ids::ScopeId const scope_id) const;
...
public: ErrorOr<JaktInternal::Optional<JaktInternal::Tuple<ids::TypeId,ids::ScopeId>>> find_type_scope(ids::ScopeId const scope_id, DeprecatedString const name, bool const ignore_mixin_scopes, bool const ignore_parent_scopes) const;
public: ErrorOr<ids::StructId> builtin_implementation_struct(types::BuiltinType const builtin, ids::ModuleId const for_module);
public: ErrorOr<JaktInternal::Optional<types::Value>> find_comptime_binding_in_scope(ids::ScopeId const scope_id, DeprecatedString const name, bool const ignore_mixin_scopes, bool const ignore_parent_scopes) const;
...
private: ErrorOr<JaktInternal::Optional<bool>> for_each_scope_accessible_unqualified_from_scope_direct_chain(ids::ScopeId const scope_id, Function<ErrorOr<typename utility::IterationDecision<bool>>(ids::ScopeId, JaktInternal::Optional<DeprecatedString>, bool)> const& callback, bool const ignore_parent_scopes) const;
...
public: ErrorOr<JaktInternal::Optional<ids::TraitId>> find_trait_in_scope(ids::ScopeId const scope_id, DeprecatedString const name, bool const ignore_mixin_scopes, bool const ignore_parent_scopes) const;
...
public: ErrorOr<JaktInternal::Optional<JaktInternal::DynamicArray<ids::FunctionId>>> find_functions_with_name_in_scope(ids::ScopeId const parent_scope_id, DeprecatedString const function_name, bool const ignore_mixin_scopes, bool const ignore_parent_scopes) const;
public: ErrorOr<JaktInternal::Optional<NonnullRefPtr<types::CheckedVariable>>> find_var_in_scope(ids::ScopeId const scope_id, DeprecatedString const var, bool const ignore_mixin_scopes, bool const ignore_parent_scopes) const;
...
public: ErrorOr<JaktInternal::Optional<ids::EnumId>> find_enum_in_scope(ids::ScopeId const scope_id, DeprecatedString const name, bool const ignore_mixin_scopes, bool const ignore_parent_scopes) const;
public: JaktInternal::Optional<types::LoadedModule> get_loaded_module(DeprecatedString const module_name) const;
public: ErrorOr<JaktInternal::Optional<JaktInternal::Tuple<JaktInternal::DynamicArray<ids::FunctionId>,ids::ScopeId>>> find_scoped_functions_with_name_in_scope(ids::ScopeId const parent_scope_id, DeprecatedString const function_name, bool const ignore_mixin_scopes, bool const ignore_parent_scopes) const;
public: bool is_signed(ids::TypeId const type_id) const;
public: bool is_numeric(ids::TypeId const type_id) const;
public: template <typename T>
ErrorOr<JaktInternal::Optional<T>> for_each_scope_accessible_unqualified_from_scope(ids::ScopeId const scope_id, Function<ErrorOr<typename utility::IterationDecision<T>>(ids::ScopeId, JaktInternal::Optional<DeprecatedString>, bool)> const& callback, bool const ignore_mixin_scopes, bool const ignore_parent_scopes) const;
...
[[nodiscard]] static ErrorOr<NonnullRefPtr<ValueImpl>> JaktString(DeprecatedString value);
[[nodiscard]] static ErrorOr<NonnullRefPtr<ValueImpl>> StringView(DeprecatedString value);
...
constexpr u8 __jakt_init_index() const noexcept { return __jakt_variant_index - 1; }ErrorOr<DeprecatedString> debug_description() const;
[[nodiscard]] static NumericOrStringValue StringValue(DeprecatedString value);
...
[[nodiscard]] static ErrorOr<NonnullRefPtr<MaybeResolvedScope>> Unresolved(NonnullRefPtr<typename types::MaybeResolvedScope> parent_scope, DeprecatedString relative_name);
~MaybeResolvedScope();
