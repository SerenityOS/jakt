...
DeprecatedString name;utility::Span name_span;types::CheckedTraitRequirements requirements;JaktInternal::DynamicArray<types::CheckedGenericParameter> generic_parameters;ids::ScopeId scope_id;protected:
...
ErrorOr<DeprecatedString> debug_description() const;
  ...
  public:
DeprecatedString name;ids::ScopeId scope;CheckedNamespace(DeprecatedString a_name, ids::ScopeId a_scope);

ErrorOr<DeprecatedString> debug_description() const;
};class Module : public RefCounted<Module>, public Weakable<Module> {
  public:
virtual ~Module() = default;
ids::ModuleId id;DeprecatedString name;JaktInternal::DynamicArray<NonnullRefPtr<types::CheckedFunction>> functions;JaktInternal::DynamicArray<types::CheckedStruct> structures;JaktInternal::DynamicArray<types::CheckedEnum> enums;JaktInternal::DynamicArray<NonnullRefPtr<types::Scope>> scopes;JaktInternal::DynamicArray<NonnullRefPtr<typename types::Type>> types;JaktInternal::DynamicArray<NonnullRefPtr<types::CheckedTrait>> traits;JaktInternal::DynamicArray<NonnullRefPtr<types::CheckedVariable>> variables;JaktInternal::DynamicArray<ids::ModuleId> imports;DeprecatedString resolved_import_path;JaktInternal::Dictionary<size_t,ids::StructId> builtin_implementation_structs;bool is_root;ids::FunctionId next_function_id() const;
ErrorOr<ids::FunctionId> add_function(NonnullRefPtr<types::CheckedFunction> const checked_function);
...
ErrorOr<ids::VarId> add_variable(NonnullRefPtr<types::CheckedVariable> const checked_variable);
ErrorOr<ids::TypeId> new_type_variable(JaktInternal::Optional<JaktInternal::DynamicArray<ids::TypeId>> const implemented_traits);
ErrorOr<DeprecatedString> debug_description() const;
...
NonnullRefPtr<compiler::Compiler> compiler;JaktInternal::DynamicArray<NonnullRefPtr<types::Module>> modules;JaktInternal::Dictionary<DeprecatedString,types::LoadedModule> loaded_modules;ErrorOr<ids::TypeId> substitute_typevars_in_type(ids::TypeId const type_id, types::GenericInferences const generic_inferences, ids::ModuleId const module_id);
ids::ModuleId prelude_module_id() const;
ErrorOr<JaktInternal::Optional<ids::ScopeId>> find_namespace_in_immediate_children_of_scope(ids::ScopeId const scope_id, DeprecatedString const name, bool const treat_aliases_as_imports) const;
...
ErrorOr<JaktInternal::Optional<ids::FunctionId>> find_default_constructors_in_scope(ids::ScopeId const parent_scope_id, DeprecatedString const function_name) const;
...
ErrorOr<ids::ScopeId> find_type_scope_id(ids::TypeId const type_id);
bool is_integer(ids::TypeId const type_id) const;
ErrorOr<ids::ScopeId> create_scope(JaktInternal::Optional<ids::ScopeId> const parent_scope_id, bool const can_throw, DeprecatedString const debug_name, ids::ModuleId const module_id, bool const for_block);
NonnullRefPtr<types::Module> get_module(ids::ModuleId const id) const;
ErrorOr<DeprecatedString> type_name(ids::TypeId const type_id, bool const debug_mode) const;
ErrorOr<JaktInternal::Optional<bool>> for_each_scope_accessible_unqualified_from_scope_impl(ids::ScopeId const scope_id, Function<ErrorOr<typename utility::IterationDecision<bool>>(ids::ScopeId, JaktInternal::Optional<DeprecatedString>, bool)> const& callback) const;
ErrorOr<bool> is_scope_directly_accessible_from(ids::ScopeId const check_scope_id, ids::ScopeId const scope_id) const;
ErrorOr<bool> is_string(ids::TypeId const type_id) const;
...
ErrorOr<ids::StructId> builtin_implementation_struct(types::BuiltinType const builtin, ids::ModuleId const for_module);
ErrorOr<ids::TypeId> substitute_typevars_in_type_helper(ids::TypeId const type_id, types::GenericInferences const generic_inferences, ids::ModuleId const module_id);
...
i64 get_bits(ids::TypeId const type_id) const;
NonnullRefPtr<typename types::Type> get_type(ids::TypeId const id) const;
ErrorOr<ids::TypeId> find_or_add_type_id(NonnullRefPtr<typename types::Type> const type, ids::ModuleId const module_id);
...
ErrorOr<JaktInternal::Optional<ids::FunctionId>> find_function_in_scope(ids::ScopeId const parent_scope_id, DeprecatedString const function_name) const;
types::CheckedStruct get_struct(ids::StructId const id) const;
ErrorOr<JaktInternal::Optional<ids::StructId>> check_and_extract_weak_ptr(ids::StructId const struct_id, JaktInternal::DynamicArray<ids::TypeId> const args) const;
ErrorOr<JaktInternal::Optional<ids::EnumId>> find_enum_in_scope(ids::ScopeId const scope_id, DeprecatedString const name) const;
...
bool is_signed(ids::TypeId const type_id) const;
bool is_numeric(ids::TypeId const type_id) const;
template <typename T>
ErrorOr<JaktInternal::Optional<T>> for_each_scope_accessible_unqualified_from_scope(ids::ScopeId const scope_id, Function<ErrorOr<typename utility::IterationDecision<T>>(ids::ScopeId, JaktInternal::Optional<DeprecatedString>, bool)> const& callback) const;
...
bool is_specialized_for_types(JaktInternal::DynamicArray<ids::TypeId> const types) const;
void set_param_default_value(size_t const param_index, NonnullRefPtr<typename types::CheckedExpression> const default_value);
...
ErrorOr<DeprecatedString> debug_description() const;
  ...
  public:
ids::ModuleId module_id;utility::FileId file_id;LoadedModule(ids::ModuleId a_module_id, utility::FileId a_file_id);
...
ids::ScopeId base_scope_id;JaktInternal::DynamicArray<types::CheckedParameter> base_params;JaktInternal::DynamicArray<types::FunctionGenericParameter> params;JaktInternal::DynamicArray<JaktInternal::DynamicArray<ids::TypeId>> specializations;protected:
...
ErrorOr<DeprecatedString> debug_description() const;
  ...
  public:
ids::StructId struct_id;ids::VarId field_id;FieldRecord(ids::StructId a_struct_id, ids::VarId a_field_id);
...
Function<ErrorOr<types::CheckedBlock>(parser::ParsedBlock, ids::ScopeId, types::SafetyMode, JaktInternal::Optional<ids::TypeId>)> block;Function<ErrorOr<ids::FunctionId>(NonnullRefPtr<types::CheckedFunction>)> register_function;protected:
...
public:
static ErrorOr<NonnullRefPtr<Scope>> __jakt_create(JaktInternal::Optional<DeprecatedString> namespace_name, JaktInternal::Optional<parser::ExternalName> external_name, JaktInternal::Dictionary<DeprecatedString,ids::VarId> vars, JaktInternal::Dictionary<DeprecatedString,types::Value> comptime_bindings, JaktInternal::Dictionary<DeprecatedString,ids::StructId> structs, JaktInternal::Dictionary<DeprecatedString,JaktInternal::DynamicArray<ids::FunctionId>> functions, JaktInternal::Dictionary<DeprecatedString,ids::EnumId> enums, JaktInternal::Dictionary<DeprecatedString,ids::TypeId> types, JaktInternal::Dictionary<DeprecatedString,ids::TraitId> traits, JaktInternal::Dictionary<DeprecatedString,ids::ModuleId> imports, JaktInternal::Dictionary<DeprecatedString,ids::ScopeId> aliases, JaktInternal::Optional<ids::ScopeId> parent, JaktInternal::Optional<ids::ScopeId> alias_scope, JaktInternal::DynamicArray<ids::ScopeId> children, bool can_throw, JaktInternal::Optional<DeprecatedString> import_path_if_extern, JaktInternal::Optional<JaktInternal::DynamicArray<types::ResolvedNamespace>> alias_path, JaktInternal::DynamicArray<parser::IncludeAction> after_extern_include, JaktInternal::DynamicArray<parser::IncludeAction> before_extern_include, DeprecatedString debug_name, JaktInternal::DynamicArray<ids::ScopeId> resolution_mixins, bool is_block_scope, JaktInternal::Optional<JaktInternal::DynamicArray<types::ResolvedForallChunk>> resolved_forall_chunks);
...
struct CheckedGenericParameter {
  public:
ids::TypeId type_id;JaktInternal::DynamicArray<ids::TraitId> constraints;utility::Span span;static ErrorOr<types::CheckedGenericParameter> make(ids::TypeId const type_id, utility::Span const span);
CheckedGenericParameter(ids::TypeId a_type_id, JaktInternal::DynamicArray<ids::TraitId> a_constraints, utility::Span a_span);

ErrorOr<DeprecatedString> debug_description() const;
};struct FunctionGenericParameter {
  public:
types::FunctionGenericParameterKind kind;types::CheckedGenericParameter checked_parameter;static ErrorOr<types::FunctionGenericParameter> parameter(ids::TypeId const type_id, utility::Span const span);
...
struct CheckedStruct {
  public:
DeprecatedString name;utility::Span name_span;JaktInternal::DynamicArray<types::CheckedGenericParameter> generic_parameters;JaktInternal::Optional<JaktInternal::DynamicArray<JaktInternal::Optional<ids::TypeId>>> generic_parameter_defaults;JaktInternal::DynamicArray<types::CheckedField> fields;ids::ScopeId scope_id;parser::DefinitionLinkage definition_linkage;JaktInternal::Dictionary<DeprecatedString,JaktInternal::DynamicArray<JaktInternal::Tuple<ids::TraitId,JaktInternal::DynamicArray<ids::TypeId>>>> trait_implementations;parser::RecordType record_type;ids::TypeId type_id;JaktInternal::Optional<ids::StructId> super_struct_id;JaktInternal::Optional<parser::ExternalName> external_name;JaktInternal::Optional<ids::TypeId> implements_type;CheckedStruct(DeprecatedString a_name, utility::Span a_name_span, JaktInternal::DynamicArray<types::CheckedGenericParameter> a_generic_parameters, JaktInternal::Optional<JaktInternal::DynamicArray<JaktInternal::Optional<ids::TypeId>>> a_generic_parameter_defaults, JaktInternal::DynamicArray<types::CheckedField> a_fields, ids::ScopeId a_scope_id, parser::DefinitionLinkage a_definition_linkage, JaktInternal::Dictionary<DeprecatedString,JaktInternal::DynamicArray<JaktInternal::Tuple<ids::TraitId,JaktInternal::DynamicArray<ids::TypeId>>>> a_trait_implementations, parser::RecordType a_record_type, ids::TypeId a_type_id, JaktInternal::Optional<ids::StructId> a_super_struct_id, JaktInternal::Optional<parser::ExternalName> a_external_name, JaktInternal::Optional<ids::TypeId> a_implements_type);
...
struct CheckedVarDecl {
  public:
DeprecatedString name;bool is_mutable;utility::Span span;ids::TypeId type_id;CheckedVarDecl(DeprecatedString a_name, bool a_is_mutable, utility::Span a_span, ids::TypeId a_type_id);
...
struct CheckedEnumVariantBinding {
  public:
JaktInternal::Optional<DeprecatedString> name;DeprecatedString binding;ids::TypeId type_id;utility::Span span;CheckedEnumVariantBinding(JaktInternal::Optional<DeprecatedString> a_name, DeprecatedString a_binding, ids::TypeId a_type_id, utility::Span a_span);

ErrorOr<DeprecatedString> debug_description() const;
};struct GenericInferences {
  public:
JaktInternal::Dictionary<ids::TypeId,ids::TypeId> values;ErrorOr<void> set_all(JaktInternal::DynamicArray<types::CheckedGenericParameter> const keys, JaktInternal::DynamicArray<ids::TypeId> const values);
ErrorOr<void> set_from(JaktInternal::Dictionary<ids::TypeId,ids::TypeId> const checkpoint);
ErrorOr<JaktInternal::Optional<ids::TypeId>> find_and_map(DeprecatedString const name, NonnullRefPtr<types::CheckedProgram> const& program) const;
GenericInferences(JaktInternal::Dictionary<ids::TypeId,ids::TypeId> a_values);

void restore(JaktInternal::Dictionary<ids::TypeId,ids::TypeId> const checkpoint);
ErrorOr<void> debug_description(NonnullRefPtr<types::CheckedProgram> const& program) const;
ids::TypeId map(ids::TypeId const type) const;
ErrorOr<JaktInternal::Dictionary<ids::TypeId,ids::TypeId>> perform_checkpoint(bool const reset);
JaktInternal::Optional<ids::TypeId> get(ids::TypeId const key) const;
JaktInternal::Dictionary<ids::TypeId,ids::TypeId> iterator() const;
ErrorOr<void> set(ids::TypeId const key, ids::TypeId const value);
ErrorOr<DeprecatedString> debug_description() const;
...
struct ResolvedNamespace {
  public:
DeprecatedString name;JaktInternal::Optional<parser::ExternalName> external_name;JaktInternal::Optional<JaktInternal::DynamicArray<ids::TypeId>> generic_parameters;ResolvedNamespace(DeprecatedString a_name, JaktInternal::Optional<parser::ExternalName> a_external_name, JaktInternal::Optional<JaktInternal::DynamicArray<ids::TypeId>> a_generic_parameters);
...
struct ClassInstanceRebind {
  public:
DeprecatedString name;utility::Span name_span;bool is_mutable;bool is_reference;ClassInstanceRebind(DeprecatedString a_name, utility::Span a_name_span, bool a_is_mutable, bool a_is_reference);
...
struct ResolvedForallChunk {
  public:
JaktInternal::Dictionary<DeprecatedString,JaktInternal::DynamicArray<JaktInternal::Tuple<utility::Span,ids::TypeId>>> parameters;parser::ParsedNamespace parsed_namespace;JaktInternal::DynamicArray<ids::ScopeId> generated_scopes;ResolvedForallChunk(JaktInternal::Dictionary<DeprecatedString,JaktInternal::DynamicArray<JaktInternal::Tuple<utility::Span,ids::TypeId>>> a_parameters, parser::ParsedNamespace a_parsed_namespace, JaktInternal::DynamicArray<ids::ScopeId> a_generated_scopes);
...
struct CheckedParameter {
  public:
bool requires_label;NonnullRefPtr<types::CheckedVariable> variable;JaktInternal::Optional<NonnullRefPtr<typename types::CheckedExpression>> default_value;ErrorOr<types::CheckedParameter> map_types(Function<ErrorOr<ids::TypeId>(ids::TypeId)> const& map) const;
