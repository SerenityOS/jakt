...
NonnullRefPtr<typename types::CheckedExpression> expr;
DeprecatedString name;
JaktInternal::Optional<types::VarId> index;
utility::Span span;
bool is_optional;
types::TypeId type_id;
