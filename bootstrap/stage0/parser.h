...
public:
ErrorOr<ByteString> as_name_for_definition() const;
...
public: ErrorOr<void> add_child_namespace(parser::ParsedNamespace const namespace_);
...
[[nodiscard]] static ErrorOr<NonnullRefPtr<ParsedExpression>> QuotedString(ByteString val, utility::Span span);
[[nodiscard]] static ErrorOr<NonnullRefPtr<ParsedExpression>> SingleQuotedString(ByteString val, JaktInternal::Optional<ByteString> prefix, utility::Span span);
...
[[nodiscard]] static ErrorOr<NonnullRefPtr<ParsedExpression>> IndexedStruct(NonnullRefPtr<typename parser::ParsedExpression> expr, ByteString field_name, bool is_optional, utility::Span span);
...
[[nodiscard]] static ErrorOr<NonnullRefPtr<ParsedExpression>> Var(ByteString name, utility::Span span);
...
[[nodiscard]] static ErrorOr<NonnullRefPtr<ParsedExpression>> NamespacedVar(ByteString name, JaktInternal::DynamicArray<ByteString> namespace_, utility::Span span);
...
[[nodiscard]] static ErrorOr<NonnullRefPtr<ParsedExpression>> Try(NonnullRefPtr<typename parser::ParsedExpression> expr, JaktInternal::Optional<parser::ParsedBlock> catch_block, JaktInternal::Optional<utility::Span> catch_span, JaktInternal::Optional<ByteString> catch_name, utility::Span span);
[[nodiscard]] static ErrorOr<NonnullRefPtr<ParsedExpression>> TryBlock(NonnullRefPtr<typename parser::ParsedStatement> stmt, ByteString error_name, utility::Span error_span, parser::ParsedBlock catch_block, utility::Span span);
...
constexpr u8 __jakt_init_index() const noexcept { return __jakt_variant_index - 1; }ErrorOr<ByteString> debug_description() const;
[[nodiscard]] static ErrorOr<NonnullRefPtr<ParsedType>> Name(JaktInternal::Optional<parser::ParsedTypeQualifiers> qualifiers, ByteString name, utility::Span span);
[[nodiscard]] static ErrorOr<NonnullRefPtr<ParsedType>> NamespacedName(JaktInternal::Optional<parser::ParsedTypeQualifiers> qualifiers, ByteString name, JaktInternal::DynamicArray<ByteString> namespaces, JaktInternal::DynamicArray<NonnullRefPtr<typename parser::ParsedType>> params, utility::Span span);
[[nodiscard]] static ErrorOr<NonnullRefPtr<ParsedType>> GenericType(JaktInternal::Optional<parser::ParsedTypeQualifiers> qualifiers, ByteString name, JaktInternal::DynamicArray<NonnullRefPtr<typename parser::ParsedType>> generic_parameters, utility::Span span);
...
[[nodiscard]] static ErrorOr<NonnullRefPtr<ParsedType>> DependentType(JaktInternal::Optional<parser::ParsedTypeQualifiers> qualifiers, NonnullRefPtr<typename parser::ParsedType> base, ByteString name, utility::Span span);
...
public: ErrorOr<ByteString> debug_description() const;
  ...
  public:
public: size_t index;public: JaktInternal::DynamicArray<lexer::Token> tokens;public: NonnullRefPtr<compiler::Compiler> compiler;public: bool can_have_trailing_closure;public: size_t next_function_id;public: static ErrorOr<parser::ParsedNamespace> parse(NonnullRefPtr<compiler::Compiler> const compiler, JaktInternal::DynamicArray<lexer::Token> const tokens);
...
public: ErrorOr<NonnullRefPtr<typename parser::ParsedExpression>> parse_operand_base();
