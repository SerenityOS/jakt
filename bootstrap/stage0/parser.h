...
ErrorOr<DeprecatedString> debug_description() const;
  ...
  public:
size_t index;JaktInternal::DynamicArray<lexer::Token> tokens;NonnullRefPtr<compiler::Compiler> compiler;bool can_have_trailing_closure;ErrorOr<NonnullRefPtr<typename parser::ParsedExpression>> parse_operand_base();
