...
public: ByteString debug_description() const;
  ...
  public:
public: ByteString name;public: NonnullRefPtr<typename Jakt::parser::ParsedType> parsed_type;public: bool is_mutable;public: JaktInternal::Optional<Jakt::utility::Span> inlay_span;public: Jakt::utility::Span span;public: JaktInternal::Optional<Jakt::parser::ExternalName> external_name;public: bool is_autogenerated;public: bool equals(Jakt::parser::ParsedVarDecl const rhs_var_decl) const;
public: ParsedVarDecl(ByteString a_name, NonnullRefPtr<typename Jakt::parser::ParsedType> a_parsed_type, bool a_is_mutable, JaktInternal::Optional<Jakt::utility::Span> a_inlay_span, Jakt::utility::Span a_span, JaktInternal::Optional<Jakt::parser::ExternalName> a_external_name, bool a_is_autogenerated);
...
[[nodiscard]] static NonnullRefPtr<ParsedStatement> DestructuringDeclaration(JaktInternal::DynamicArray<Jakt::parser::ParsedVarDecl> vars, NonnullRefPtr<typename Jakt::parser::ParsedStatement> var_decl, Jakt::utility::Span span);
