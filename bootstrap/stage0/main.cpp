...
if (is_directory){
auto __jakt_var_922 = [&]() -> ErrorOr<void> { return TRY((jakt__platform__unknown_fs::make_directory(((TRY((((to).join(((path_relative_to_target).to_string())))))).to_string())))), ErrorOr<void>{}; }();
;
...
size_t const max_concurrent = (infallible_integer_cast<size_t>((({ Optional<u32> __jakt_var_923;
auto __jakt_var_924 = [&]() -> ErrorOr<u32> { return TRY((value_or_throw<u32>(((compiler_job_count).to_uint())))); }();
...
if (__jakt_enum_value == true) {
return JaktInternal::ExplicitValue(({ Optional<JaktInternal::DynamicArray<types::Value>> __jakt_var_925; {
...
__jakt_var_925 = (TRY((DynamicArray<types::Value>::create_with({types::Value(TRY((types::ValueImpl::template __jakt_create<typename types::ValueImpl::JaktArray>(passed_arguments,(((((first_main_param.value())).variable))->type_id)))),call_span)})))); goto __jakt_label_793;

}
__jakt_label_793:; __jakt_var_925.release_value(); }));
}
...
jakt__path::Path const path = TRY((((binary_dir).join(file))));
auto __jakt_var_927 = [&]() -> ErrorOr<void> { return TRY((utility::write_to_file(contents,((path).to_string())))), ErrorOr<void>{}; }();
if (__jakt_var_927.is_error()) {auto error = __jakt_var_927.release_error();
{
...
auto __jakt_var_928 = [&]() -> ErrorOr<void> {{
TRY((utility::write_to_file(TRY((((depfile_builder).to_string()))),(generate_depfile.value()))));
}

;return {};}();
if (__jakt_var_928.is_error()) {auto error = __jakt_var_928.release_error();{
...
auto __jakt_var_930 = [&]() -> ErrorOr<void> { return TRY((((builder).build_all(binary_dir,(([use_ccache, cxx_compiler_path, runtime_path, extra_include_paths, optimize, extra_compiler_flags](DeprecatedString input_filename, DeprecatedString output_filename) -> ErrorOr<JaktInternal::DynamicArray<DeprecatedString>> {
{
...
auto __jakt_var_932 = [&]() -> ErrorOr<void> { return TRY((((builder).link_into_archive(TRY((archiver_path.try_value_or_lazy_evaluated([&]() -> ErrorOr<DeprecatedString> { return TRY(DeprecatedString::from_utf8("ar"sv)); }))),((TRY((((binary_dir).join((link_archive.value())))))).to_string()))))), ErrorOr<void>{}; }();
...
auto __jakt_var_934 = [&]() -> ErrorOr<void> { return TRY((((builder).link_into_executable(cxx_compiler_path,output_filename,extra_arguments)))), ErrorOr<void>{}; }();
...
__jakt_var_935 = (infallible_integer_cast<size_t>(((end_input.value())))); goto __jakt_label_794;

}
__jakt_label_794:; __jakt_var_935.release_value(); }));
}
else {
{
return JaktInternal::OptionalNone();
