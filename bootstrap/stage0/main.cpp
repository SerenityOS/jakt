...
bool const archive_link_support_libs = TRY((((args_parser).flag((TRY((DynamicArray<DeprecatedString>::create_with({TRY(DeprecatedString::from_utf8("--archive-link-support-libs"sv))}))))))));
...
TRY((((depfile_builder).append(TRY((escape_for_depfile(((TRY((((binary_dir).join((link_archive.value())))))).to_string()))))))));
}
else {
TRY((((depfile_builder).append(TRY((escape_for_depfile(output_filename)))))));
}

TRY((((depfile_builder).append((StringView::from_string_literal(" : "sv))))));
JaktInternal::Set<DeprecatedString> seen_files = (TRY((Set<DeprecatedString>::create_with_values({}))));
{
JaktInternal::DictionaryIterator<DeprecatedString,JaktInternal::Tuple<DeprecatedString,DeprecatedString>> _magic = ((codegen_result).iterator());
for (;;){
JaktInternal::Optional<JaktInternal::Tuple<DeprecatedString,JaktInternal::Tuple<DeprecatedString,DeprecatedString>>> const _magic_value = ((_magic).next());
...
JaktInternal::Tuple<DeprecatedString,JaktInternal::Tuple<DeprecatedString,DeprecatedString>> ___contents_and_path__ = (_magic_value.value());
{
JaktInternal::Tuple<DeprecatedString,JaktInternal::Tuple<DeprecatedString,DeprecatedString>> const jakt_____contents_and_path__ = ___contents_and_path__;
DeprecatedString const _ = ((jakt_____contents_and_path__).template get<0>());
JaktInternal::Tuple<DeprecatedString,DeprecatedString> const contents_and_path = ((jakt_____contents_and_path__).template get<1>());
...
DeprecatedString const file = TRY((escape_for_depfile(module_file_path)));
...
{
JaktInternal::DictionaryIterator<DeprecatedString,ids::ScopeId> _magic = ((((typechecker).cpp_import_cache)).iterator());
for (;;){
JaktInternal::Optional<JaktInternal::Tuple<DeprecatedString,ids::ScopeId>> const _magic_value = ((_magic).next());
if ((!(((_magic_value).has_value())))){
break;
}
JaktInternal::Tuple<DeprecatedString,ids::ScopeId> path_____ = (_magic_value.value());
{
JaktInternal::Tuple<DeprecatedString,ids::ScopeId> const jakt__path_____ = path_____;
DeprecatedString const path = ((jakt__path_____).template get<0>());
ids::ScopeId const _ = ((jakt__path_____).template get<1>());

JaktInternal::Optional<jakt__path::Path> const full_path = TRY((((compiler)->find_in_search_paths(TRY((jakt__path::Path::from_string(path)))))));
DeprecatedString entry = path;
if (((full_path).has_value())){
(entry = (((full_path.value())).to_string()));
}
TRY((((depfile_builder).append((StringView::from_string_literal(" \\\n  "sv))))));
TRY((((depfile_builder).append(TRY((escape_for_depfile(entry)))))));
}
...
auto __jakt_var_968 = [&]() -> ErrorOr<void> { return TRY((((builder).build_all(binary_dir,(([use_ccache, cxx_compiler_path, runtime_path, extra_include_paths, optimize, extra_compiler_flags](DeprecatedString input_filename, DeprecatedString output_filename) -> ErrorOr<JaktInternal::DynamicArray<DeprecatedString>> {
{
...
{
return ((((((input).replace(TRY(DeprecatedString::from_utf8("$"sv)),TRY(DeprecatedString::from_utf8("$$"sv))))).replace(TRY(DeprecatedString::from_utf8("#"sv)),TRY(DeprecatedString::from_utf8("\\#"sv))))).replace(TRY(DeprecatedString::from_utf8(" "sv)),TRY(DeprecatedString::from_utf8("\\ "sv))));
}
}
