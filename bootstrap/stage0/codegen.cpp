...
JaktInternal::DynamicArray<codegen::LineSpan> const empty_array = ((DynamicArray<codegen::LineSpan>::must_create_with({})));
...
{
codegen::CodeGenerator generator = codegen::CodeGenerator(compiler,program,codegen::ControlFlowState(codegen::AllowedControlExits::Nothing(),false,false,static_cast<size_t>(0ULL)),((DynamicArray<JaktInternal::Tuple<ByteString,ByteString>>::must_create_with({}))),(ByteString::must_from_utf8(""sv)),JaktInternal::OptionalNone(),false,codegen::CodegenDebugInfo(compiler,(TRY((Dictionary<size_t, JaktInternal::DynamicArray<codegen::LineSpan>>::create_with_entries({})))),debug_info),((DynamicArray<ByteString>::must_create_with({}))),static_cast<size_t>(0ULL),static_cast<size_t>(0ULL),JaktInternal::OptionalNone(),JaktInternal::OptionalNone());
...
{
JaktInternal::ArrayIterator<bool> _magic = ((((DynamicArray<bool>::must_create_with({true, false})))).iterator());
for (;;){
...
return JaktInternal::ExplicitValue(({ Optional<ByteString> __jakt_var_612; {
...
__jakt_var_612 = ((builder).to_string()); goto __jakt_label_520;

}
__jakt_label_520:; __jakt_var_612.release_value(); }));
}
VERIFY_NOT_REACHED();
}());
    if (_jakt_value.is_return())
...
{
TRY((((dependency_graph).set(((type_).template get<1>()),((*this).extract_dependencies_from(((type_).template get<1>()),dependency_graph,true))))));
}
...
__jakt_var_613 = output; goto __jakt_label_521;
...
__jakt_var_614 = TRY((((result) + ((ByteString::must_from_utf8(";"sv)))))); goto __jakt_label_522;
...
(output,block_str)));
__jakt_var_616 = output; goto __jakt_label_524;
...
{
JaktInternal::DynamicArray<JaktInternal::Tuple<ByteString,ByteString>> common_fields = ((DynamicArray<JaktInternal::Tuple<ByteString,ByteString>>::must_create_with({})));
...
JaktInternal::DynamicArray<JaktInternal::Tuple<ByteString,JaktInternal::DynamicArray<JaktInternal::Tuple<ByteString,ByteString>>>> variant_field_list = ((DynamicArray<JaktInternal::Tuple<ByteString,JaktInternal::DynamicArray<JaktInternal::Tuple<ByteString,ByteString>>>>::must_create_with({})));
{
...
return JaktInternal::ExplicitValue(((DynamicArray<JaktInternal::Tuple<ByteString,ByteString>>::must_create_with({}))));
};/*case end*/
case 3 /* StructLike */: {
...
JaktInternal::DynamicArray<JaktInternal::Tuple<ByteString,ByteString>> fields = ((DynamicArray<JaktInternal::Tuple<ByteString,ByteString>>::must_create_with({})));
{
...
__jakt_var_623 = fields; goto __jakt_label_531;
...
{
JaktInternal::DynamicArray<ids::TypeId> ids = ((DynamicArray<ids::TypeId>::must_create_with({})));
{
...
JaktInternal::DynamicArray<types::CheckedParameter> params = ((DynamicArray<types::CheckedParameter>::must_create_with({types::CheckedParameter(false,var,JaktInternal::OptionalNone())})));
{
...
NonnullRefPtr<typename types::CheckedExpression> const lambda = TRY((types::CheckedExpression::Function(JaktInternal::OptionalNone(),((DynamicArray<types::CheckedCapture>::must_create_with({}))),params,((function)->can_throw),((function)->return_type_id),((function)->block),((expr)->span()),types::unknown_type_id(),((call).function_id),((function)->function_scope_id))));
...
(output,((name).as_name_for_use()))));
if ((!(((generic_parameters).is_empty())))){
JaktInternal::DynamicArray<ByteString> types = ((DynamicArray<ByteString>::must_create_with({})));
{
...
(output,__jakt_format((StringView::from_string_literal("<{}>"sv)),TRY((utility::join(types,(ByteString::must_from_utf8(", "sv)))))))));
}
}
return {};
}
...
ErrorOr<void> codegen::CodeGenerator::codegen_for_enum_variants(types::CheckedEnum const& enum_,Function<ErrorOr<ByteString>(ByteString)> const& stmt_fmt,ByteString const index_expr,ByteStringBuilder& builder) const {
{
...
case 1 /* Typed */: {
{
((((builder))).append(TRY((stmt_fmt(__jakt_format((StringView::from_string_literal("as.{}.value"sv)),variant_name))))));
}
return JaktInternal::ExplicitValue<void>();
};/*case end*/
case 3 /* StructLike */: {
...
((((builder))).append(TRY((stmt_fmt(__jakt_format((StringView::from_string_literal("as.{}.{}"sv)),variant_name,name))))));
}
...
(output,TRY(((((ByteString::must_from_utf8("::"sv))) + (((((call).name_for_codegen())).as_name_for_use()))))))));
}
return JaktInternal::ExplicitValue<void>();
};/*case end*/
...
JaktInternal::DynamicArray<ByteString> arguments = ((DynamicArray<ByteString>::must_create_with({})));
{
JaktInternal::ArrayIterator<JaktInternal::Tuple<ByteString,NonnullRefPtr<typename types::CheckedExpression>>> _magic = ((((call).args)).iterator());
for (;;){
JaktInternal::Optional<JaktInternal::Tuple<ByteString,NonnullRefPtr<typename types::CheckedExpression>>> const _magic_value = ((_magic).next());
...
(output,__jakt_format((StringView::from_string_literal("({})"sv)),TRY((utility::join(arguments,(ByteString::must_from_utf8(","sv)))))))));
}
return JaktInternal::ExplicitValue<void>();
}
return JaktInternal::ExplicitValue<void>();
...
JaktInternal::DynamicArray<ids::ModuleId> stack = ((DynamicArray<ids::ModuleId>::must_create_with({})));
{
JaktInternal::ArrayIterator<NonnullRefPtr<types::Module>> _magic = ((((((*this).program))->modules)).iterator());
for (;;){
JaktInternal::Optional<NonnullRefPtr<types::Module>> const _magic_value = ((_magic).next());
...
JaktInternal::DynamicArray<ids::ModuleId> sorted_modules = ((DynamicArray<ids::ModuleId>::must_create_with({})));
...
(output,TRY((((__jakt_format((StringView::from_string_literal("([&]() -> JaktInternal::ExplicitValueOrControlFlow<{},{}>"sv)),cpp_match_result_type,TRY((((*this).codegen_function_return_type((((*this).current_function).value()))))))) + ((ByteString::must_from_utf8("{\n"sv)))))))));
if (is_generic_enum){
TRY(([](ByteString& self, ByteString rhs) -> ErrorOr<void> {
{
(self = TRY((((self) + (rhs)))));
...
(output,TRY((((((((field_var)->name_for_codegen())).as_name_for_use())) + ((ByteString::must_from_utf8(");\n"sv)))))))));
((i++));
}
...
{
JaktInternal::ArrayIterator<bool> _magic = ((((DynamicArray<bool>::must_create_with({false, true})))).iterator());
for (;;){
JaktInternal::Optional<bool> const _magic_value = ((_magic).next());
if ((!(((_magic_value).has_value())))){
break;
...
{
JaktInternal::DynamicArray<ids::TypeId> dependencies = ((DynamicArray<ids::TypeId>::must_create_with({})));
types::CheckedStruct const struct_ = ((((*this).program))->get_struct(struct_id));
...
default: {
return JaktInternal::ExplicitValue(((DynamicArray<ids::TypeId>::must_create_with({}))));
};/*case end*/
}/*switch end*/
}()
);
...
JaktInternal::DynamicArray<ids::TypeId> const super_dependencies = ((*this).extract_dependencies_from_struct((super_struct_id.value()),dependency_graph,true,((DynamicArray<ids::TypeId>::must_create_with({})))));
...
__jakt_var_626 = __jakt_format((StringView::from_string_literal("(*([]<typename V>(V&& value) {{ if constexpr (IsSpecializationOf<V, NonnullRefPtr>) return &*value; else return &value; }})({}))"sv)),contents); goto __jakt_label_533;
...
JaktInternal::DynamicArray<ByteString> generic_parameter_names = ((DynamicArray<ByteString>::must_create_with({})));
...
(output,(ByteString::must_from_utf8(")})"sv)))));
__jakt_var_634 = output; goto __jakt_label_539;
...
__jakt_var_636 = __jakt_format((StringView::from_string_literal("{}({}::{}(\"{}\"sv))"sv)),error_handler,TRY((((*this).codegen_type(((val).type_id))))),name,escaped_value); goto __jakt_label_541;
...
(output,(ByteString::must_from_utf8(")"sv)))));
__jakt_var_638 = output; goto __jakt_label_543;
...
types::CheckedStruct const struct_ = ((((*this).program))->get_struct(id));
__jakt_var_642 = TRY((((TRY((((*this).codegen_namespace_qualifier(((struct_).scope_id),true,JaktInternal::OptionalNone(),JaktInternal::OptionalNone()))))) + (((((struct_).name_for_codegen())).as_name_for_use()))))); goto __jakt_label_547;
...
__jakt_var_641 = TRY((((TRY(((((ByteString::must_from_utf8("is<"sv))) + (is_type))))) + ((ByteString::must_from_utf8(">("sv)))))); goto __jakt_label_546;
...
__jakt_var_644 = cast_type; goto __jakt_label_549;
...
__jakt_var_643 = TRY((((TRY((((TRY((((cast_type) + ((ByteString::must_from_utf8("<"sv))))))) + (TRY((((*this).codegen_type(final_type_id))))))))) + ((ByteString::must_from_utf8(">("sv)))))); goto __jakt_label_548;
...
__jakt_var_646 = suffix; goto __jakt_label_551;
...
__jakt_var_648 = TRY((((output) + (((((var)->name_for_codegen())).as_name_for_use()))))); goto __jakt_label_553;
...
__jakt_var_649 = __jakt_format((StringView::from_string_literal("({}){}{}.{}"sv)),var_name,cpp_deref_operator,section,arg_name); goto __jakt_label_554;
...
(output,(ByteString::must_from_utf8(">::must_filled("sv)))));
TRY(([](ByteString& self, ByteString rhs) -> ErrorOr<void> {
{
(self = TRY((((self) + (rhs)))));
}
...
(output,(ByteString::must_from_utf8(">::must_create_with({"sv)))));
bool first = true;
{
...
__jakt_var_650 = output; goto __jakt_label_555;
...
ByteString output = __jakt_format((StringView::from_string_literal("({}((Dictionary<{}, {}>::create_with_entries({{"sv)),((*this).current_error_handler()),TRY((((*this).codegen_type(key_type_id)))),TRY((((*this).codegen_type(value_type_id)))));
bool first = true;
{
...
(output,__jakt_format((StringView::from_string_literal("({}((Set<{}>::create_with_values({{"sv)),((*this).current_error_handler()),TRY((((*this).codegen_type(inner_type_id))))))));
bool first = true;
{
JaktInternal::ArrayIterator<NonnullRefPtr<typename types::CheckedExpression>> _magic = ((vals).iterator());
for (;;){
...
JaktInternal::DynamicArray<ByteString> generated_captures = ((DynamicArray<ByteString>::must_create_with({})));
{
...
JaktInternal::DynamicArray<ByteString> generated_params = ((DynamicArray<ByteString>::must_create_with({})));
{
...
__jakt_var_654 = __jakt_format((StringView::from_string_literal("[{}]({}) -> {} {}"sv)),TRY((utility::join(generated_captures,(ByteString::must_from_utf8(", "sv))))),TRY((utility::join(generated_params,(ByteString::must_from_utf8(", "sv))))),return_type,block_output); goto __jakt_label_559;
...
(output,(ByteString::must_from_utf8("}"sv)))));
__jakt_var_657 = output; goto __jakt_label_560;

}
__jakt_label_560:; __jakt_var_657.release_value(); }));
};/*case end*/
case 31 /* Try */: {
...
return __jakt_format((StringView::from_string_literal("{}({}.set({}, {}))"sv)),((*this).current_error_handler()),TRY((((*this).codegen_expression(expr)))),TRY((((*this).codegen_expression(index)))),TRY((((*this).codegen_expression(rhs)))));
}
...
(output,TRY((((__jakt_format((StringView::from_string_literal("case {} /* {} */: "sv)),index,((variant).name()))) + ((ByteString::must_from_utf8("{\n"sv)))))))));
({
    auto&& _jakt_value = ([&]() -> JaktInternal::ExplicitValueOrControlFlow<void, ErrorOr<ByteString>>{
auto&& __jakt_match_variant = variant;
switch(__jakt_match_variant.__jakt_init_index()) {
...
ByteString const name = ((((variable)->name_for_codegen())).as_name_for_use());
((builder).append(TRY((placement_new(__jakt_format((StringView::from_string_literal("common.init_common.{}"sv)),name))))));
}
...
NonnullRefPtr<types::CheckedVariable> const variable = ((((*this).program))->get_variable(((common).variable_id)));
ByteString const name = ((((variable)->name_for_codegen())).as_name_for_use());
((builder).append(TRY((assign(__jakt_format((StringView::from_string_literal("common.init_common.{}"sv)),name))))));
}
...
if (is_constructor){
TRY((((*this).codegen_for_enum_variants(((enum_)),((placement_new)),(ByteString::must_from_utf8("rhs.__jakt_init_index()"sv)),((builder))))));
}
else {
...
TRY((((*this).codegen_for_enum_variants(((enum_)),((assign)),(ByteString::must_from_utf8("rhs.__jakt_init_index()"sv)),((builder))))));
((builder).append((StringView::from_string_literal("}\n"sv))));
}
...
(output,__jakt_format((StringView::from_string_literal("<{}>"sv)),TRY((utility::join(generic_parameter_names,(ByteString::must_from_utf8(", "sv)))))))));
}
TRY(([](ByteString& self, ByteString rhs) -> ErrorOr<void> {
{
(self = TRY((((self) + (rhs)))));
...
(output,TRY((placement_new(__jakt_format((StringView::from_string_literal("{}common.init_common.{}"sv)),deref_uninit,name),name))))));
}
...
(output,TRY((placement_new(__jakt_format((StringView::from_string_literal("{}as.{}.{}"sv)),deref_uninit,variant_name,name),name))))));
}
...
JaktInternal::DynamicArray<ByteString> args = ((DynamicArray<ByteString>::must_create_with({})));
{
JaktInternal::ArrayIterator<ids::TypeId> _magic = ((((((((function)->generics))->specializations))[(((function)->specialization_index).value())])).iterator());
for (;;){
JaktInternal::Optional<ids::TypeId> const _magic_value = ((_magic).next());
...
case 24 /* Struct */: {
auto&& __jakt_match_value = __jakt_match_variant.as.Struct;ids::StructId const& id = __jakt_match_value.value;
return JaktInternal::ExplicitValue(((*this).extract_dependencies_from_struct(id,dependency_graph,top_level,((DynamicArray<ids::TypeId>::must_create_with({}))))));
};/*case end*/
case 20 /* GenericInstance */: {
auto&& __jakt_match_value = __jakt_match_variant.as.GenericInstance;ids::StructId const& id = __jakt_match_value.id;
JaktInternal::DynamicArray<ids::TypeId> const& args = __jakt_match_value.args;
...
{
JaktInternal::DynamicArray<ids::TypeId> const traversal = ((DynamicArray<ids::TypeId>::must_create_with({})));
...
(output,(ByteString::must_from_utf8(": "sv)))));
JaktInternal::DynamicArray<ByteString> initializers = ((DynamicArray<ByteString>::must_create_with({})));
...
JaktInternal::DynamicArray<ByteString> strings = ((DynamicArray<ByteString>::must_create_with({})));
{
...
types::CheckedParameter param = (_magic_value.value());
{
((strings).push(TRY((((TRY(((((ByteString::must_from_utf8("move(a_"sv))) + (((((((param).variable))->name_for_codegen())).as_name_for_use())))))) + ((ByteString::must_from_utf8(")"sv))))))));
}
...
((initializers).push(TRY((((TRY((((TRY((((((((((param).variable))->name_for_codegen())).as_name_for_use())) + ((ByteString::must_from_utf8("(move(a_"sv))))))) + (((((((param).variable))->name_for_codegen())).as_name_for_use())))))) + ((ByteString::must_from_utf8("))"sv))))))));
}
...
(output,(ByteString::must_from_utf8(")>"sv)))));
__jakt_var_668 = output; goto __jakt_label_564;
...
__jakt_var_669 = (ByteString::must_from_utf8("auto"sv)); goto __jakt_label_565;
