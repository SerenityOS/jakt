...
__jakt_var_393 = TRY((String::formatted(String("(*([]<typename V>(V const& value) {{ if constexpr (IsSpecializationOf<V, NonnullRefPtr>) return &*value; else return &value; }})({}))"),contents))); goto __jakt_label_364;
...
__jakt_var_398 = output; goto __jakt_label_365;
...
__jakt_var_399 = JAKT_RESOLVE_EXPLICIT_VALUE_OR_CONTROL_FLOW_RETURN_ONLY(([&]() -> JaktInternal::ExplicitValueOrControlFlow<String,ErrorOr<String>>{
...
(add_newline = false);
__jakt_var_401 = output; goto __jakt_label_368;
...
(add_newline = false);
__jakt_var_405 = output; goto __jakt_label_372;
...
(output += end_label);
(output += String(";\n"));
__jakt_var_406 = output; goto __jakt_label_373;
...
__jakt_var_407 = String(""); goto __jakt_label_374;
...
return JaktInternal::ExplicitValue(({ Optional<JaktInternal::Array<JaktInternal::Tuple<String,String>>> __jakt_var_408; {
if (is_generic){
(output += ((String("template<") + template_args) + String(">\n")));
}
(output += ((String("struct ") + name) + String(" {\n")));
__jakt_var_408 = common_fields; goto __jakt_label_375;
...
return JaktInternal::ExplicitValue(({ Optional<JaktInternal::Array<JaktInternal::Tuple<String,String>>> __jakt_var_409; {
...
(output += ((String("struct ") + name) + String(" {\n")));
__jakt_var_409 = fields; goto __jakt_label_376;
...
return JaktInternal::ExplicitValue(({ Optional<JaktInternal::Array<JaktInternal::Tuple<String,String>>> __jakt_var_410; {
JaktInternal::Array<JaktInternal::Tuple<String,String>> fields = (TRY((Array<JaktInternal::Tuple<String,String>>::create_with({}))));
{
...
(output += ((String("struct ") + name) + String("{\n")));
__jakt_var_410 = fields; goto __jakt_label_377;

}
__jakt_label_377:; __jakt_var_410.release_value(); }));
};/*case end*/
default: {
return JaktInternal::ExplicitValue(({ Optional<JaktInternal::Array<JaktInternal::Tuple<String,String>>> __jakt_var_411; {
utility::todo(TRY((String::formatted(String("codegen enum variant: {}"),variant))));
__jakt_var_411 = (TRY((Array<JaktInternal::Tuple<String,String>>::create_with({})))); goto __jakt_label_378;
...
(output += String(")})"));
__jakt_var_413 = output; goto __jakt_label_379;
...
__jakt_var_414 = ((String("String(\"") + escaped_value) + String("\")")); goto __jakt_label_380;
...
(output += String(")"));
__jakt_var_415 = output; goto __jakt_label_381;
...
(output += String(")"));
__jakt_var_416 = output; goto __jakt_label_382;
...
NonnullRefPtr<types::Module> const type_module = ((((*this).program))->get_module(((id).module)));
__jakt_var_419 = ((((((*this).program))->get_struct(id))).name); goto __jakt_label_385;
...
__jakt_var_418 = ((String("is<") + is_type) + String(">(")); goto __jakt_label_384;
...
__jakt_var_421 = cast_type; goto __jakt_label_387;
...
__jakt_var_422 = cast_type; goto __jakt_label_388;
...
__jakt_var_420 = (((cast_type + String("<")) + TRY((((*this).codegen_type(final_type_id))))) + String(">(")); goto __jakt_label_386;
...
__jakt_var_423 = suffix; goto __jakt_label_389;
...
(output += String(")"));
__jakt_var_417 = output; goto __jakt_label_383;
...
__jakt_var_424 = JAKT_RESOLVE_EXPLICIT_VALUE_OR_CONTROL_FLOW_RETURN_ONLY(([&]() -> JaktInternal::ExplicitValueOrControlFlow<String, ErrorOr<String>>{
auto&& __jakt_match_variant = val;
switch(__jakt_match_variant.index()) {
case 9: {
...
__jakt_var_425 = (output + ((var).name)); goto __jakt_label_391;
...
;
__jakt_var_426 = TRY((String::formatted(String("(({}){}get<{}::{}>()).{}"),var_name,cpp_deref_operator,enum_type,variant_name,arg_name))); goto __jakt_label_392;
...
__jakt_var_427 = output; goto __jakt_label_393;
...
(output += String("}))))"));
__jakt_var_428 = output; goto __jakt_label_394;
...
(output += String("}))))"));
__jakt_var_429 = output; goto __jakt_label_395;
...
(output += String("})"));
__jakt_var_430 = output; goto __jakt_label_396;
...
__jakt_var_431 = TRY((String::formatted(String("[{}]({}) -> {} {}"),utility::join(generated_captures,String(", ")),utility::join(generated_params,String(", ")),return_type,block_output))); goto __jakt_label_397;

}
__jakt_label_397:; __jakt_var_431.release_value(); }));
};/*case end*/
case 29: {
...
(((*this).control_flow_state) = last_control_flow);
(output += String("}"));
__jakt_var_433 = output; goto __jakt_label_398;
...
__jakt_var_434 = output; goto __jakt_label_399;
...
__jakt_var_436 = String(""); goto __jakt_label_400;

}
__jakt_label_400:; __jakt_var_436.release_value(); }));
};/*case end*/
default: VERIFY_NOT_REACHED();}/*switch end*/
}()
)));
...
__jakt_var_438 = String(""); goto __jakt_label_401;

}
__jakt_label_401:; __jakt_var_438.release_value(); }));
};/*case end*/
}/*switch end*/
}()
)));
...
(output += String(")>"));
__jakt_var_440 = output; goto __jakt_label_402;
...
__jakt_var_441 = String("auto"); goto __jakt_label_403;
