...
__jakt_var_625 = fields; goto __jakt_label_526;
...
__jakt_var_626 = fields; goto __jakt_label_527;
...
__jakt_label_532:; __jakt_var_631.release_value(); }));
};/*case end*/
default: {
...
types::CheckedStruct const struct_ = ((((*this).program))->get_struct(id));
__jakt_var_634 = ((TRY((((*this).codegen_namespace_qualifier(((struct_).scope_id),true,JaktInternal::OptionalNone(),JaktInternal::OptionalNone()))))) + (((((struct_).name_for_codegen())).as_name_for_use()))); goto __jakt_label_534;
...
__jakt_var_633 = (((((ByteString::from_utf8_without_validation("is<"sv))) + (is_type))) + ((ByteString::from_utf8_without_validation(">("sv)))); goto __jakt_label_533;
...
__jakt_var_636 = cast_type; goto __jakt_label_536;
...
__jakt_var_637 = cast_type; goto __jakt_label_537;
...
__jakt_var_635 = ((((((cast_type) + ((ByteString::from_utf8_without_validation("<"sv))))) + (TRY((((*this).codegen_type(final_type_id))))))) + ((ByteString::from_utf8_without_validation(">("sv)))); goto __jakt_label_535;
...
__jakt_var_644 = ((builder).to_string()); goto __jakt_label_540;
...
((builder).append((StringView::from_string_literal(")>"sv))));
__jakt_var_645 = ((builder).to_string()); goto __jakt_label_541;
...
__jakt_var_646 = (ByteString::from_utf8_without_validation("auto"sv)); goto __jakt_label_542;
...
__jakt_var_648 = ((builder).to_string()); goto __jakt_label_543;

}
__jakt_label_543:; __jakt_var_648.release_value(); }));
}
VERIFY_NOT_REACHED();
}());
    if (_jakt_value.is_return())
