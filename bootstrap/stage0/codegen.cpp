...
__jakt_var_399 = TRY((String::formatted(String("(*([]<typename V>(V const& value) {{ if constexpr (IsSpecializationOf<V, NonnullRefPtr>) return &*value; else return &value; }})({}))"),contents))); goto __jakt_label_364;
...
__jakt_var_404 = output; goto __jakt_label_365;

}
__jakt_label_365:; __jakt_var_404.release_value(); }));
};/*case end*/
case 8: {
...
__jakt_var_405 = JAKT_RESOLVE_EXPLICIT_VALUE_OR_CONTROL_FLOW_RETURN_ONLY(([&]() -> JaktInternal::ExplicitValueOrControlFlow<String,ErrorOr<String>>{
...
__jakt_label_366:; __jakt_var_405.release_value(); }));
}
}()))
);
};/*case end*/
...
(((*this).control_flow_state) = last_control_flow);
(output += block_str);
__jakt_var_406 = output; goto __jakt_label_367;

}
__jakt_label_367:; __jakt_var_406.release_value(); }));
};/*case end*/
case 7: {
...
(add_newline = false);
__jakt_var_407 = output; goto __jakt_label_368;

}
__jakt_label_368:; __jakt_var_407.release_value(); }));
};/*case end*/
case 5: {
...
__jakt_var_408 = output; goto __jakt_label_369;

}
__jakt_label_369:; __jakt_var_408.release_value(); }));
};/*case end*/
case 3: {
...
(output += String(";"));
__jakt_var_409 = output; goto __jakt_label_370;

}
__jakt_label_370:; __jakt_var_409.release_value(); }));
};/*case end*/
case 13: {
...
__jakt_var_410 = output; goto __jakt_label_371;

}
__jakt_label_371:; __jakt_var_410.release_value(); }));
};/*case end*/
case 4: {
...
(output += end_label);
(output += String(";\n"));
__jakt_var_412 = output; goto __jakt_label_373;
...
__jakt_var_413 = String(""); goto __jakt_label_374;
...
return JaktInternal::ExplicitValue(({ Optional<JaktInternal::Array<JaktInternal::Tuple<String,String>>> __jakt_var_414; {
if (is_generic){
(output += ((String("template<") + template_args) + String(">\n")));
}
(output += ((String("struct ") + name) + String(" {\n")));
__jakt_var_414 = common_fields; goto __jakt_label_375;
...
return JaktInternal::ExplicitValue(({ Optional<JaktInternal::Array<JaktInternal::Tuple<String,String>>> __jakt_var_415; {
...
(output += ((String("struct ") + name) + String(" {\n")));
__jakt_var_415 = fields; goto __jakt_label_376;
...
return JaktInternal::ExplicitValue(({ Optional<JaktInternal::Array<JaktInternal::Tuple<String,String>>> __jakt_var_416; {
JaktInternal::Array<JaktInternal::Tuple<String,String>> fields = (TRY((Array<JaktInternal::Tuple<String,String>>::create_with({}))));
{
...
(output += ((String("struct ") + name) + String("{\n")));
__jakt_var_416 = fields; goto __jakt_label_377;

}
__jakt_label_377:; __jakt_var_416.release_value(); }));
};/*case end*/
default: {
return JaktInternal::ExplicitValue(({ Optional<JaktInternal::Array<JaktInternal::Tuple<String,String>>> __jakt_var_417; {
utility::todo(TRY((String::formatted(String("codegen enum variant: {}"),variant))));
__jakt_var_417 = (TRY((Array<JaktInternal::Tuple<String,String>>::create_with({})))); goto __jakt_label_378;
...
(output += String(")})"));
__jakt_var_419 = output; goto __jakt_label_379;

}
__jakt_label_379:; __jakt_var_419.release_value(); }));
};/*case end*/
case 23: {
...
__jakt_var_420 = ((String("String(\"") + escaped_value) + String("\")")); goto __jakt_label_380;

}
__jakt_label_380:; __jakt_var_420.release_value(); }));
};/*case end*/
case 3: {
...
(output += String(")"));
__jakt_var_421 = output; goto __jakt_label_381;

}
__jakt_label_381:; __jakt_var_421.release_value(); }));
};/*case end*/
case 16: {
...
String const& index = __jakt_match_value.index;
bool const& is_optional = __jakt_match_value.is_optional;
return JaktInternal::ExplicitValue(({ Optional<String> __jakt_var_422; {
String output = String("");
String const object = TRY((((*this).codegen_expression(expr))));
(output += String("(("));
(output += object);
...
(output += String(")"));
__jakt_var_422 = output; goto __jakt_label_382;

}
__jakt_label_382:; __jakt_var_422.release_value(); }));
};/*case end*/
case 26: {
...
return JaktInternal::ExplicitValue((((String("const_cast<") + TRY((((*this).codegen_type(type_id))))) + String(">(")) + String("&")));
};/*case end*/
case 9: {
...
return JaktInternal::ExplicitValue(({ Optional<String> __jakt_var_424; {
...
NonnullRefPtr<types::Module> const type_module = ((((*this).program))->get_module(((id).module)));
__jakt_var_425 = ((((((*this).program))->get_struct(id))).name); goto __jakt_label_385;

}
__jakt_label_385:; __jakt_var_425.release_value(); }));
};/*case end*/
default: {
...
__jakt_var_424 = ((String("is<") + is_type) + String(">(")); goto __jakt_label_384;

}
__jakt_label_384:; __jakt_var_424.release_value(); }));
};/*case end*/
case 11: {
...
__jakt_var_427 = cast_type; goto __jakt_label_387;
...
__jakt_var_428 = cast_type; goto __jakt_label_388;
...
__jakt_var_426 = (((cast_type + String("<")) + TRY((((*this).codegen_type(final_type_id))))) + String(">(")); goto __jakt_label_386;
...
__jakt_var_429 = suffix; goto __jakt_label_389;
...
(output += String(")"));
__jakt_var_423 = output; goto __jakt_label_383;

}
__jakt_label_383:; __jakt_var_423.release_value(); }));
};/*case end*/
case 6: {
...
__jakt_var_430 = JAKT_RESOLVE_EXPLICIT_VALUE_OR_CONTROL_FLOW_RETURN_ONLY(([&]() -> JaktInternal::ExplicitValueOrControlFlow<String, ErrorOr<String>>{
auto&& __jakt_match_variant = val;
switch(__jakt_match_variant.index()) {
case 9: {
...
__jakt_var_431 = (output + ((var).name)); goto __jakt_label_391;
...
;
__jakt_var_432 = TRY((String::formatted(String("(({}){}get<{}::{}>()).{}"),var_name,cpp_deref_operator,enum_type,variant_name,arg_name))); goto __jakt_label_392;
...
__jakt_var_433 = output; goto __jakt_label_393;
...
(output += String("}))))"));
__jakt_var_434 = output; goto __jakt_label_394;
...
(output += String("}))))"));
__jakt_var_435 = output; goto __jakt_label_395;
...
(output += String("})"));
__jakt_var_436 = output; goto __jakt_label_396;
...
__jakt_var_437 = TRY((String::formatted(String("[{}]({}) -> {} {}"),utility::join(generated_captures,String(", ")),utility::join(generated_params,String(", ")),return_type,block_output))); goto __jakt_label_397;
...
(((*this).control_flow_state) = last_control_flow);
(output += String("}"));
__jakt_var_439 = output; goto __jakt_label_398;
...
__jakt_var_440 = output; goto __jakt_label_399;

}
__jakt_label_399:; __jakt_var_440.release_value(); }));
};/*case end*/
case 30: {
...
utility::todo(TRY((String::formatted(String("codegen_expression of bad AST node in {} at {}..{}"),TRY((((((*this).compiler))->get_file_path(((span).file_id))))),((span).start),((span).end)))));
__jakt_var_442 = String(""); goto __jakt_label_400;

}
__jakt_label_400:; __jakt_var_442.release_value(); }));
};/*case end*/
default: VERIFY_NOT_REACHED();}/*switch end*/
}()
)));
...
__jakt_var_444 = String(""); goto __jakt_label_401;

}
__jakt_label_401:; __jakt_var_444.release_value(); }));
};/*case end*/
}/*switch end*/
}()
)));
...
bool const& can_throw = __jakt_match_value.can_throw;
types::TypeId const& return_type_id = __jakt_match_value.return_type_id;
return JaktInternal::ExplicitValue(({ Optional<String> __jakt_var_446; {
...
(output += String(")>"));
__jakt_var_446 = output; goto __jakt_label_402;

}
__jakt_label_402:; __jakt_var_446.release_value(); }));
};/*case end*/
case 21: {
...
__jakt_var_447 = String("auto"); goto __jakt_label_403;

}
__jakt_label_403:; __jakt_var_447.release_value(); }));
};/*case end*/
}/*switch end*/
}()
)));
