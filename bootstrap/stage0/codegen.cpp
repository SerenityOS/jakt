...
__jakt_var_630 = __jakt_format((StringView::from_string_literal("if (_jakt_value.is_loop_break())\n        {};\n    if (_jakt_value.is_loop_continue())\n        {};\n    "sv)),break_stmt,continue_stmt); goto __jakt_label_532;

}
__jakt_label_532:; __jakt_var_630.release_value(); }));
}
VERIFY_NOT_REACHED();
}());
    if (_jakt_value.is_return())
...
ids::ScopeId const scope_id = ids::ScopeId(((module)->id),main_id);
NonnullRefPtr<types::Scope> const scope = ((((generator).program))->get_scope(scope_id));
...
return JaktInternal::ExplicitValue(({ Optional<JaktInternal::DynamicArray<JaktInternal::Tuple<ByteString,ByteString>>> __jakt_var_639; {
...
__jakt_var_639 = fields; goto __jakt_label_533;
...
return JaktInternal::ExplicitValue(({ Optional<JaktInternal::DynamicArray<JaktInternal::Tuple<ByteString,ByteString>>> __jakt_var_640; {
JaktInternal::DynamicArray<JaktInternal::Tuple<ByteString,ByteString>> fields = DynamicArray<JaktInternal::Tuple<ByteString,ByteString>>::create_with({});
((fields).push((Tuple{(ByteString::from_utf8_without_validation("value"sv)), TRY((((*this).codegen_type(type_id))))})));
__jakt_var_640 = fields; goto __jakt_label_534;
...
return JaktInternal::ExplicitValue(({ Optional<JaktInternal::Optional<ByteString>> __jakt_var_644; {
...
__jakt_label_538:; __jakt_var_644.release_value(); }));
};/*case end*/
case 21 /* GenericEnumInstance */: {
auto&& __jakt_match_value = __jakt_match_variant.as.GenericEnumInstance;ids::EnumId const& id = __jakt_match_value.id;
return JaktInternal::ExplicitValue(({ Optional<JaktInternal::Optional<ByteString>> __jakt_var_645; {
types::CheckedEnum const enum_ = ((((*this).program))->get_enum(id));
__jakt_var_645 = ({
    auto&& _jakt_value = ([&]() -> JaktInternal::ExplicitValueOrControlFlow<JaktInternal::Optional<ByteString>,JaktInternal::Optional<ByteString>> {
auto __jakt_enum_value = (((enum_).is_boxed));
...
__jakt_label_539:; __jakt_var_645.release_value(); }));
};/*case end*/
default: {
...
types::CheckedStruct const struct_ = ((((*this).program))->get_struct(id));
__jakt_var_648 = ((TRY((((*this).codegen_namespace_qualifier(((struct_).scope_id),true,JaktInternal::OptionalNone(),JaktInternal::OptionalNone()))))) + (((((struct_).name_for_codegen())).as_name_for_use()))); goto __jakt_label_541;
...
__jakt_var_647 = (((((ByteString::from_utf8_without_validation("is<"sv))) + (is_type))) + ((ByteString::from_utf8_without_validation(">("sv)))); goto __jakt_label_540;
...
__jakt_var_650 = cast_type; goto __jakt_label_543;
...
__jakt_var_651 = cast_type; goto __jakt_label_544;
...
__jakt_var_649 = ((((((cast_type) + ((ByteString::from_utf8_without_validation("<"sv))))) + (TRY((((*this).codegen_type(final_type_id))))))) + ((ByteString::from_utf8_without_validation(">("sv)))); goto __jakt_label_542;
...
__jakt_var_658 = ((builder).to_string()); goto __jakt_label_547;
...
((builder).append((StringView::from_string_literal(")>"sv))));
__jakt_var_659 = ((builder).to_string()); goto __jakt_label_548;

}
__jakt_label_548:; __jakt_var_659.release_value(); }));
};/*case end*/
...
__jakt_var_660 = (ByteString::from_utf8_without_validation("auto"sv)); goto __jakt_label_549;

}
__jakt_label_549:; __jakt_var_660.release_value(); }));
};/*case end*/
}/*switch end*/
}()
);
...
__jakt_var_662 = ((builder).to_string()); goto __jakt_label_550;

}
__jakt_label_550:; __jakt_var_662.release_value(); }));
}
VERIFY_NOT_REACHED();
}());
    if (_jakt_value.is_return())
