...
return JaktInternal::ExplicitValue<size_t>(TRY((interpreter::size_of_impl(type_id,interpreter))));
}
VERIFY_NOT_REACHED();
};/*case end*/
case 2 /* WithValue */: {
...
return JaktInternal::ExplicitValue<NonnullRefPtr<typename types::CheckedExpression>>(types::CheckedExpression::OptionalSome(JaktInternal::OptionalNone(),expr,((this_value).span),type_id));
}
VERIFY_NOT_REACHED();
};/*case end*/
case 26 /* JaktTuple */: {
...
return JaktInternal::ExplicitValue<NonnullRefPtr<typename types::CheckedExpression>>(types::CheckedExpression::JaktTuple(JaktInternal::OptionalNone(),vals,((this_value).span),type_id));
}
VERIFY_NOT_REACHED();
};/*case end*/
case 17 /* Struct */: {
...
return JaktInternal::ExplicitValue<NonnullRefPtr<typename types::CheckedExpression>>(types::CheckedExpression::Call(JaktInternal::OptionalNone(),call,((this_value).span),((struct_).type_id)));
}
VERIFY_NOT_REACHED();
};/*case end*/
case 18 /* Class */: {
...
return JaktInternal::ExplicitValue<NonnullRefPtr<typename types::CheckedExpression>>(types::CheckedExpression::Call(JaktInternal::OptionalNone(),call,((this_value).span),((enum_).type_id)));
}
VERIFY_NOT_REACHED();
};/*case end*/
case 20 /* JaktArray */: {
...
return JaktInternal::ExplicitValue<NonnullRefPtr<typename types::CheckedExpression>>(types::CheckedExpression::JaktArray(JaktInternal::OptionalNone(),vals,JaktInternal::OptionalNone(),((this_value).span),type_id,inner_type_id));
}
VERIFY_NOT_REACHED();
};/*case end*/
...
return JaktInternal::ExplicitValue<NonnullRefPtr<typename types::CheckedExpression>>(types::CheckedExpression::JaktDictionary(JaktInternal::OptionalNone(),vals,((this_value).span),type_id,key_type_id,value_type_id));
}
VERIFY_NOT_REACHED();
};/*case end*/
case 22 /* JaktSet */: {
...
return JaktInternal::ExplicitValue<NonnullRefPtr<typename types::CheckedExpression>>(types::CheckedExpression::JaktSet(JaktInternal::OptionalNone(),vals,((this_value).span),type_id,value_type_id));
}
VERIFY_NOT_REACHED();
};/*case end*/
case 27 /* Function */: {
...
return JaktInternal::ExplicitValue<NonnullRefPtr<typename types::CheckedExpression>>(types::CheckedExpression::Function(JaktInternal::OptionalNone(),DynamicArray<types::CheckedCapture>::create_with({}),checked_params,can_throw,return_type_id,new_block,((this_value).span),type_id,pseudo_function_id,scope_id));
}
VERIFY_NOT_REACHED();
};/*case end*/
default: {
...
return JaktInternal::ExplicitValue<NonnullRefPtr<typename types::CheckedStatement>>(types::CheckedStatement::If(new_condition,new_then_block,new_else_statement,span));
}
VERIFY_NOT_REACHED();
};/*case end*/
case 5 /* Block */: {
...
return JaktInternal::ExplicitValue<NonnullRefPtr<typename types::CheckedStatement>>(types::CheckedStatement::Block(new_block,span));
}
VERIFY_NOT_REACHED();
};/*case end*/
case 6 /* Loop */: {
...
types::CheckedBlock const new_block = types::CheckedBlock(statements,((block).scope_id),((block).control_flow),((block).yielded_type),((block).yielded_none));
return JaktInternal::ExplicitValue<NonnullRefPtr<typename types::CheckedStatement>>(types::CheckedStatement::Loop(new_block,span));
}
VERIFY_NOT_REACHED();
};/*case end*/
case 7 /* While */: {
...
types::CheckedBlock const new_block = types::CheckedBlock(statements,((block).scope_id),((block).control_flow),((block).yielded_type),((block).yielded_none));
return JaktInternal::ExplicitValue<NonnullRefPtr<typename types::CheckedStatement>>(types::CheckedStatement::While(new_condition,new_block,span));
}
VERIFY_NOT_REACHED();
};/*case end*/
case 8 /* Return */: {
...
{
return ((interpreter::Interpreter::invoke_typecheck_block(((((((*this).typecheck_functions))->block))),block,scope,function_id)));
}
}
...
{
return ((function(block,parent_scope_id,types::SafetyMode::Safe(),JaktInternal::OptionalNone(),function_id)));
}
}
...
return JaktInternal::ExplicitValue<NonnullRefPtr<typename types::CheckedExpression>>(types::CheckedExpression::MethodCall(JaktInternal::OptionalNone(),TRY((((*this).perform_final_interpretation_expr_pass(expr,scope,function_id)))),types::CheckedCall(((call).namespace_),((call).name),new_args,((call).type_args),((call).function_id),((call).return_type),((call).callee_throws),JaktInternal::OptionalNone(),parser::InlineState::Default()),span,is_optional,type_id));
}
VERIFY_NOT_REACHED();
};/*case end*/
default: {
...
return JaktInternal::ExplicitValue<interpreter::StatementResult>(interpreter::StatementResult::JustValue(types::Value(types::ValueImpl::JaktString(TRY((types::comptime_format_impl(format_string,((arguments)[(JaktInternal::Range<i64>{static_cast<i64>(static_cast<i64>(1LL)),static_cast<i64>(9223372036854775807LL)})]),((((*this).program))))))),call_span)));
}
VERIFY_NOT_REACHED();
}
...
return JaktInternal::ExplicitValue<interpreter::StatementResult>(interpreter::StatementResult::JustValue(types::Value(types::ValueImpl::Void(),call_span)));
}
VERIFY_NOT_REACHED();
}
else if (__jakt_enum_value == "eprintln"sv) {
...
return JaktInternal::ExplicitValue<interpreter::StatementResult>(interpreter::StatementResult::JustValue(TRY((interpreter::cast_value_to_type(((arguments)[static_cast<i64>(0LL)]),(output_type_id.value()),*this,true)))));
}
VERIFY_NOT_REACHED();
}
...
return JaktInternal::ExplicitValue<interpreter::StatementResult>(interpreter::StatementResult::JustValue(types::Value(({
...
return JaktInternal::ExplicitValue<interpreter::StatementResult>(interpreter::StatementResult::JustValue(types::Value(impl,call_span)));
}
VERIFY_NOT_REACHED();
}
...
return JaktInternal::ExplicitValue<interpreter::StatementResult>(interpreter::StatementResult::JustValue(types::Value(types::ValueImpl::JaktSet(DynamicArray<types::Value>::create_with({}),type_id),call_span)));
}
VERIFY_NOT_REACHED();
}
...
return JaktInternal::ExplicitValue<interpreter::StatementResult>(interpreter::StatementResult::JustValue(types::Value(types::ValueImpl::JaktDictionary(DynamicArray<types::Value>::create_with({}),DynamicArray<types::Value>::create_with({}),type_id),call_span)));
}
VERIFY_NOT_REACHED();
}
else if (__jakt_enum_value == "from_string_literal"sv) {
{
return JaktInternal::ExplicitValue<interpreter::StatementResult>(interpreter::StatementResult::JustValue(((arguments)[static_cast<i64>(0LL)])));
}
VERIFY_NOT_REACHED();
}
else {
...
return JaktInternal::ExplicitValue<interpreter::StatementResult>(interpreter::StatementResult::JustValue(types::Value(types::ValueImpl::Struct(DynamicArray<types::Value>::create_with({err}),error_struct_id,(((constructors.value()))[static_cast<i64>(0LL)])),call_span)));
}
VERIFY_NOT_REACHED();
}
else if (__jakt_enum_value == "from_string_literal"sv) {
...
return JaktInternal::ExplicitValue<interpreter::StatementResult>(interpreter::StatementResult::JustValue(types::Value(types::ValueImpl::Struct(DynamicArray<types::Value>::create_with({path_value}),file_struct_id,(((constructors.value()))[static_cast<i64>(0LL)])),call_span)));
}
VERIFY_NOT_REACHED();
}
...
return JaktInternal::ExplicitValue<interpreter::StatementResult>(interpreter::StatementResult::JustValue(types::Value(types::ValueImpl::Struct(DynamicArray<types::Value>::create_with({path_value}),file_struct_id,(((constructor.value()))[static_cast<i64>(0LL)])),call_span)));
}
VERIFY_NOT_REACHED();
}
...
return JaktInternal::ExplicitValue<interpreter::StatementResult>(interpreter::StatementResult::JustValue(types::Value(types::ValueImpl::JaktArray(result_values,((*this).find_or_add_type_id(types::Type::GenericInstance(parser::CheckedQualifiers(false),array_struct_id,DynamicArray<ids::TypeId>::create_with({types::builtin(types::BuiltinType::U8())}))))),call_span)));
}
VERIFY_NOT_REACHED();
}
...
return JaktInternal::ExplicitValue<interpreter::StatementResult>(interpreter::StatementResult::JustValue(types::Value(types::ValueImpl::USize(bytes_read),call_span)));
}
VERIFY_NOT_REACHED();
}
...
jakt__path::Path const path = (((((((((((*this).program))->compiler))->get_file_path(((call_span).file_id))).value())).parent())).join(requested_path));
return JaktInternal::ExplicitValue<interpreter::StatementResult>(interpreter::StatementResult::JustValue(types::Value(types::ValueImpl::Bool(((path).exists())),call_span)));
}
VERIFY_NOT_REACHED();
}
...
return JaktInternal::ExplicitValue<interpreter::StatementResult>(interpreter::StatementResult::JustValue(types::Value(types::ValueImpl::USize(bytes_written),call_span)));
}
VERIFY_NOT_REACHED();
}
else {
...
return JaktInternal::ExplicitValue<interpreter::StatementResult>(interpreter::StatementResult::JustValue(types::Value(types::ValueImpl::Struct(DynamicArray<types::Value>::create_with({types::Value(types::ValueImpl::JaktString((ByteString::from_utf8_without_validation(""sv))),call_span)}),string_builder_struct_id,JaktInternal::OptionalNone()),call_span)));
}
VERIFY_NOT_REACHED();
}
...
return JaktInternal::ExplicitValue<interpreter::StatementResult>(interpreter::StatementResult::JustValue(({
...
return JaktInternal::ExplicitValue<interpreter::StatementResult>(interpreter::StatementResult::JustValue(types::Value(types::ValueImpl::Bool(found),call_span)));
}
VERIFY_NOT_REACHED();
};/*case end*/
default: {
...
return JaktInternal::ExplicitValue<interpreter::StatementResult>(interpreter::StatementResult::JustValue(types::Value(types::ValueImpl::Bool(((found_index).has_value())),call_span)));
}
VERIFY_NOT_REACHED();
};/*case end*/
default: {
...
return JaktInternal::ExplicitValue<interpreter::StatementResult>(({
    auto&& _jakt_value = ([&]() -> JaktInternal::ExplicitValueOrControlFlow<interpreter::StatementResult,ErrorOr<interpreter::StatementResult>> {
...
return JaktInternal::ExplicitValue<interpreter::StatementResult>(interpreter::StatementResult::JustValue(types::Value(types::ValueImpl::JaktArray(keys,type_id),call_span)));
}
VERIFY_NOT_REACHED();
}
else {
...
return JaktInternal::ExplicitValue<interpreter::StatementResult>(interpreter::StatementResult::JustValue(types::Value(types::ValueImpl::Struct(DynamicArray<types::Value>::create_with({(this_argument.value()), types::Value(types::ValueImpl::USize(static_cast<size_t>(0ULL)),call_span)}),struct_id,JaktInternal::OptionalNone()),call_span)));
}
VERIFY_NOT_REACHED();
};/*case end*/
default: {
...
auto&& __jakt_match_value = __jakt_match_variant.as.JaktArray;JaktInternal::DynamicArray<types::Value> const& values = __jakt_match_value.values;
{
return JaktInternal::ExplicitValue<interpreter::StatementResult>(interpreter::StatementResult::JustValue(types::Value(types::ValueImpl::USize(((values).size())),call_span)));
}
VERIFY_NOT_REACHED();
};/*case end*/
default: {
...
auto&& __jakt_match_value = __jakt_match_variant.as.JaktArray;JaktInternal::DynamicArray<types::Value> const& values = __jakt_match_value.values;
{
return JaktInternal::ExplicitValue<interpreter::StatementResult>(interpreter::StatementResult::JustValue(types::Value(types::ValueImpl::USize(((values).capacity())),call_span)));
}
VERIFY_NOT_REACHED();
};/*case end*/
default: {
...
return JaktInternal::ExplicitValue<types::Value>(types::Value(types::ValueImpl::OptionalSome(((values)[index])),call_span));
}
VERIFY_NOT_REACHED();
}
else {
...
return JaktInternal::ExplicitValue<interpreter::StatementResult>(interpreter::StatementResult::JustValue(types::Value(types::ValueImpl::OptionalSome(types::Value(types::ValueImpl::U64(start),call_span)),call_span)));
}
VERIFY_NOT_REACHED();
}
...
return JaktInternal::ExplicitValue<interpreter::StatementResult>(interpreter::StatementResult::JustValue(types::Value(types::ValueImpl::Struct(fields,struct_id,constructor),(((this_argument.value())).span))));
}
VERIFY_NOT_REACHED();
};/*case end*/
default: {
...
return JaktInternal::ExplicitValue<interpreter::StatementResult>(interpreter::StatementResult::JustValue(types::Value(types::ValueImpl::JaktString(result),call_span)));
}
VERIFY_NOT_REACHED();
};/*case end*/
case 5 /* U64 */: {
...
ids::StructId const array_struct_id = TRY((((((*this).program))->find_struct_in_prelude((ByteString::from_utf8_without_validation("Array"sv))))));
return JaktInternal::ExplicitValue<interpreter::StatementResult>(interpreter::StatementResult::JustValue(types::Value(types::ValueImpl::JaktArray(result,((*this).find_or_add_type_id(types::Type::GenericInstance(parser::CheckedQualifiers(false),array_struct_id,DynamicArray<ids::TypeId>::create_with({TRY((((*this).string_type())))}))))),call_span)));
}
VERIFY_NOT_REACHED();
};/*case end*/
default: {
...
return JaktInternal::ExplicitValue<interpreter::StatementResult>(interpreter::StatementResult::JustValue(types::Value(types::ValueImpl::JaktString(ByteString::repeated(character,count)),call_span)));
}
VERIFY_NOT_REACHED();
}
else {
...
return JaktInternal::ExplicitValue<types::Value>(types::Value(types::ValueImpl::OptionalSome(types::Value(types::ValueImpl::JaktTuple(DynamicArray<types::Value>::create_with({((keys)[index]), ((values)[index])}),tuple_type_id),call_span)),call_span));
}
VERIFY_NOT_REACHED();
}
else if (__jakt_enum_value == false) {
...
return JaktInternal::ExplicitValue<interpreter::StatementResult>(interpreter::StatementResult::JustValue(blk));
}
VERIFY_NOT_REACHED();
}
else {
...
return JaktInternal::ExplicitValue<interpreter::StatementResult>(TRY((((*this).execute_binary_operator(lhs_value,rhs_value,((op).op),span,scope)))));
}
VERIFY_NOT_REACHED();
};/*case end*/
}/*switch end*/
...
return JaktInternal::ExplicitValue<interpreter::StatementResult>(value);
}
VERIFY_NOT_REACHED();
};/*case end*/
case 6 /* UnaryOp */: {
...
return JaktInternal::ExplicitValue<types::Value>(value);
}
VERIFY_NOT_REACHED();
};/*case end*/
case 6 /* I8 */: {
...
auto&& __jakt_match_value = __jakt_match_variant.as.Fallible;ids::TypeId const& type_id = __jakt_match_value.value;
{
return JaktInternal::ExplicitValue<interpreter::StatementResult>(interpreter::StatementResult::JustValue(types::Value(types::ValueImpl::OptionalSome(TRY((interpreter::cast_value_to_type(value,type_id,*this,false)))),span)));
}
VERIFY_NOT_REACHED();
};/*case end*/
default: VERIFY_NOT_REACHED();}/*switch end*/
...
return JaktInternal::ExplicitValue<interpreter::StatementResult>(interpreter::StatementResult::JustValue(types::Value(types::ValueImpl::Bool(true),span)));
}
VERIFY_NOT_REACHED();
};/*case end*/
default: {
...
return JaktInternal::ExplicitValue<interpreter::StatementResult>(interpreter::StatementResult::JustValue(types::Value(types::ValueImpl::Struct(DynamicArray<types::Value>::create_with({start, end}),range_struct_id,((range_constructors)[static_cast<i64>(0LL)])),span)));
}
VERIFY_NOT_REACHED();
};/*case end*/
case 21 /* Call */: {
...
return ((((*this).call_prelude_function(((call).name),DynamicArray<types::ResolvedNamespace>::create_with({}),JaktInternal::OptionalNone(),arguments,span,Dictionary<ids::TypeId, ids::TypeId>::create_with_entries({})))));
}
...
return ((((*this).call_prelude_function(((call).name),effective_namespace,this_argument,arguments,span,Dictionary<ids::TypeId, ids::TypeId>::create_with_entries({})))));
}
NonnullRefPtr<types::CheckedFunction> const function_to_run = ((((*this).program))->get_function((((call).function_id).value())));
JaktInternal::DynamicArray<types::Value> arguments = DynamicArray<types::Value>::create_with({});
{
...
return JaktInternal::ExplicitValue<interpreter::StatementResult>(interpreter::StatementResult::JustValue(((values)[numeric_index])));
}
VERIFY_NOT_REACHED();
};/*case end*/
default: {
...
return JaktInternal::ExplicitValue<interpreter::StatementResult>(interpreter::StatementResult::JustValue(((fields)[(found_index.value())])));
}
VERIFY_NOT_REACHED();
};/*case end*/
case 18 /* Class */: {
...
return JaktInternal::ExplicitValue<interpreter::StatementResult>(interpreter::StatementResult::JustValue(types::Value(types::ValueImpl::JaktDictionary(keys,values,type_id),span)));
}
VERIFY_NOT_REACHED();
};/*case end*/
...
return JaktInternal::ExplicitValue<ids::FunctionId>(((((overloads.value())).first()).value()));
}
VERIFY_NOT_REACHED();
};/*case end*/
case 20 /* GenericInstance */: {
...
return JaktInternal::ExplicitValue<interpreter::StatementResult>(interpreter::StatementResult::JustValue(types::Value(types::ValueImpl::U32((code_point.value())),span)));
}
VERIFY_NOT_REACHED();
};/*case end*/
case 10 /* JaktArray */: {
...
return JaktInternal::ExplicitValue<interpreter::StatementResult>(interpreter::StatementResult::JustValue(types::Value(types::ValueImpl::JaktArray(DynamicArray<types::Value>::filled(count, value_to_repeat),TRY((((((*this).program))->substitute_typevars_in_type(type_id,((scope)->type_map_for_substitution()),((type_id).module)))))),span)));
}
VERIFY_NOT_REACHED();
}
else {
...
return JaktInternal::ExplicitValue<interpreter::StatementResult>(interpreter::StatementResult::JustValue(types::Value(types::ValueImpl::JaktArray(values,TRY((((((*this).program))->substitute_typevars_in_type(type_id,((scope)->type_map_for_substitution()),((type_id).module)))))),span)));
}
VERIFY_NOT_REACHED();
}
}());
...
return JaktInternal::ExplicitValue<interpreter::StatementResult>(interpreter::StatementResult::JustValue(((fields)[index])));
}
VERIFY_NOT_REACHED();
}
else {
...
JaktInternal::DynamicArray<types::CheckedMatchBranch> const& branches = __jakt_match_value.branches;
...
{
JaktInternal::ArrayIterator<types::CheckedMatchBranch> _magic = ((branches).iterator());
for (;;){
JaktInternal::Optional<types::CheckedMatchBranch> const _magic_value = ((_magic).next());
if ((!(((_magic_value).has_value())))){
break;
}
types::CheckedMatchBranch branch = (_magic_value.value());
{
{
JaktInternal::ArrayIterator<types::CheckedMatchCase> _magic = ((((branch).cases)).iterator());
for (;;){
...
case 3 /* CatchAll */: {
auto&& __jakt_match_value = __jakt_match_variant.as.CatchAll;utility::Span const& marker_span = __jakt_match_value.marker_span;
{
(catch_all_case = ((branch).body));
(span = marker_span);
return JaktInternal::LoopContinue{};
}
return JaktInternal::ExplicitValue<void>();
...
(found_body = static_cast<JaktInternal::Optional<types::CheckedMatchBody>>(((branch).body)));
...
return JaktInternal::ExplicitValue<interpreter::StatementResult>(interpreter::StatementResult::JustValue(((fields)[i])));
}
VERIFY_NOT_REACHED();
};/*case end*/
default: {
...
return JaktInternal::ExplicitValue<interpreter::StatementResult>(interpreter::StatementResult::JustValue(types::Value(types::ValueImpl::JaktTuple(fields,type_id),span)));
}
VERIFY_NOT_REACHED();
};/*case end*/
case 11 /* JaktSet */: {
...
return JaktInternal::ExplicitValue<interpreter::StatementResult>(interpreter::StatementResult::JustValue(types::Value(types::ValueImpl::JaktSet(values,type_id),span)));
}
VERIFY_NOT_REACHED();
};/*case end*/
...
return JaktInternal::ExplicitValue<interpreter::StatementResult>(interpreter::StatementResult::JustValue(types::Value(types::ValueImpl::Function(resolved_captures,resolved_params,TRY((((((*this).program))->substitute_typevars_in_type(return_type_id,type_map,((return_type_id).module))))),TRY((((((*this).program))->substitute_typevars_in_type(type_id,type_map,((type_id).module))))),fixed_block,can_throw,checked_params,scope_id,pseudo_function_id),span)));
}
VERIFY_NOT_REACHED();
};/*case end*/
case 29 /* Function */: {
...
return JaktInternal::ExplicitValue<interpreter::StatementResult>(interpreter::StatementResult::JustValue(types::Value(types::ValueImpl::Void(),span)));
}
VERIFY_NOT_REACHED();
};/*case end*/
case 34 /* Reflect */: {
...
return JaktInternal::ExplicitValue<ids::FunctionId>((constructor.value()));
}
VERIFY_NOT_REACHED();
};/*case end*/
case 6 /* I8 */: {
...
return JaktInternal::ExplicitValue<ids::FunctionId>(constructor);
}
VERIFY_NOT_REACHED();
};/*case end*/
case 28 /* Reference */: {
...
return JaktInternal::ExplicitValue<JaktInternal::DynamicArray<types::Value>>(result);
}
VERIFY_NOT_REACHED();
};/*case end*/
default: {
