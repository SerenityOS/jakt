...
__jakt_var_907 = __jakt_format((StringView::from_string_literal("{}..{}"sv)),from_output,to_output); goto __jakt_label_800;
...
((builder).append((StringView::from_string_literal(")"sv))));
__jakt_var_912 = ((builder).to_string()); goto __jakt_label_805;
