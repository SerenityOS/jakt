...
return JaktInternal::ExplicitValue(({ Optional<ByteString> __jakt_var_903; {
...
((builder).append((StringView::from_string_literal(")"sv))));
__jakt_var_903 = ((builder).to_string()); goto __jakt_label_796;
...
return JaktInternal::ExplicitValue(({ Optional<ByteString> __jakt_var_904; {
...
__jakt_var_904 = __jakt_format((StringView::from_string_literal("{}..{}"sv)),from_output,to_output); goto __jakt_label_797;
...
return JaktInternal::ExplicitValue(({ Optional<ByteString> __jakt_var_905; {
ByteStringBuilder builder = ByteStringBuilder::create();
((builder).append((StringView::from_string_literal("["sv))));
{
JaktInternal::Range<size_t> _magic = (JaktInternal::Range<size_t>{static_cast<size_t>(static_cast<size_t>(0ULL)),static_cast<size_t>(((vals).size()))});
...
((builder).append((StringView::from_string_literal("]"sv))));
__jakt_var_905 = ((builder).to_string()); goto __jakt_label_798;
...
((builder).append((StringView::from_string_literal("}"sv))));
__jakt_var_906 = ((builder).to_string()); goto __jakt_label_799;
...
((builder).append((StringView::from_string_literal("]"sv))));
__jakt_var_907 = ((builder).to_string()); goto __jakt_label_800;
...
__jakt_var_908 = ((builder).to_string()); goto __jakt_label_801;
...
((builder).append((StringView::from_string_literal(")"sv))));
__jakt_var_909 = ((builder).to_string()); goto __jakt_label_802;
...
{
JaktInternal::ArrayIterator<lexer::Token> _magic = ((({ Optional<JaktInternal::DynamicArray<lexer::Token>> __jakt_var_911;
auto __jakt_var_912 = [&]() -> ErrorOr<JaktInternal::DynamicArray<lexer::Token>> { return lexer::Lexer::lex(((*this).compiler)); }();
if (__jakt_var_912.is_error()) {{
return {};
}
} else {__jakt_var_911 = __jakt_var_912.release_value();
}
__jakt_var_911.release_value(); })).iterator());
for (;;){
JaktInternal::Optional<lexer::Token> const _magic_value = ((_magic).next());
if ((!(((_magic_value).has_value())))){
break;
...
repl_backend__common::LineResult const line_result = ({ Optional<repl_backend__common::LineResult> __jakt_var_914;
auto __jakt_var_915 = [&]() -> ErrorOr<repl_backend__common::LineResult> { return TRY((((editor).get_line(JaktInternal::OptionalNone())))); }();
if (__jakt_var_915.is_error()) {auto error = __jakt_var_915.release_error();
{
return {};
}
...
JaktInternal::DynamicArray<lexer::Token> tokens = ({ Optional<JaktInternal::DynamicArray<lexer::Token>> __jakt_var_916;
auto __jakt_var_917 = [&]() -> ErrorOr<JaktInternal::DynamicArray<lexer::Token>> { return lexer::Lexer::lex(((*this).compiler)); }();
...
repl_backend__common::LineResult const line_result = ({ Optional<repl_backend__common::LineResult> __jakt_var_918;
auto __jakt_var_919 = [&]() -> ErrorOr<repl_backend__common::LineResult> { return TRY((((editor).get_line((ByteString::from_utf8_without_validation(".."sv)))))); }();
if (__jakt_var_919.is_error()) {auto error = __jakt_var_919.release_error();
{
return {};
}
...
(tokens = ({ Optional<JaktInternal::DynamicArray<lexer::Token>> __jakt_var_920;
auto __jakt_var_921 = [&]() -> ErrorOr<JaktInternal::DynamicArray<lexer::Token>> { return lexer::Lexer::lex(((*this).compiler)); }();
...
parser::ParsedNamespace const parsed_namespace = ({ Optional<parser::ParsedNamespace> __jakt_var_922;
auto __jakt_var_923 = [&]() -> ErrorOr<parser::ParsedNamespace> { return ((parser).parse_namespace(false)); }();
if (__jakt_var_923.is_error()) {{
TRY((((*this).handle_possible_error())));
continue;
}
} else {__jakt_var_922 = __jakt_var_923.release_value();
}
__jakt_var_922.release_value(); });
if (TRY((((*this).handle_possible_error())))){
continue;
}
auto __jakt_var_925 = [&]() -> ErrorOr<void> { return TRY((((((*this).typechecker)).typecheck_module(parsed_namespace,((*this).root_scope_id))))), ErrorOr<void>{}; }();
...
NonnullRefPtr<typename parser::ParsedStatement> const parsed_statement = ({ Optional<NonnullRefPtr<typename parser::ParsedStatement>> __jakt_var_926;
auto __jakt_var_927 = [&]() -> ErrorOr<NonnullRefPtr<typename parser::ParsedStatement>> { return ((parser).parse_statement(true)); }();
...
NonnullRefPtr<typename types::CheckedStatement> const checked_statement = ({ Optional<NonnullRefPtr<typename types::CheckedStatement>> __jakt_var_928;
auto __jakt_var_929 = [&]() -> ErrorOr<NonnullRefPtr<typename types::CheckedStatement>> { return TRY((((((*this).typechecker)).typecheck_statement(parsed_statement,((*this).root_scope_id),types::SafetyMode::Safe(),JaktInternal::OptionalNone())))); }();
...
interpreter::StatementResult const result = ({ Optional<interpreter::StatementResult> __jakt_var_930;
auto __jakt_var_931 = [&]() -> ErrorOr<interpreter::StatementResult> { return TRY((((interpreter)->execute_statement(checked_statement,((*this).root_interpreter_scope),utility::Span(((*this).file_id),static_cast<size_t>(0ULL),((line).length())))))); }();
if (__jakt_var_931.is_error()) {{
TRY((((*this).handle_possible_error())));
continue;
}
