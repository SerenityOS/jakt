...
return JaktInternal::ExplicitValue(({ Optional<DeprecatedString> __jakt_var_928; {
...
return JaktInternal::ExplicitValue(({ Optional<DeprecatedString> __jakt_var_929; {
...
return JaktInternal::ExplicitValue(({ Optional<DeprecatedString> __jakt_var_930; {
DeprecatedStringBuilder builder = DeprecatedStringBuilder::create();
TRY((((builder).append_string(TRY(DeprecatedString::from_utf8("["sv))))));
{
JaktInternal::Range<size_t> _magic = (JaktInternal::Range<size_t>{static_cast<size_t>(static_cast<size_t>(0ULL)),static_cast<size_t>(((vals).size()))});
...
return JaktInternal::ExplicitValue(({ Optional<DeprecatedString> __jakt_var_931; {
DeprecatedStringBuilder builder = DeprecatedStringBuilder::create();
TRY((((builder).append_string(TRY(DeprecatedString::from_utf8("{"sv))))));
{
JaktInternal::Range<size_t> _magic = (JaktInternal::Range<size_t>{static_cast<size_t>(static_cast<size_t>(0ULL)),static_cast<size_t>(((vals).size()))});
...
return JaktInternal::ExplicitValue(({ Optional<DeprecatedString> __jakt_var_932; {
DeprecatedStringBuilder builder = DeprecatedStringBuilder::create();
TRY((((builder).append_string(TRY(DeprecatedString::from_utf8("["sv))))));
{
JaktInternal::Range<size_t> _magic = (JaktInternal::Range<size_t>{static_cast<size_t>(static_cast<size_t>(0ULL)),static_cast<size_t>(((vals).size()))});
...
return JaktInternal::ExplicitValue(({ Optional<DeprecatedString> __jakt_var_933; {
DeprecatedStringBuilder builder = DeprecatedStringBuilder::create();
{
...
return JaktInternal::ExplicitValue(({ Optional<DeprecatedString> __jakt_var_934; {
DeprecatedStringBuilder builder = DeprecatedStringBuilder::create();
{
...
typechecker::Typechecker typechecker = typechecker::Typechecker(compiler,TRY((types::CheckedProgram::__jakt_create(compiler,(TRY((DynamicArray<NonnullRefPtr<types::Module>>::create_with({})))),(TRY((Dictionary<DeprecatedString, types::LoadedModule>::create_with_entries({}))))))),placeholder_module_id,ids::TypeId::none(),JaktInternal::OptionalNone(),false,static_cast<size_t>(0ULL),false,((compiler)->dump_type_hints),((compiler)->dump_try_hints),static_cast<u64>(0ULL),types::GenericInferences((TRY((Dictionary<ids::TypeId, ids::TypeId>::create_with_entries({}))))),JaktInternal::OptionalNone(),root_module_name,false,false,(TRY((Dictionary<DeprecatedString, ids::ScopeId>::create_with_entries({})))),JaktInternal::OptionalNone());
...
auto __jakt_var_944 = [&]() -> ErrorOr<repl_backend__common::LineResult> { return TRY((((editor).get_line(TRY(DeprecatedString::from_utf8(".."sv)))))); }();
