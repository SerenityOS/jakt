...
{
JaktInternal::ArrayIterator<lexer::Token> _magic = ((({ Optional<JaktInternal::DynamicArray<lexer::Token>> __jakt_var_111;
auto __jakt_var_112 = [&]() -> ErrorOr<JaktInternal::DynamicArray<lexer::Token>> { return lexer::Lexer::lex(((*this).compiler)); }();
if (__jakt_var_112.is_error()) {{
return {};
}
} else {__jakt_var_111 = __jakt_var_112.release_value();
}
__jakt_var_111.release_value(); })).iterator());
for (;;){
JaktInternal::Optional<lexer::Token> const _magic_value = ((_magic).next());
if ((!(((_magic_value).has_value())))){
break;
...
repl_backend__common::LineResult const line_result = ({ Optional<repl_backend__common::LineResult> __jakt_var_114;
auto __jakt_var_115 = [&]() -> ErrorOr<repl_backend__common::LineResult> { return ((((editor).get_line(JaktInternal::OptionalNone())))); }();
if (__jakt_var_115.is_error()) {auto error = __jakt_var_115.release_error();
{
return {};
}
} else {__jakt_var_114 = __jakt_var_115.release_value();
}
__jakt_var_114.release_value(); });
...
JaktInternal::DynamicArray<lexer::Token> tokens = ({ Optional<JaktInternal::DynamicArray<lexer::Token>> __jakt_var_116;
auto __jakt_var_117 = [&]() -> ErrorOr<JaktInternal::DynamicArray<lexer::Token>> { return lexer::Lexer::lex(((*this).compiler)); }();
if (__jakt_var_117.is_error()) {{
continue;
}
} else {__jakt_var_116 = __jakt_var_117.release_value();
}
__jakt_var_116.release_value(); });
if (((tokens).is_empty())){
continue;
}
...
repl_backend__common::LineResult const line_result = ({ Optional<repl_backend__common::LineResult> __jakt_var_118;
auto __jakt_var_119 = [&]() -> ErrorOr<repl_backend__common::LineResult> { return ((((editor).get_line((ByteString::from_utf8_without_validation(".."sv)))))); }();
if (__jakt_var_119.is_error()) {auto error = __jakt_var_119.release_error();
{
return {};
}
} else {__jakt_var_118 = __jakt_var_119.release_value();
}
__jakt_var_118.release_value(); });
if (((line_result).__jakt_init_index() == 0 /* Line */)){
ByteString const line = (line_result).as.Line.value;
((builder).append(line));
(((((*this).compiler))->current_file) = ((*this).file_id));
(((((*this).compiler))->current_file_contents) = repl::REPL::line_to_bytes(((builder).to_string())));
(tokens = ({ Optional<JaktInternal::DynamicArray<lexer::Token>> __jakt_var_120;
auto __jakt_var_121 = [&]() -> ErrorOr<JaktInternal::DynamicArray<lexer::Token>> { return lexer::Lexer::lex(((*this).compiler)); }();
if (__jakt_var_121.is_error()) {{
continue;
}
} else {__jakt_var_120 = __jakt_var_121.release_value();
}
__jakt_var_120.release_value(); }));
}
else {
return {};
}
...
parser::ParsedNamespace const parsed_namespace = ({ Optional<parser::ParsedNamespace> __jakt_var_122;
auto __jakt_var_123 = [&]() -> ErrorOr<parser::ParsedNamespace> { return ((parser).parse_namespace(false)); }();
if (__jakt_var_123.is_error()) {{
TRY((((*this).handle_possible_error())));
continue;
}
} else {__jakt_var_122 = __jakt_var_123.release_value();
}
__jakt_var_122.release_value(); });
if (TRY((((*this).handle_possible_error())))){
continue;
}
auto __jakt_var_125 = [&]() -> ErrorOr<void> { return TRY((((((*this).typechecker)).typecheck_module(parsed_namespace,((*this).root_scope_id))))), ErrorOr<void>{}; }();
if (__jakt_var_125.is_error()) {{
TRY((((*this).handle_possible_error())));
continue;
}
}
...
NonnullRefPtr<typename parser::ParsedStatement> const parsed_statement = ({ Optional<NonnullRefPtr<typename parser::ParsedStatement>> __jakt_var_126;
auto __jakt_var_127 = [&]() -> ErrorOr<NonnullRefPtr<typename parser::ParsedStatement>> { return ((parser).parse_statement(true)); }();
...
NonnullRefPtr<typename types::CheckedStatement> const checked_statement = ({ Optional<NonnullRefPtr<typename types::CheckedStatement>> __jakt_var_128;
auto __jakt_var_129 = [&]() -> ErrorOr<NonnullRefPtr<typename types::CheckedStatement>> { return ((((((*this).typechecker)).typecheck_statement(parsed_statement,((*this).root_scope_id),types::SafetyMode::Safe(),JaktInternal::OptionalNone())))); }();
...
interpreter::StatementResult const result = ({ Optional<interpreter::StatementResult> __jakt_var_130;
auto __jakt_var_131 = [&]() -> ErrorOr<interpreter::StatementResult> { return ((((interpreter)->execute_statement(checked_statement,((*this).root_interpreter_scope),utility::Span(((*this).file_id),static_cast<size_t>(0ULL),((line).length())))))); }();
