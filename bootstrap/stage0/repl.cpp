...
__jakt_var_932 = __jakt_format((StringView::from_string_literal("{}..{}"sv)),from_output,to_output); goto __jakt_label_826;
...
return JaktInternal::ExplicitValue(({ Optional<ByteString> __jakt_var_935; {
ByteStringBuilder builder = ByteStringBuilder::create();
((builder).append((StringView::from_string_literal("["sv))));
{
JaktInternal::Range<size_t> _magic = (JaktInternal::Range<size_t>{static_cast<size_t>(static_cast<size_t>(0ULL)),static_cast<size_t>(((vals).size()))});
...
((builder).append((StringView::from_string_literal("]"sv))));
__jakt_var_935 = ((builder).to_string()); goto __jakt_label_829;

}
__jakt_label_829:; __jakt_var_935.release_value(); }));
};/*case end*/
...
return JaktInternal::ExplicitValue(({ Optional<ByteString> __jakt_var_936; {
ByteStringBuilder builder = ByteStringBuilder::create();
{
...
__jakt_var_936 = ((builder).to_string()); goto __jakt_label_830;

}
__jakt_label_830:; __jakt_var_936.release_value(); }));
};/*case end*/
case 24 /* Var */: {
...
return JaktInternal::ExplicitValue(({ Optional<ByteString> __jakt_var_937; {
ByteStringBuilder builder = ByteStringBuilder::create();
{
...
((builder).append((StringView::from_string_literal(")"sv))));
__jakt_var_937 = ((builder).to_string()); goto __jakt_label_831;

}
__jakt_label_831:; __jakt_var_937.release_value(); }));
};/*case end*/
case 34 /* Garbage */: {
...
typechecker::Typechecker typechecker = typechecker::Typechecker(compiler,TRY((types::CheckedProgram::__jakt_create(compiler,(DynamicArray<NonnullRefPtr<types::Module>>::create_with({})),Dictionary<ByteString, types::LoadedModule>::create_with_entries({})))),placeholder_module_id,ids::TypeId::none(),JaktInternal::OptionalNone(),false,static_cast<size_t>(0ULL),false,((compiler)->dump_type_hints),((compiler)->dump_try_hints),static_cast<u64>(0ULL),types::GenericInferences(Dictionary<ids::TypeId, ids::TypeId>::create_with_entries({})),JaktInternal::OptionalNone(),root_module_name,false,false,Dictionary<ByteString, ids::ScopeId>::create_with_entries({}),JaktInternal::OptionalNone());
...
NonnullRefPtr<interpreter::InterpreterScope> const root_interpreter_scope = TRY((interpreter::InterpreterScope::create(Dictionary<ByteString, types::Value>::create_with_entries({}),JaktInternal::OptionalNone(),Dictionary<ids::TypeId, ids::TypeId>::create_with_entries({}))));
...
{
JaktInternal::ArrayIterator<lexer::Token> _magic = ((({ Optional<JaktInternal::DynamicArray<lexer::Token>> __jakt_var_939;
auto __jakt_var_940 = [&]() -> ErrorOr<JaktInternal::DynamicArray<lexer::Token>> { return TRY((lexer::Lexer::lex(((*this).compiler)))); }();
if (__jakt_var_940.is_error()) {{
return {};
}
} else {__jakt_var_939 = __jakt_var_940.release_value();
}
__jakt_var_939.release_value(); })).iterator());
for (;;){
JaktInternal::Optional<lexer::Token> const _magic_value = ((_magic).next());
if ((!(((_magic_value).has_value())))){
break;
...
auto __jakt_var_943 = [&]() -> ErrorOr<repl_backend__common::LineResult> { return TRY((((editor).get_line(JaktInternal::OptionalNone())))); }();
...
JaktInternal::DynamicArray<lexer::Token> tokens = ({ Optional<JaktInternal::DynamicArray<lexer::Token>> __jakt_var_944;
auto __jakt_var_945 = [&]() -> ErrorOr<JaktInternal::DynamicArray<lexer::Token>> { return TRY((lexer::Lexer::lex(((*this).compiler)))); }();
...
repl_backend__common::LineResult const line_result = ({ Optional<repl_backend__common::LineResult> __jakt_var_946;
auto __jakt_var_947 = [&]() -> ErrorOr<repl_backend__common::LineResult> { return TRY((((editor).get_line((ByteString::must_from_utf8(".."sv)))))); }();
if (__jakt_var_947.is_error()) {auto error = __jakt_var_947.release_error();
{
return {};
}
...
(tokens = ({ Optional<JaktInternal::DynamicArray<lexer::Token>> __jakt_var_948;
auto __jakt_var_949 = [&]() -> ErrorOr<JaktInternal::DynamicArray<lexer::Token>> { return TRY((lexer::Lexer::lex(((*this).compiler)))); }();
if (__jakt_var_949.is_error()) {{
continue;
}
} else {__jakt_var_948 = __jakt_var_949.release_value();
}
__jakt_var_948.release_value(); }));
}
else {
return {};
}
...
parser::ParsedNamespace const parsed_namespace = ({ Optional<parser::ParsedNamespace> __jakt_var_950;
auto __jakt_var_951 = [&]() -> ErrorOr<parser::ParsedNamespace> { return TRY((((parser).parse_namespace(false)))); }();
...
auto __jakt_var_953 = [&]() -> ErrorOr<void> { return TRY((((((*this).typechecker)).typecheck_module(parsed_namespace,((*this).root_scope_id))))), ErrorOr<void>{}; }();
...
NonnullRefPtr<typename parser::ParsedStatement> const parsed_statement = ({ Optional<NonnullRefPtr<typename parser::ParsedStatement>> __jakt_var_954;
auto __jakt_var_955 = [&]() -> ErrorOr<NonnullRefPtr<typename parser::ParsedStatement>> { return TRY((((parser).parse_statement(true)))); }();
...
NonnullRefPtr<typename types::CheckedStatement> const checked_statement = ({ Optional<NonnullRefPtr<typename types::CheckedStatement>> __jakt_var_956;
auto __jakt_var_957 = [&]() -> ErrorOr<NonnullRefPtr<typename types::CheckedStatement>> { return TRY((((((*this).typechecker)).typecheck_statement(parsed_statement,((*this).root_scope_id),types::SafetyMode::Safe(),JaktInternal::OptionalNone())))); }();
if (__jakt_var_957.is_error()) {{
TRY((((*this).handle_possible_error())));
continue;
}
} else {__jakt_var_956 = __jakt_var_957.release_value();
}
__jakt_var_956.release_value(); });
if (TRY((((*this).handle_possible_error())))){
continue;
}
NonnullRefPtr<interpreter::Interpreter> interpreter = TRY((((((*this).typechecker)).interpreter())));
interpreter::StatementResult const result = ({ Optional<interpreter::StatementResult> __jakt_var_958;
auto __jakt_var_959 = [&]() -> ErrorOr<interpreter::StatementResult> { return TRY((((interpreter)->execute_statement(checked_statement,((*this).root_interpreter_scope),utility::Span(((*this).file_id),static_cast<size_t>(0ULL),((line).length())))))); }();
if (__jakt_var_959.is_error()) {{
TRY((((*this).handle_possible_error())));
continue;
}
} else {__jakt_var_958 = __jakt_var_959.release_value();
}
__jakt_var_958.release_value(); });
if (TRY((((*this).handle_possible_error())))){
continue;
}
({
