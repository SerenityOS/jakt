...
TRY((((builder).append_string(String(")")))));
__jakt_var_641 = TRY((((builder).to_string()))); goto __jakt_label_595;
...
__jakt_var_642 = TRY((String::formatted(String("{}..{}"),from_output,to_output))); goto __jakt_label_596;
...
TRY((((builder).append_string(String("]")))));
__jakt_var_643 = TRY((((builder).to_string()))); goto __jakt_label_597;
...
TRY((((builder).append_string(String("}")))));
__jakt_var_644 = TRY((((builder).to_string()))); goto __jakt_label_598;
...
TRY((((builder).append_string(String("]")))));
__jakt_var_645 = TRY((((builder).to_string()))); goto __jakt_label_599;
...
__jakt_var_646 = TRY((((builder).to_string()))); goto __jakt_label_600;
...
TRY((((builder).append_string(String(")")))));
__jakt_var_647 = TRY((((builder).to_string()))); goto __jakt_label_601;
...
repl::LineResult const line_result = ({ Optional<repl::LineResult> __jakt_var_649;
auto __jakt_var_650 = [&]() -> ErrorOr<repl::LineResult> { return TRY((((editor).get_line()))); }();
if (__jakt_var_650.is_error()) {auto error = __jakt_var_650.release_error();
{
return {};
}
} else {__jakt_var_649 = __jakt_var_650.release_value();
}
__jakt_var_649.release_value(); });
...
JaktInternal::Array<lexer::Token> const tokens = ({ Optional<JaktInternal::Array<lexer::Token>> __jakt_var_651;
auto __jakt_var_652 = [&]() -> ErrorOr<JaktInternal::Array<lexer::Token>> { return TRY((lexer::Lexer::Lexer::lex(((*this).compiler)))); }();
...
parser::ParsedNamespace const parsed_namespace = ({ Optional<parser::ParsedNamespace> __jakt_var_653;
auto __jakt_var_654 = [&]() -> ErrorOr<parser::ParsedNamespace> { return TRY((((parser).parse_namespace()))); }();
...
auto __jakt_var_656 = [&]() -> ErrorOr<void> { return TRY((((((*this).typechecker)).typecheck_module(parsed_namespace,((*this).root_scope_id))))), ErrorOr<void>{}; }();
...
NonnullRefPtr<parser::ParsedStatement> const parsed_statement = ({ Optional<NonnullRefPtr<parser::ParsedStatement>> __jakt_var_657;
auto __jakt_var_658 = [&]() -> ErrorOr<NonnullRefPtr<parser::ParsedStatement>> { return TRY((((parser).parse_statement(true)))); }();
if (__jakt_var_658.is_error()) {{
TRY((((*this).handle_possible_error())));
continue;
}
...
NonnullRefPtr<types::CheckedStatement> const checked_statement = ({ Optional<NonnullRefPtr<types::CheckedStatement>> __jakt_var_659;
auto __jakt_var_660 = [&]() -> ErrorOr<NonnullRefPtr<types::CheckedStatement>> { return TRY((((((*this).typechecker)).typecheck_statement(parsed_statement,((*this).root_scope_id), types::SafetyMode { typename types::SafetyMode::Safe() } ,JaktInternal::OptionalNone())))); }();
...
interpreter::StatementResult const result = ({ Optional<interpreter::StatementResult> __jakt_var_661;
auto __jakt_var_662 = [&]() -> ErrorOr<interpreter::StatementResult> { return TRY((((interpreter)->execute_statement(checked_statement,((*this).root_interpreter_scope),utility::Span(((*this).file_id),static_cast<size_t>(0ULL),((line).length())))))); }();
