...
public: void codegen_enum_destroy_variant(types::CheckedEnum const enum_, ByteString& output) const;
public: void codegen_enum_destructor_body(types::CheckedEnum const enum_, ByteString& output) const;
...
public: ByteString codegen_ak_formatter(ByteString const name, JaktInternal::DynamicArray<ByteString> const generic_parameter_names, ByteString const template_args);
