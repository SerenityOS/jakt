...
ErrorOr<DeprecatedString> codegen_expression_and_deref_if_generic_and_needed(NonnullRefPtr<types::CheckedExpression> const expression);
...
ErrorOr<DeprecatedString> codegen_unchecked_binary_op(NonnullRefPtr<types::CheckedExpression> const lhs, NonnullRefPtr<types::CheckedExpression> const rhs, parser::BinaryOperator const op, types::TypeId const type_id);
...
ErrorOr<DeprecatedString> codegen_unchecked_binary_op_assignment(NonnullRefPtr<types::CheckedExpression> const lhs, NonnullRefPtr<types::CheckedExpression> const rhs, parser::BinaryOperator const op, types::TypeId const type_id);
ErrorOr<DeprecatedString> codegen_statement(NonnullRefPtr<types::CheckedStatement> const statement);
...
ErrorOr<DeprecatedString> codegen_generic_match(NonnullRefPtr<types::CheckedExpression> const expr, JaktInternal::DynamicArray<types::CheckedMatchCase> const cases, types::TypeId const return_type_id, bool const all_variants_constant);
ErrorOr<DeprecatedString> codegen_checked_binary_op(NonnullRefPtr<types::CheckedExpression> const lhs, NonnullRefPtr<types::CheckedExpression> const rhs, parser::BinaryOperator const op, types::TypeId const type_id);
...
ErrorOr<DeprecatedString> codegen_expression(NonnullRefPtr<types::CheckedExpression> const expression);
...
ErrorOr<DeprecatedString> codegen_method_call(NonnullRefPtr<types::CheckedExpression> const expr, types::CheckedCall const call, bool const is_optional);
...
ErrorOr<DeprecatedString> codegen_binary_expression(NonnullRefPtr<types::CheckedExpression> const expression, types::TypeId const type_id, NonnullRefPtr<types::CheckedExpression> const lhs, NonnullRefPtr<types::CheckedExpression> const rhs, parser::BinaryOperator const op);
...
ErrorOr<DeprecatedString> codegen_namespace_qualifier(types::ScopeId const scope_id) const;
...
ErrorOr<DeprecatedString> codegen_checked_binary_op_assignment(NonnullRefPtr<types::CheckedExpression> const lhs, NonnullRefPtr<types::CheckedExpression> const rhs, parser::BinaryOperator const op, types::TypeId const type_id);
...
ErrorOr<DeprecatedString> codegen_enum_match(types::CheckedEnum const enum_, NonnullRefPtr<types::CheckedExpression> const expr, JaktInternal::DynamicArray<types::CheckedMatchCase> const match_cases, types::TypeId const type_id, bool const all_variants_constant);
ErrorOr<DeprecatedString> codegen_match(NonnullRefPtr<types::CheckedExpression> const expr, JaktInternal::DynamicArray<types::CheckedMatchCase> const match_cases, types::TypeId const type_id, bool const all_variants_constant);
