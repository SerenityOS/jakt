...
public: static ErrorOr<ByteString> capture_output(Function<ErrorOr<void>(ByteStringBuilder&)> const gen);
...
public: ErrorOr<void> codegen_expression(NonnullRefPtr<typename types::CheckedExpression> const expression, ByteStringBuilder& output, bool const forward_error_with_try);
public: ErrorOr<void> codegen_match(NonnullRefPtr<typename types::CheckedExpression> const expr, JaktInternal::DynamicArray<types::CheckedMatchBranch> const branches, ids::TypeId const type_id, bool const all_variants_constant, ByteStringBuilder& output);
public: ErrorOr<void> codegen_generic_match(NonnullRefPtr<typename types::CheckedExpression> const expr, JaktInternal::DynamicArray<types::CheckedMatchBranch> const branches, ids::TypeId const return_type_id, ByteString const cpp_match_result_type, bool const all_variants_constant, ByteStringBuilder& output);
public: ErrorOr<void> codegen_enum_match(types::CheckedEnum const enum_, NonnullRefPtr<typename types::CheckedExpression> const expr, JaktInternal::DynamicArray<types::CheckedMatchBranch> const branches, ids::TypeId const type_id, ByteString const cpp_match_result_type, bool const all_variants_constant, ByteStringBuilder& output);
...
public: ErrorOr<void> codegen_binary_expression(NonnullRefPtr<typename types::CheckedExpression> const expression, ids::TypeId const type_id, NonnullRefPtr<typename types::CheckedExpression> const lhs, NonnullRefPtr<typename types::CheckedExpression> const rhs, types::CheckedBinaryOperator const op, ByteStringBuilder& output, bool const forward_error_with_try);
...
public: ErrorOr<void> codegen_method_call(NonnullRefPtr<typename types::CheckedExpression> const expr, types::CheckedCall const call, bool const is_optional, ByteStringBuilder& output, bool const forward_error_with_try);
public: ErrorOr<void> codegen_call(types::CheckedCall const call, ByteStringBuilder& output, bool const forward_error_with_try);
