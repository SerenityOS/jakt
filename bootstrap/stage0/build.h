...
struct ParallelExecutionPool {
  public:
JaktInternal::Dictionary<size_t,jakt__platform__unknown_process::Process> pids;JaktInternal::Dictionary<size_t,jakt__platform__unknown_process::ExitPollResult> completed;size_t pid_index;size_t max_concurrent;static ErrorOr<build::ParallelExecutionPool> create(size_t const max_concurrent);
JaktInternal::Optional<jakt__platform__unknown_process::ExitPollResult> status(size_t const id) const;
ParallelExecutionPool(JaktInternal::Dictionary<size_t,jakt__platform__unknown_process::Process> a_pids, JaktInternal::Dictionary<size_t,jakt__platform__unknown_process::ExitPollResult> a_completed, size_t a_pid_index, size_t a_max_concurrent);
